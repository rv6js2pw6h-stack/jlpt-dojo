...
const N2_GRAMMAR = [
  ...
  /* ===================== AJOUTS — formes du cours B2 (handouts) ===================== */

  {
    id: "g183", g: "〜とは", m: "ce qu'on appelle… (c'est) ; X, c'est…", f: "Nom + とは、〜（という意味だ／〜ものだ）",
    c: "express", lv: 2, rel: ["g184", "g185"],
    note: "Sert à poser une définition ou à expliquer un terme. Registre plutôt formel/écrit. Proche de 〜というのは, mais plus net et catégorique (idéal pour les définitions). À ne pas confondre avec le とは de surprise (〜とは思わなかった).",
    ex: [
      { jp: "カタカナ語とは、外来語を表すためにカタカナで書かれる日本語の語彙です。", fr: "Les mots en katakana, ce sont les termes japonais écrits en katakana pour représenter les mots étrangers." },
      { jp: "セクハラとは、セクシャルハラスメントという意味です。", fr: "« Sekuhara », cela signifie « harcèlement sexuel »." },
    ],
    qs: [
      { t: "fill", q: "義務＿＿＿、しなければならないことです。", fr: "Le devoir, c'est ce qu'on est obligé de faire.",
        o: ["とは", "をめぐって", "にしては", "において"], a: 0,
        e: "On pose une définition de « 義務 » → 〜とは." },
      { t: "meaning", q: "「健康とは、ただ病気がないことではない」— rôle de とは ?",
        o: ["introduit une définition de « la santé »", "exprime une opposition", "indique le moyen", "marque le moment"], a: 0,
        e: "〜とは sert ici à définir le mot « 健康 »." },
      { t: "nuance", q: "Pour définir un simple terme technique à l'écrit, on préfère :",
        o: ["〜とは", "〜というものは", "〜にすれば", "〜とか"], a: 0,
        e: "Pour une définition nette d'un mot, 〜とは. 〜というものは sert plutôt à énoncer une vérité générale/essentielle." },
    ],
  },
  {
    id: "g184", g: "〜というものは", m: "ce qu'on appelle X (par nature)… ; X, par essence…", f: "Nom + というものは、〜（ものだ）",
    c: "express", lv: 2, rel: ["g183"],
    note: "Énonce une vérité générale, une essence, sur la nature profonde d'une chose (ton réfléchi, presque philosophique). Convient aux concepts (人生, 幸せ, 親…), pas à la définition d'un mot technique.",
    ex: [
      { jp: "幸せというものは、お金で得られないものです。", fr: "Le bonheur, par nature, ne s'achète pas." },
      { jp: "親というものは、いつまでも子供を心配するものだ。", fr: "Les parents, par nature, s'inquiètent toujours pour leurs enfants." },
    ],
    qs: [
      { t: "fill", q: "時間＿＿＿、二度と戻ってこないものだ。", fr: "Le temps, par nature, ne revient jamais.",
        o: ["というものは", "をめぐって", "に際して", "とか"], a: 0,
        e: "Vérité générale sur la nature du temps → 〜というものは." },
      { t: "nuance", q: "« PCというものはパソコンの略です » est-il naturel ?",
        o: ["Non : pour définir un mot, on emploie 〜とは", "Oui, parfaitement naturel", "Non : il faut 〜にすれば", "Oui, mais seulement à l'oral"], a: 0,
        e: "というものは = vérité essentielle, pas définition de mot. Ici il faut 〜とは." },
      { t: "meaning", q: "「子供というものは、すぐ大きくなるものだ」— nuance ?",
        o: ["généralité sur la nature des enfants", "définition du mot enfant", "opposition", "hypothèse"], a: 0,
        e: "On exprime une vérité générale → というものは + ものだ." },
    ],
  },
  {
    id: "g185", g: "〜と言えば（といえば）", m: "en parlant de… ; quand on évoque X, ce qui vient à l'esprit…", f: "Nom + といえば、〜",
    c: "express", lv: 2, rel: ["g183"],
    note: "Rebondit sur un sujet pour y associer l'image la plus typique, ou réagit à un mot que l'interlocuteur vient de dire. Très fréquent à l'oral.",
    ex: [
      { jp: "フランス料理といえば、エスカルゴやフォアグラが思い浮かびます。", fr: "Quand on parle de cuisine française, l'escargot et le foie gras viennent à l'esprit." },
      { jp: "京都といえば、お寺や紅葉が有名ですね。", fr: "Kyoto, ce qui est célèbre, ce sont les temples et les érables d'automne." },
    ],
    qs: [
      { t: "fill", q: "日本のアニメ＿＿＿、宮崎駿が有名だ。", fr: "En matière d'animation japonaise, Miyazaki Hayao est célèbre.",
        o: ["といえば", "といった", "をめぐって", "において"], a: 0,
        e: "On associe à « anime japonais » son image la plus typique → 〜といえば." },
      { t: "meaning", q: "A「田中さんに会ったよ」B「田中さんといえば、最近結婚したね」— rôle de といえば ?",
        o: ["rebondir sur le mot que l'autre vient de dire", "définir Tanaka", "s'opposer", "donner une condition"], a: 0,
        e: "といえば relance la conversation à partir d'un mot évoqué." },
      { t: "nuance", q: "Distinguer 〜といえば de 〜といった :",
        o: ["といえば = association d'idées à partir d'un thème ; といった = donne des exemples avant un nom", "identiques", "といえば donne des exemples", "といった rebondit sur un mot"], a: 0,
        e: "といった + Nom = « tels que » ; といえば = « en parlant de »." },
    ],
  },
  {
    id: "g186", g: "〜にすれば／〜にしてみれば", m: "du point de vue de ; pour X (si l'on se met à sa place)", f: "Nom (personne) + にすれば／にしてみれば、〜（はずだ／だろう）",
    c: "modality", lv: 2, rel: ["g187"],
    note: "Adopte le point de vue, les sentiments d'une personne. にしてみれば insiste un peu plus sur l'empathie. À distinguer de 〜にしても (concession, « même »).",
    ex: [
      { jp: "彼女は笑っていたけど、彼女にすれば、あなたの考えに納得していないはずだよ。", fr: "Elle souriait, mais de son point de vue, elle n'est sûrement pas convaincue par ton idée." },
      { jp: "子供にしてみれば、引っ越しは不安なことだろう。", fr: "Du point de vue de l'enfant, le déménagement doit être source d'angoisse." },
    ],
    qs: [
      { t: "fill", q: "親＿＿＿、子供の幸せが一番だ。", fr: "Du point de vue des parents, le bonheur de l'enfant passe avant tout.",
        o: ["にすれば", "に際して", "において", "をめぐって"], a: 0,
        e: "On adopte le point de vue des parents → 〜にすれば." },
      { t: "nuance", q: "Pour exprimer « même lui (à qui on ne s'attendrait pas) », on emploie :",
        o: ["〜にしても", "〜にすれば", "〜にしてみれば", "〜とは"], a: 0,
        e: "にしても = concession (« même ») ; にすれば／にしてみれば = point de vue." },
      { t: "meaning", q: "「外国人にしてみれば、日本の習慣は不思議だろう」— sens ?",
        o: ["du point de vue d'un étranger", "même un étranger", "à propos des étrangers", "grâce aux étrangers"], a: 0,
        e: "にしてみれば = se mettre à la place de quelqu'un." },
    ],
  },
  {
    id: "g187", g: "そこで", m: "c'est pourquoi ; alors (j'ai décidé de)", f: "〔Phrase〕。 そこで、〔action décidée〕。",
    c: "condition", lv: 2, rel: ["g186"],
    note: "Relie une situation/problème à l'action volontaire décidée en réponse. À distinguer de それで (conséquence/résultat naturel, souvent involontaire).",
    ex: [
      { jp: "最近、太ってきた。そこで、毎朝5キロほどジョギングすることにした。", fr: "J'ai grossi ces derniers temps. Alors, j'ai décidé de courir 5 km chaque matin." },
      { jp: "道に迷ってしまった。そこで、駅員に道を尋ねた。", fr: "Je me suis perdu. Alors, j'ai demandé mon chemin à un employé de la gare." },
    ],
    qs: [
      { t: "fill", q: "部屋が暗かった。＿＿＿、電気をつけた。", fr: "La pièce était sombre. Alors, j'ai allumé la lumière.",
        o: ["そこで", "それでも", "ところが", "ただし"], a: 0,
        e: "Action décidée en réponse à une situation → そこで." },
      { t: "nuance", q: "« 雨が降った。＿＿、試合が中止になった » (résultat involontaire) :",
        o: ["それで", "そこで", "ただし", "なお"], a: 0,
        e: "Un simple résultat (non une décision active) → それで, pas そこで." },
      { t: "meaning", q: "Rôle de そこで dans un texte :",
        o: ["introduit l'action prise pour répondre à une situation", "exprime une opposition", "ajoute une condition", "donne un exemple"], a: 0,
        e: "そこで = « face à cela, j'ai donc fait… »." },
    ],
  },
  {
    id: "g188", g: "〜かける／〜かけの", m: "commencer à (sans finir) ; être à moitié…", f: "Verbe(masu) + かける ／ かけの + Nom",
    c: "time", lv: 2, rel: ["g202"],
    note: "Une action est entamée mais interrompue ou inachevée. 〜かけた時 = « juste au moment où je commençais à… ». かけの + Nom : « un café entamé ».",
    ex: [
      { jp: "夕飯を食べかけた時、だれかがドアをノックした。", fr: "Juste au moment où je commençais à dîner, quelqu'un a frappé à la porte." },
      { jp: "机の上に読みかけの本が置いてある。", fr: "Sur le bureau se trouve un livre commencé (à moitié lu)." },
    ],
    qs: [
      { t: "fill", q: "彼女は何か言い＿＿＿が、すぐに黙ってしまった。", fr: "Elle a commencé à dire quelque chose, puis s'est tue aussitôt.",
        o: ["かけた", "きった", "以来", "つつ"], a: 0,
        e: "Action entamée puis interrompue → 言いかけた." },
      { t: "nuance", q: "Distinguer 〜かける de 〜きる :",
        o: ["かける = action à moitié/interrompue ; きる = action menée jusqu'au bout", "identiques", "かける = achèvement", "きる = à moitié"], a: 0,
        e: "食べかけ = à moitié mangé ; 食べきる = tout manger." },
      { t: "meaning", q: "「飲みかけのジュース」— sens ?",
        o: ["un jus entamé (à moitié bu)", "un jus terminé", "un jus à boire", "un jus renversé"], a: 0,
        e: "かけの + Nom = chose dont l'action est inachevée." },
    ],
  },
  {
    id: "g189", g: "〜とか／〜とかで", m: "il paraît que… ; on dit que… (et donc)", f: "Forme neutre + とか／とかで",
    c: "modality", lv: 2, rel: ["g190"],
    note: "Rapporte une information entendue, incertaine. とかで = « et c'est pour ça que… » : la raison rapportée explique une conséquence. Registre courant.",
    ex: [
      { jp: "明日、鉄道のストライキがあるとか、ほんと？", fr: "Il paraît qu'il y a une grève des trains demain, c'est vrai ?" },
      { jp: "係の者が不在とかで、詳しいことは分からなかった。", fr: "La personne responsable était paraît-il absente, je n'ai donc pas pu avoir les détails." },
    ],
    qs: [
      { t: "fill", q: "彼女は体調が悪い＿＿＿、今日は欠席です。", fr: "Elle ne se sentirait pas bien, paraît-il, et est donc absente aujourd'hui.",
        o: ["とかで", "べきで", "以来", "のみ"], a: 0,
        e: "Raison rapportée → conséquence : 〜とかで." },
      { t: "nuance", q: "Différence entre 〜とか et 〜とかで :",
        o: ["とか = simple ouï-dire ; とかで = ouï-dire qui sert de raison", "identiques", "とかで = simple ouï-dire", "とか = exprime une raison"], a: 0,
        e: "とかで relie l'information rapportée à une conséquence." },
      { t: "meaning", q: "「新しい店ができたとかで、人が並んでいる」— sens de とかで ?",
        o: ["paraît-il qu'un nouveau magasin a ouvert, d'où la file", "il faut ouvrir un magasin", "à propos du magasin", "même au magasin"], a: 0,
        e: "Ouï-dire + conséquence." },
    ],
  },
  {
    id: "g190", g: "〜のかと思った", m: "j'ai cru que… (alors que ce n'était pas le cas)", f: "Forme neutre + のかと思った",
    c: "modality", lv: 3, rel: ["g189"],
    note: "Exprime une impression erronée, une fausse interprétation sur le moment. Souvent réaction à une situation surprenante, avec nuance de soulagement ou d'étonnement rétrospectif.",
    ex: [
      { jp: "遅いから、事故にあったのかと思ったよ。", fr: "Tu étais tellement en retard que j'ai cru que tu avais eu un accident." },
      { jp: "静かだったので、誰もいないのかと思った。", fr: "C'était si calme que j'ai cru qu'il n'y avait personne." },
    ],
    qs: [
      { t: "fill", q: "電気が消えていたので、もう寝た＿＿＿思った。", fr: "Comme la lumière était éteinte, j'ai cru que tu dormais déjà.",
        o: ["のかと", "べきかと", "以来", "とかで"], a: 0,
        e: "Fausse impression sur le moment → 〜のかと思った." },
      { t: "meaning", q: "「返事がないので、怒っているのかと思った」— sens ?",
        o: ["j'ai cru (à tort) qu'il était fâché", "il devrait être fâché", "il est forcément fâché", "même fâché"], a: 0,
        e: "のかと思った = interprétation erronée." },
      { t: "nuance", q: "Quelle nuance porte souvent 〜のかと思った ?",
        o: ["soulagement/étonnement rétrospectif (ce n'était pas le cas)", "obligation", "certitude absolue", "ordre"], a: 0,
        e: "On a cru à tort ; la réalité dément l'impression." },
    ],
  },
  {
    id: "g191", g: "〜で済む／〜ずに済む", m: "s'en tirer avec ; ça suffit / éviter d'avoir à…", f: "Nom／Verbe(て) + 済む ／ Verbe(ない→ず) + に済む",
    c: "express", lv: 2, rel: ["g187"],
    note: "〜で済む = « s'en tirer avec / il suffit de » (2000円で済んだ). 〜ずに済む／〜ないで済む = « éviter d'avoir à faire » (怒られずに済んだ). する→せずに済む. Nuance de soulagement.",
    ex: [
      { jp: "4人で飲んで食べたが、一人2000円で済んだ。", fr: "Nous avons bu et mangé à quatre, mais ça nous a coûté seulement 2000 yens chacun." },
      { jp: "もう少し早く気づいていれば、大事故にならずに済んだのに。", fr: "Si je m'en étais aperçu plus tôt, on aurait évité un grave accident." },
    ],
    qs: [
      { t: "fill", q: "薬を飲んだので、病院に行か＿＿＿済んだ。", fr: "Comme j'ai pris des médicaments, j'ai pu éviter d'aller à l'hôpital.",
        o: ["ないで", "について", "わりに", "ばかり"], a: 0,
        e: "Éviter une action désagréable → 〜ないで済む." },
      { t: "nuance", q: "Conjugaison de する dans « éviter d'avoir à faire » :",
        o: ["せずに済む", "しずに済む", "さずに済む", "しないで済まう"], a: 0,
        e: "する → せず ; donc せずに済む." },
      { t: "meaning", q: "「傘のおかげで濡れずに済んだ」— sens ?",
        o: ["j'ai évité de me mouiller", "j'ai fini de me mouiller", "je me suis mouillé exprès", "je devais me mouiller"], a: 0,
        e: "〜ずに済む = on a évité (heureusement) l'action." },
    ],
  },
  {
    id: "g192", g: "〜（意志形）ではないか／じゃないか", m: "et si nous… ! ; faisons… ! (exhortation)", f: "Verbe(volitif) + ではないか／じゃないか",
    c: "express", lv: 2, rel: [],
    note: "Exhortation collective, appel à agir ensemble. ではないか = formel/écrit (discours) ; じゃないか = oral. Distinct du 〜じゃない de confirmation.",
    ex: [
      { jp: "環境を守るために、一人一人ができることを考えようではないか。", fr: "Pour protéger l'environnement, réfléchissons à ce que chacun peut faire." },
      { jp: "みんなで力を合わせて、この問題を解決しようではないか。", fr: "Unissons nos forces et résolvons ce problème ensemble." },
    ],
    qs: [
      { t: "fill", q: "新しいことに挑戦し＿＿＿ではないか。", fr: "Lançons-nous donc dans quelque chose de nouveau !",
        o: ["よう", "た", "ない", "ます"], a: 0,
        e: "Forme volitive (〜よう) + ではないか." },
      { t: "order", q: "Reconstituez l'exhortation.", frame: "未来を子供たちに託すために、今、＿＿＿。",
        o: ["行動しようではないか", "行動するではないか", "行動しただろうか", "行動しないではないか"], a: 0,
        e: "意志形 行動しよう + ではないか." },
      { t: "nuance", q: "Forme la plus orale :",
        o: ["考えようじゃないか", "考えようではないか", "考えるではないか", "考えたではないか"], a: 0,
        e: "じゃないか = registre oral ; ではないか = plus formel." },
    ],
  },
  {
    id: "g193", g: "〜つつある", m: "être en train de (changer progressivement)", f: "Verbe(masu) + つつある",
    c: "time", lv: 2, rel: [],
    note: "Décrit un changement graduel en cours, en mouvement vers un état. Surtout avec des verbes de changement (変わる, 増える, 減る, 進む…). Registre écrit. À distinguer de 〜つつ（も） (« tout en / bien que »).",
    ex: [
      { jp: "テクノロジーの進化により、仕事のやり方が変わりつつある。", fr: "Avec l'évolution de la technologie, la façon de travailler est en train de changer." },
      { jp: "社会全体が高齢化しつつある。", fr: "La société dans son ensemble est en train de vieillir." },
    ],
    qs: [
      { t: "fill", q: "地球の気温は年々上がり＿＿＿。", fr: "La température du globe est en train d'augmenter d'année en année.",
        o: ["つつある", "かけだ", "以来", "きり"], a: 0,
        e: "Changement progressif en cours → 〜つつある." },
      { t: "nuance", q: "Distinguer 〜つつある de 〜つつ（も） :",
        o: ["つつある = changement progressif en cours ; つつ（も） = « tout en / bien que »", "identiques", "つつある = concession", "つつも = changement"], a: 0,
        e: "Deux 〜つつ différents : aspect progressif vs concession simultanée." },
      { t: "meaning", q: "「伝統文化が消えつつある」— sens ?",
        o: ["la culture traditionnelle est en train de disparaître", "elle a disparu", "elle va réapparaître", "même si elle disparaît"], a: 0,
        e: "つつある = évolution graduelle en cours." },
    ],
  },
  {
    id: "g194", g: "〜を皮切りに（かわきりに）", m: "en commençant par… (qui marque le début d'une série)", f: "Nom／Verbe(た)+の + を皮切りに（して）",
    c: "time", lv: 3, rel: ["g195"],
    note: "Marque le coup d'envoi d'une série d'événements qui s'enchaînent ensuite. À distinguer de 〜をはじめ (exemples représentatifs d'un ensemble). Registre formel/écrit.",
    ex: [
      { jp: "東京公演を皮切りに、全国ツアーが始まった。", fr: "En commençant par le concert de Tokyo, la tournée nationale a débuté." },
      { jp: "彼の発言を皮切りに、次々と反対意見が出た。", fr: "Sa remarque a donné le coup d'envoi à une série d'objections." },
    ],
    qs: [
      { t: "fill", q: "大阪公演＿＿＿、ツアーがスタートした。", fr: "À partir du concert d'Osaka, la tournée a démarré.",
        o: ["を皮切りに", "において", "わりに", "のみ"], a: 0,
        e: "Point de départ d'une série → 〜を皮切りに." },
      { t: "nuance", q: "Distinguer 〜を皮切りに de 〜をはじめ :",
        o: ["を皮切りに = début chronologique d'une suite d'événements ; をはじめ = exemple représentatif d'un ensemble", "identiques", "をはじめ = début d'une série", "を皮切りに = exemple"], a: 0,
        e: "を皮切りに insiste sur l'enchaînement temporel." },
      { t: "meaning", q: "「彼の質問を皮切りに、議論が活発になった」— sens ?",
        o: ["sa question a déclenché un débat animé", "à part sa question", "malgré sa question", "à propos de sa question"], a: 0,
        e: "Sa question = point de départ d'une série." },
    ],
  },
  {
    id: "g195", g: "〜および（及び）", m: "ainsi que ; et (liaison formelle)", f: "Nom + および + Nom",
    c: "particle", lv: 3, rel: ["g194"],
    note: "Équivalent formel de と／や pour relier des noms ; typique des documents officiels. Ne relie que des noms, jamais des propositions verbales.",
    ex: [
      { jp: "氏名および住所をご記入ください。", fr: "Veuillez inscrire vos nom et adresse." },
      { jp: "会員および家族は無料で入場できる。", fr: "Les membres ainsi que leur famille entrent gratuitement." },
    ],
    qs: [
      { t: "fill", q: "日時＿＿＿場所をお知らせします。", fr: "Nous vous communiquerons la date ainsi que le lieu.",
        o: ["および", "において", "くらい", "わりに"], a: 0,
        e: "Liaison formelle de deux noms → および." },
      { t: "nuance", q: "« 食べおよび飲んだ » est-il correct ?",
        o: ["Non : および ne relie que des noms, pas des verbes", "Oui", "Oui, mais à l'oral seulement", "Non : il faut として"], a: 0,
        e: "および relie uniquement des noms." },
      { t: "meaning", q: "Registre de および :",
        o: ["formel/administratif", "très familier", "enfantin", "argotique"], a: 0,
        e: "Typique des écrits officiels ; à l'oral on dit と." },
    ],
  },
  {
    id: "g196", g: "〜のみ", m: "seulement, uniquement (formel)", f: "Nom／forme neutre + のみ",
    c: "particle", lv: 2, rel: ["g197"],
    note: "Version écrite/formelle de だけ. Peut se combiner avec が／を (彼のみが…). Voir aussi 〜のみならず (« non seulement »).",
    ex: [
      { jp: "彼のみが、その秘密を知っている。", fr: "Lui seul connaît ce secret." },
      { jp: "会員のみ入場できます。", fr: "Seuls les membres peuvent entrer." },
    ],
    qs: [
      { t: "fill", q: "この資料は社内＿＿＿使用してください。", fr: "Veuillez utiliser ce document uniquement en interne.",
        o: ["のみ", "において", "わりに", "とか"], a: 0,
        e: "« uniquement » (formel) → 〜のみ." },
      { t: "nuance", q: "Équivalent courant de 〜のみ :",
        o: ["〜だけ", "〜ばかり", "〜しか", "〜こそ"], a: 0,
        e: "のみ = registre formel de だけ." },
      { t: "meaning", q: "「努力のみが成功への道だ」— sens ?",
        o: ["seul l'effort mène au succès", "même l'effort", "à propos de l'effort", "grâce au succès"], a: 0,
        e: "のみ = seulement, uniquement." },
    ],
  },
  {
    id: "g197", g: "〜でのみ／〜にのみ", m: "uniquement à/dans/par (のみ + particule)", f: "Nom + で／に + のみ",
    c: "particle", lv: 3, rel: ["g196"],
    note: "On garde la particule appropriée AVANT のみ pour préciser le rôle : でのみ (lieu/moyen), にのみ (lieu/cible). Registre formel.",
    ex: [
      { jp: "沖縄でのみ、その伝統的な祭りが行われる。", fr: "C'est uniquement à Okinawa que se tient cette fête traditionnelle." },
      { jp: "この薬は薬局にのみ置いてある。", fr: "Ce médicament n'est disponible qu'en pharmacie." },
    ],
    qs: [
      { t: "fill", q: "このチケットは公式サイト＿＿＿買えます。", fr: "Ce billet ne s'achète que sur le site officiel.",
        o: ["でのみ", "をはじめ", "わりに", "について"], a: 0,
        e: "Moyen + « uniquement » → でのみ." },
      { t: "nuance", q: "« 会員＿＿特典がある » (destinataire) :",
        o: ["にのみ", "でのみ", "をのみ", "へのみ"], a: 0,
        e: "Cible/destinataire → にのみ." },
      { t: "meaning", q: "Pourquoi garder で／に devant のみ ?",
        o: ["pour préciser le rôle (lieu, moyen, cible)", "par politesse", "c'est une faute", "pour l'oral"], a: 0,
        e: "La particule conserve sa fonction grammaticale." },
    ],
  },
  {
    id: "g198", g: "〜に限る（にかぎる）", m: "rien ne vaut ; le mieux c'est…", f: "Nom／Verbe(辞書・ない) + に限る",
    c: "express", lv: 2, rel: ["g199", "g200"],
    note: "Opinion subjective : « il n'y a rien de tel que X ». Souvent pour des conseils/goûts. À distinguer de 〜に限り (restriction « seulement pour »).",
    ex: [
      { jp: "疲れた時は、温泉に限る。", fr: "Quand on est fatigué, rien ne vaut une source thermale." },
      { jp: "夏は冷たいビールに限るね。", fr: "En été, rien ne vaut une bière fraîche." },
    ],
    qs: [
      { t: "fill", q: "暑い日は、かき氷＿＿＿。", fr: "Les jours de chaleur, rien ne vaut un kakigōri.",
        o: ["に限る", "に限り", "に限って", "において"], a: 0,
        e: "Préférence forte (« le mieux ») → 〜に限る." },
      { t: "nuance", q: "Distinguer 〜に限る de 〜に限り :",
        o: ["に限る = « rien ne vaut » (préférence) ; に限り = « seulement pour » (restriction)", "identiques", "に限り = préférence", "に限る = restriction"], a: 0,
        e: "Sens très différents malgré la forme proche." },
      { t: "meaning", q: "「困った時は、専門家に相談するに限る」— sens ?",
        o: ["le mieux est de consulter un expert", "seuls les experts consultent", "même les experts", "à propos des experts"], a: 0,
        e: "に限る = il n'y a rien de mieux que…." },
    ],
  },
  {
    id: "g199", g: "〜に限り（にかぎり）", m: "uniquement (dans le cas de) ; exclusivement pour", f: "Nom + に限り、〜",
    c: "particle", lv: 2, rel: ["g198", "g200"],
    note: "Restreint une mesure (souvent un avantage) à un cas/une personne précis. Registre formel/écrit (annonces, offres). ≠ 〜に限る (préférence).",
    ex: [
      { jp: "明日に限り、朝9時から営業いたします。", fr: "Demain seulement, nous ouvrons à partir de 9 h." },
      { jp: "学生に限り、半額で入場できます。", fr: "Pour les étudiants uniquement, l'entrée est à moitié prix." },
    ],
    qs: [
      { t: "fill", q: "本日＿＿＿、全品2割引です。", fr: "Aujourd'hui seulement, tout est à -20 %.",
        o: ["に限り", "に限る", "に限って", "のみならず"], a: 0,
        e: "Restriction « seulement pour » → 〜に限り." },
      { t: "meaning", q: "「先着100名様に限り、プレゼント」— sens ?",
        o: ["cadeau pour les 100 premiers seulement", "rien ne vaut 100 personnes", "même 100 personnes", "à propos de 100 personnes"], a: 0,
        e: "に限り = exclusivement pour ce cas." },
      { t: "nuance", q: "Registre de 〜に限り :",
        o: ["formel (annonces, offres)", "argot", "enfantin", "littéraire ancien"], a: 0,
        e: "Typique des conditions/offres officielles." },
    ],
  },
  {
    id: "g200", g: "〜に限って（にかぎって）", m: "justement quand… (malchance) ; (lui) de tous… ne ferait jamais…", f: "Nom + に限って、〜",
    c: "express", lv: 2, rel: ["g198", "g199"],
    note: "Sens 1 : malchance (« c'est justement quand… que le pire arrive »). Sens 2 : confiance (« lui, de tous, ne ferait jamais ça »). Forte charge émotionnelle.",
    ex: [
      { jp: "大事な会議の時に限って、電車が遅れた。", fr: "C'est justement le jour de la réunion importante que le train a eu du retard." },
      { jp: "彼に限って、うそをつくことはない。", fr: "Lui, de tous, ne mentirait jamais." },
    ],
    qs: [
      { t: "fill", q: "急いでいる時＿＿＿、信号が赤になる。", fr: "C'est justement quand on est pressé que le feu passe au rouge.",
        o: ["に限って", "に限り", "に限る", "において"], a: 0,
        e: "Malchance ironique → 〜に限って." },
      { t: "meaning", q: "「彼女に限って盗むはずがない」— sens ?",
        o: ["elle, de toutes, ne volerait jamais (confiance)", "seulement elle vole", "elle vole par malchance", "à propos d'elle"], a: 0,
        e: "Ici sens de confiance : « elle justement, jamais »." },
      { t: "nuance", q: "Quelle forme exprime l'ironie/la malchance ?",
        o: ["〜に限って", "〜に限り", "〜に限る", "〜に限らず"], a: 0,
        e: "に限って = malchance ou confiance ; に限り = restriction neutre." },
    ],
  },
  {
    id: "g201", g: "〜は問わない／〜を問わない", m: "peu importe ; X n'est pas requis / ne compte pas", f: "Nom + は／を + 問わない",
    c: "express", lv: 2, rel: [],
    note: "Indique qu'un critère n'entre pas en compte (offres d'emploi : 経験を問わない). Forme adverbiale apparentée : 〜を問わず (« sans distinction de »).",
    ex: [
      { jp: "この仕事は経験を問いません。", fr: "Ce travail ne requiert pas d'expérience." },
      { jp: "このコンテストは国籍を問いません。", fr: "Ce concours est ouvert quelle que soit la nationalité." },
    ],
    qs: [
      { t: "fill", q: "当社は学歴＿＿＿問いません。", fr: "Notre société ne tient pas compte du niveau d'études.",
        o: ["は", "より", "ほど", "さえ"], a: 0,
        e: "〜は問わない = (le critère) ne compte pas." },
      { t: "nuance", q: "Forme adverbiale équivalente (« sans distinction de ») :",
        o: ["〜を問わず", "〜を問って", "〜に問わず", "〜は問えず"], a: 0,
        e: "問わない (prédicat) ↔ 問わず (adverbial)." },
      { t: "meaning", q: "「年齢は問わない」— sens ?",
        o: ["l'âge n'entre pas en compte", "il faut demander l'âge", "selon l'âge", "à propos de l'âge"], a: 0,
        e: "問わない = on ne prend pas en considération." },
    ],
  },
  {
    id: "g202", g: "〜きる（〜切る）", m: "faire complètement, jusqu'au bout ; à fond", f: "Verbe(masu) + きる",
    c: "express", lv: 2, rel: ["g203", "g188"],
    note: "Sens 1 : achèvement total (走りきる, 使いきる). Sens 2 : état extrême (疲れきる, 困りきる). 言いきる = affirmer avec certitude.",
    ex: [
      { jp: "疲れていたが、なんとかそのコースを走りきった。", fr: "J'étais épuisé, mais j'ai réussi à courir le parcours jusqu'au bout." },
      { jp: "彼女は、この計画は失敗すると言いきった。", fr: "Elle a affirmé catégoriquement que ce plan échouerait." },
    ],
    qs: [
      { t: "fill", q: "マラソンを最後まで走り＿＿＿。", fr: "J'ai couru le marathon jusqu'au bout.",
        o: ["きった", "かけた", "つつある", "得る"], a: 0,
        e: "Mener l'action à son terme → 〜きる." },
      { t: "meaning", q: "「お金を全部使いきった」— sens ?",
        o: ["j'ai tout dépensé (jusqu'au dernier yen)", "j'ai commencé à dépenser", "j'évite de dépenser", "je peux dépenser"], a: 0,
        e: "使いきる = utiliser complètement." },
      { t: "nuance", q: "「言いきる」 signifie :",
        o: ["affirmer avec certitude/catégoriquement", "commencer à parler", "ne pas pouvoir parler", "parler à moitié"], a: 0,
        e: "言いきる = déclarer sans réserve." },
    ],
  },
  {
    id: "g203", g: "〜きれない（〜切れない）", m: "ne pas pouvoir finir/faire complètement ; trop… pour", f: "Verbe(masu) + きれない",
    c: "express", lv: 2, rel: ["g202"],
    note: "Forme négative de 〜きる : impossible d'achever totalement. 数えきれない = innombrable ; 言いきれない = ne pas pouvoir affirmer ; 〜きれないほど = « au point de ne pas pouvoir ».",
    ex: [
      { jp: "料理が多すぎて、食べきれない。", fr: "Il y a trop à manger, je ne peux pas tout finir." },
      { jp: "多くの困難に直面しても、希望を捨てきれない。", fr: "Même face à de nombreuses difficultés, je ne peux pas totalement abandonner l'espoir." },
    ],
    qs: [
      { t: "fill", q: "星が多すぎて数え＿＿＿。", fr: "Il y a trop d'étoiles pour les compter.",
        o: ["きれない", "かけない", "得ない", "つつない"], a: 0,
        e: "Impossible d'achever (compter entièrement) → 〜きれない." },
      { t: "meaning", q: "「成功するかどうか、言いきれない」— sens ?",
        o: ["je ne peux pas affirmer avec certitude", "j'affirme catégoriquement", "j'ai fini de parler", "je commence à parler"], a: 0,
        e: "言いきれない = ne pas pouvoir trancher." },
      { t: "nuance", q: "〜きる / 〜きれない :",
        o: ["きる = mener à terme ; きれない = ne pas pouvoir mener à terme", "identiques", "きれない = achèvement", "きる = impossibilité"], a: 0,
        e: "きれない est le négatif (impossibilité) de きる." },
    ],
  },
  {
    id: "g204", g: "〜わけがない", m: "il est impossible que ; aucune chance que", f: "Forme neutre + わけがない",
    c: "modality", lv: 1, rel: [],
    note: "Nie catégoriquement une possibilité, par déduction logique. Très proche de 〜はずがない (un peu plus familier/catégorique). Forme familière : わけない.",
    ex: [
      { jp: "彼がうそをつくわけがない。", fr: "Il est impossible qu'il mente." },
      { jp: "こんなに勉強したのだから、落ちるわけがない。", fr: "J'ai tellement étudié qu'il est impossible que j'échoue." },
    ],
    qs: [
      { t: "fill", q: "あの真面目な彼が約束を忘れる＿＿＿。", fr: "Lui, si sérieux, ne peut pas oublier une promesse.",
        o: ["わけがない", "に限る", "一方だ", "つつある"], a: 0,
        e: "Impossibilité logique → 〜わけがない." },
      { t: "nuance", q: "Distinguer 〜わけがない de 〜わけにはいかない :",
        o: ["わけがない = impossible/inconcevable ; わけにはいかない = je ne peux pas (pour raison morale/sociale)", "identiques", "わけがない = obligation", "わけにはいかない = impossibilité logique"], a: 0,
        e: "わけがない = déduction ; わけにはいかない = contrainte morale." },
      { t: "meaning", q: "「そんな高い物が買えるわけがない」— sens ?",
        o: ["il est impossible que je puisse l'acheter", "je dois l'acheter", "j'ai le droit de l'acheter", "même si je l'achète"], a: 0,
        e: "わけがない = aucune possibilité." },
    ],
  },
  {
    id: "g205", g: "ただ", m: "cela dit, seulement, toutefois (léger bémol)", f: "〔Phrase positive〕。 ただ、〜。",
    c: "contrast", lv: 2, rel: ["g206"],
    note: "Apporte une légère réserve après un propos plutôt positif. Plus doux que しかし (« le seul hic, c'est… »). À distinguer de ただし (condition/exception formelle).",
    ex: [
      { jp: "彼はすばらしい学生です。ただ、ちょっと恥ずかしがり屋ですね。", fr: "C'est un excellent élève. Cela dit, il est un peu timide." },
      { jp: "この車はとても速い。ただ、ちょっと燃費が悪いね。", fr: "Cette voiture est très rapide. Seulement, elle consomme un peu beaucoup." },
    ],
    qs: [
      { t: "fill", q: "この店は安い。＿＿＿、少し遠い。", fr: "Ce magasin est bon marché. Seulement, il est un peu loin.",
        o: ["ただ", "そこで", "すなわち", "および"], a: 0,
        e: "Léger bémol après un point positif → ただ." },
      { t: "nuance", q: "Distinguer ただ de ただし :",
        o: ["ただ = léger bémol ; ただし = condition/exception (formel)", "identiques", "ただ = condition", "ただし = bémol"], a: 0,
        e: "ただし pose une condition officielle ; ただ nuance doucement." },
      { t: "meaning", q: "Rôle de ただ :",
        o: ["introduire une petite réserve", "donner une conséquence", "définir un mot", "énumérer"], a: 0,
        e: "ただ = « seulement, cela dit »." },
    ],
  },
  {
    id: "g206", g: "ただし（但し）", m: "toutefois, à condition que, sauf que", f: "〔Phrase〕。 ただし、〜（condition／exception）。",
    c: "contrast", lv: 2, rel: ["g205"],
    note: "Ajoute une condition restrictive ou une exception, ton formel (règlements, annonces, contrats). ≠ ただ (simple bémol).",
    ex: [
      { jp: "誰でも参加できます。ただし、事前に予約が必要です。", fr: "Tout le monde peut participer, à condition toutefois de réserver à l'avance." },
      { jp: "明日のツアーは実施します。ただし、天候によっては中止になります。", fr: "La visite de demain aura lieu. Toutefois, elle peut être annulée selon la météo." },
    ],
    qs: [
      { t: "fill", q: "全員入場できます。＿＿＿、20時までです。", fr: "Tout le monde peut entrer. Toutefois, jusqu'à 20 h seulement.",
        o: ["ただし", "ただ", "そこで", "なお"], a: 0,
        e: "Condition/restriction officielle → ただし." },
      { t: "nuance", q: "Dans un règlement, « à condition que… » s'introduit par :",
        o: ["ただし", "ただ", "それでも", "すなわち"], a: 0,
        e: "ただし pose une condition formelle." },
      { t: "meaning", q: "「返品可能です。ただし、レシートが必要です」— rôle de ただし ?",
        o: ["pose la condition (reçu requis)", "donne la conséquence", "définit un terme", "exprime un regret"], a: 0,
        e: "ただし introduit la condition/exception." },
    ],
  },
  {
    id: "g207", g: "〜だらけ", m: "couvert de, plein de (souvent négatif, en désordre)", f: "Nom + だらけ",
    c: "express", lv: 2, rel: [],
    note: "Forte connotation négative : saleté, fautes, désordre (間違いだらけ, 泥だらけ, 借金だらけ). À distinguer de 〜ばかり (proportion neutre).",
    ex: [
      { jp: "彼のレポートは誤字だらけで、読みにくい。", fr: "Son rapport est truffé de fautes, difficile à lire." },
      { jp: "子供は泥だらけになって遊んでいた。", fr: "L'enfant jouait, tout couvert de boue." },
    ],
    qs: [
      { t: "fill", q: "試験の答案は間違い＿＿＿だった。", fr: "La copie d'examen était truffée d'erreurs.",
        o: ["だらけ", "きり", "こそ", "のみ"], a: 0,
        e: "Plein de (qqch de négatif) → 〜だらけ." },
      { t: "nuance", q: "Distinguer 〜だらけ de 〜ばかり :",
        o: ["だらけ = couvert de qqch de négatif/sale ; ばかり = proportion (neutre)", "identiques", "だらけ = neutre", "ばかり = négatif"], a: 0,
        e: "だらけ porte une nuance désagréable." },
      { t: "meaning", q: "「彼の部屋は本だらけだ」— sens ?",
        o: ["sa chambre est pleine de livres (partout)", "il n'a qu'un livre", "il aime les livres", "il range ses livres"], a: 0,
        e: "だらけ = en grande quantité, partout." },
    ],
  },
  {
    id: "g208", g: "〜なりに／〜なりの", m: "à sa manière, selon ses propres moyens", f: "Nom + なりに（+ verbe）／なりの（+ nom）",
    c: "express", lv: 2, rel: [],
    note: "Reconnaît qu'à son niveau/dans ses limites, on fait de son mieux. なりに modifie un verbe ; なりの modifie un nom (彼なりの考え). Nuance respectueuse.",
    ex: [
      { jp: "私は私なりに幸せを感じている。", fr: "Je me sens heureux à ma manière." },
      { jp: "子供たちは、子供たちなりに世界を理解している。", fr: "Les enfants comprennent le monde à leur manière." },
    ],
    qs: [
      { t: "fill", q: "新人だが、彼＿＿＿に努力している。", fr: "C'est un nouveau, mais il fait des efforts à sa manière.",
        o: ["なり", "きり", "だらけ", "こそ"], a: 0,
        e: "« à sa façon » → 〜なりに." },
      { t: "nuance", q: "« 彼＿＿考え » (modifie un nom) :",
        o: ["なりの", "なりに", "なりで", "なりと"], a: 0,
        e: "Devant un nom → なりの." },
      { t: "meaning", q: "「初心者には初心者なりのやり方がある」— sens ?",
        o: ["les débutants ont leur propre façon de faire", "les débutants n'ont pas de méthode", "seuls les débutants comptent", "même les débutants"], a: 0,
        e: "なりの = propre à (son niveau)." },
    ],
  },
  {
    id: "g209", g: "〜ことは〜が", m: "certes… mais ; c'est vrai que X, seulement…", f: "Verbe／Adj + ことは +〔même mot〕+ が、〜",
    c: "contrast", lv: 2, rel: [],
    note: "On répète le mot autour de ことは…が pour concéder (料理することはするが…). Reconnaît une vérité partielle, puis nuance. Adjectifs : きれいなことはきれいだが….",
    ex: [
      { jp: "彼女は料理することはするが、あまり上手じゃない。", fr: "Elle cuisine, certes, mais elle n'est pas très douée." },
      { jp: "この町はきれいなことはきれいだが、生活は不便だ。", fr: "Cette ville est jolie, c'est vrai, mais peu pratique à vivre." },
    ],
    qs: [
      { t: "fill", q: "運動する＿＿＿するが、週に一回だけだ。", fr: "Je fais du sport, certes, mais une fois par semaine seulement.",
        o: ["ことは", "きり", "なりに", "だらけ"], a: 0,
        e: "Concession « certes… mais » → 〜ことは〜が." },
      { t: "order", q: "Reconstituez la concession.", frame: "この車は速い＿＿＿、燃費は悪い。",
        o: ["ことは速いが", "ことが速いと", "ことに速くて", "ことは速いので"], a: 0,
        e: "速い + ことは速いが = « rapide, certes, mais… »." },
      { t: "meaning", q: "Nuance de 〜ことは〜が :",
        o: ["concède un point puis le limite", "exprime une conséquence", "donne un exemple", "marque le moment"], a: 0,
        e: "Concession partielle suivie d'une réserve." },
    ],
  },
  {
    id: "g210", g: "すなわち", m: "c'est-à-dire, à savoir, autrement dit", f: "〔A〕、 すなわち、〔reformulation de A〕。",
    c: "express", lv: 3, rel: ["g211"],
    note: "Reformulation exacte/équivalence, plus formel que つまり. Pour préciser une définition ou un équivalent. ≠ 要するに (résumé/synthèse).",
    ex: [
      { jp: "あの人は母の兄、すなわち私の伯父です。", fr: "Cette personne est le frère de ma mère, c'est-à-dire mon oncle." },
      { jp: "彼は芸術科目、すなわち美術と音楽が得意だ。", fr: "Il excelle dans les matières artistiques, à savoir le dessin et la musique." },
    ],
    qs: [
      { t: "fill", q: "一年の半分、＿＿＿6か月が過ぎた。", fr: "La moitié de l'année, c'est-à-dire six mois, s'est écoulée.",
        o: ["すなわち", "ただし", "そこで", "および"], a: 0,
        e: "Équivalence exacte → すなわち." },
      { t: "nuance", q: "Distinguer すなわち de 要するに :",
        o: ["すなわち = reformulation/équivalence stricte ; 要するに = synthèse/résumé", "identiques", "すなわち = résumé", "要するに = équivalence"], a: 0,
        e: "すなわち pose un équivalent ; 要するに condense." },
      { t: "meaning", q: "Registre de すなわち :",
        o: ["formel/écrit (plus que つまり)", "très familier", "argot", "enfantin"], a: 0,
        e: "すなわち appartient au registre soutenu." },
    ],
  },
  {
    id: "g211", g: "要するに（ようするに）", m: "en somme, bref, pour résumer", f: "〔explication longue〕。 要するに、〔l'essentiel〕。",
    c: "express", lv: 2, rel: ["g210"],
    note: "Condense un propos long en son point essentiel. ≠ すなわち (équivalence stricte). Fréquent à l'oral pour conclure.",
    ex: [
      { jp: "明日は残業も接待もある。要するに、夕飯はいらないよ。", fr: "Demain j'ai des heures sup et une réception. Bref, pas besoin de dîner pour moi." },
      { jp: "要するに、君は何が言いたいの？", fr: "Bref, qu'est-ce que tu veux dire ?" },
    ],
    qs: [
      { t: "fill", q: "時間も金もない。＿＿＿、旅行は無理だ。", fr: "Ni temps ni argent. En somme, le voyage est impossible.",
        o: ["要するに", "すなわち", "ただし", "および"], a: 0,
        e: "Synthèse de ce qui précède → 要するに." },
      { t: "meaning", q: "「説明が長いが、要するに反対ということだ」— sens ?",
        o: ["en résumé : c'est un refus", "c'est-à-dire un accord", "à condition de refuser", "même un refus"], a: 0,
        e: "要するに = pour résumer l'essentiel." },
      { t: "nuance", q: "要するに / すなわち :",
        o: ["要するに résume ; すなわち reformule à l'identique", "identiques", "要するに reformule", "すなわち résume"], a: 0,
        e: "Résumé vs équivalence." },
    ],
  },
  {
    id: "g212", g: "それでも", m: "malgré tout, et pourtant, même ainsi", f: "〔fait〕。 それでも、〜。",
    c: "contrast", lv: 2, rel: ["g187"],
    note: "Concession forte : « malgré cela, quand même… ». À distinguer de それで (conséquence logique). La suite persiste malgré l'obstacle.",
    ex: [
      { jp: "値段は高かった。それでも、その時計を買った。", fr: "Le prix était élevé. Malgré tout, j'ai acheté cette montre." },
      { jp: "何度も失敗した。それでも、彼は諦めなかった。", fr: "Il a échoué maintes fois. Même ainsi, il n'a pas abandonné." },
    ],
    qs: [
      { t: "fill", q: "雨が降っていた。＿＿＿、試合は行われた。", fr: "Il pleuvait. Malgré tout, le match a eu lieu.",
        o: ["それでも", "それで", "そこで", "すなわち"], a: 0,
        e: "Concession (malgré l'obstacle) → それでも." },
      { t: "nuance", q: "Distinguer それでも de それで :",
        o: ["それでも = malgré cela (opposition) ; それで = donc (conséquence)", "identiques", "それでも = conséquence", "それで = opposition"], a: 0,
        e: "それでも introduit un contraste ; それで une suite logique." },
      { t: "meaning", q: "「危険だと言われた。それでも、彼は行った」— sens ?",
        o: ["on l'a prévenu du danger ; il y est allé quand même", "donc il y est allé", "à condition d'y aller", "il n'y est pas allé"], a: 0,
        e: "それでも = persistance malgré l'avertissement." },
    ],
  },
  {
    id: "g213", g: "〜と同時に", m: "en même temps que, dès que, à la fois", f: "Verbe(辞書)／Nom + と同時に",
    c: "time", lv: 2, rel: [],
    note: "Simultanéité (« au moment même où ») ou « à la fois A et B » (教師であると同時に研究者でもある). Proche de 〜とともに, qui insiste davantage sur l'évolution conjointe.",
    ex: [
      { jp: "彼が出発すると同時に、雨が降りだした。", fr: "Au moment même où il est parti, il s'est mis à pleuvoir." },
      { jp: "料理ができあがると同時に、友達が訪ねてきた。", fr: "Juste au moment où le plat était prêt, un ami est venu me rendre visite." },
    ],
    qs: [
      { t: "fill", q: "ベルが鳴る＿＿＿、生徒が教室を出た。", fr: "Dès que la sonnerie a retenti, les élèves sont sortis de la classe.",
        o: ["と同時に", "きり", "だらけ", "のみ"], a: 0,
        e: "Simultanéité immédiate → 〜と同時に." },
      { t: "meaning", q: "「彼は医者であると同時に作家でもある」— sens ?",
        o: ["il est à la fois médecin et écrivain", "il est devenu médecin puis écrivain", "il hésite entre les deux", "il n'est ni l'un ni l'autre"], a: 0,
        e: "と同時に = « à la fois » (deux qualités simultanées)." },
      { t: "nuance", q: "と同時に / とともに :",
        o: ["と同時に insiste sur le moment précis ; とともに sur l'évolution conjointe", "identiques", "とともに = moment précis", "と同時に = évolution"], a: 0,
        e: "Nuance de simultanéité vs accompagnement/évolution." },
    ],
  },
  {
    id: "g214", g: "なんと〜だろう／なんて〜んだろう", m: "comme c'est… ! quel(le)… ! (exclamation)", f: "なんと／なんて + Adj／Nom + （な）んだろう／のだろう",
    c: "express", lv: 2, rel: [],
    note: "Exclamation d'admiration ou d'étonnement. なんて = plus oral/émotionnel ; なんと = plus écrit/littéraire. Les な-adjectifs et noms prennent な (なんてきれいなんだろう).",
    ex: [
      { jp: "なんて美しい景色なんだろう。", fr: "Comme ce paysage est beau !" },
      { jp: "なんとすばらしい考えだろう。", fr: "Quelle idée magnifique !" },
    ],
    qs: [
      { t: "fill", q: "＿＿＿かわいい赤ちゃんなんだろう。", fr: "Comme ce bébé est mignon !",
        o: ["なんて", "なぜ", "どこ", "いつ"], a: 0,
        e: "Exclamation → なんて〜んだろう." },
      { t: "meaning", q: "「なんとすばらしい演奏だろう」— rôle de なんと ?",
        o: ["exprime l'admiration (« quelle… ! »)", "pose une question", "donne une raison", "marque une condition"], a: 0,
        e: "なんと〜だろう = exclamation admirative." },
      { t: "nuance", q: "Forme la plus écrite/littéraire :",
        o: ["なんと〜のだろう", "なんて〜んだろう", "なんで〜んだ", "なんか〜だろう"], a: 0,
        e: "なんと = registre écrit ; なんて = plus oral/émotionnel." },
    ],
  },
  //__APPEND__
];
