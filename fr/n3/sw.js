/* N3 道場 FR — Service Worker */
const CACHE = "n3dojo-fr-v1";
const ASSETS = ["./","./index.html","./styles.css?v=1","./paywall.js?v=1","./grammar-n3.js?v=1","./app.js?v=1","./manifest.json","./icon-192.png","./icon-180.png"];
