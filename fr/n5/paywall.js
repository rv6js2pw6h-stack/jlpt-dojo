...
(function () {
  ...
  // Déjà débloqué OU démo active — on sort (app.js gère la démo)
  try {
  ...
  overlay.innerHTML =
    '<div id="pw-card">' +
      ...
      '<h2>' + appName + '</h2>' +
      '<p>Quiz SRS &middot; Flashcards &middot; Défi chrono &middot; Référence complète<br>Accès permanent, fonctionne hors ligne.</p>' +
      '<a id="pw-btn" href="' + stripeLink + '">Commencer ' + level + ' &rarr;</a>' +
      '<button id="pw-demo-btn">Essayer 10 questions gratuites</button>' +
      '<p id="pw-note">Paiement unique &middot; 3,50&nbsp;€ &middot; Sécurisé par Gumroad</p>' +
      '<div id="pw-code-wrap">' +
