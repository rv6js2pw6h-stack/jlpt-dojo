...
const N2_GRAMMAR = [
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「地球温暖化について、様々な意見が出た」- meaning of について?",
      ...
      { t: "nuance", q: "「住民は建設計画＿＿＿強く反対した」- Which particle expresses opposition to the project?",
  ...
  {
    id: "g002", g: "〜に対して", m: "toward, against, facing; contrary to", f: "Nom + に対して／に対する＋Nom",
    ...
    qs: [
      ...
      { t: "meaning", q: "「収入が増えたのに対して、支出も増えた」- meaning of のに対して?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "To report second-hand information (\"according to the weather...\"), we say 天気予報＿＿＿....",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「研究の分野において優れた成果を上げた」- meaning of において?",
        o: ["in (the field of)", "about", "because of", "for (sb)"], a: 0,
        e: "Here において designates the domain/framework: \"in the field of research\"." },
      { t: "usage", q: "Which sentence is the most natural (formal register of a press release)?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「専門家として意見を述べた」- meaning of として?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "「この辞書は私＿＿＿宝物だ」- What form does \"for me, it's a treasure\" take?",
      ...
      { t: "usage", q: "Which is correct for \"I study to pass the exam\" (objective)?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「事実に基づく報道」- meaning of に基づく?",
        o: ["based on (the facts)", "contrary to", "about", "despite"], a: 0,
        e: "〜に基づく + Name = \"(report) based on facts\"." },
      { t: "nuance", q: "To \"decide IN ACCORDANCE with the regulations\" (strict standard), we prefer :",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "\"A film DRAWN FROM a novel\" (material adapted into a work):",
      ...
      { t: "meaning", q: "「経験をもとにアドバイスする」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「社長をはじめ、社員全員が参加した」- meaning?",
      ...
      { t: "order", q: "Reconstruct the sentence. Which segment goes in place of ★?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "In an official document, \"concerning this file\" is most naturally written :",
      ...
      { t: "meaning", q: "「健康に関する情報」- meaning of に関する?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「開会に際してご挨拶申し上げます」- meaning of に際して?",
        o: ["on the occasion of (the opening)", "about", "because of", "unlike"], a: 0,
        e: "〜に際して = during / on the occasion of (a solemn event)." },
      { t: "nuance", q: "For a DAILY, mundane circumstance, 〜に際して is :",
        o: ["unsuitable (too formal); looks like 〜とき", "the only correct choice", "mandatory", "identical to 〜たとたん"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜に先立って differs from 〜前に mainly because it :",
      ...
      { t: "meaning", q: "「会議に先立ち、資料が配られた」- when were the documents distributed?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "We prefer 〜をめぐって to 〜について when :",
      ...
      { t: "meaning", q: "「その発言をめぐって騒ぎになった」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「都市化に伴う問題」- meaning of に伴う?",
      ...
      { t: "nuance", q: "Main difference between 〜に伴って and 〜につれて :",
        o: ["伴って also accepts punctual/large-scale changes; つれて requires continuous gradual progression", "伴って expresses a single direct cause", "つれて is more formal", "they are never interchangeable"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Which sentence uses 〜につれて correctly (gradual change of BOTH sides)?",
      ...
      { t: "meaning", q: "「品質が上がるにつれて、値段も上がる」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Which of the two senses 〜につれて does NOT possess?",
      ...
      { t: "meaning", q: "「規則にしたがって行動する」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「命令に反する行為」- meaning of に反する?",
      ...
      { t: "nuance", q: "With what type of nouns is 〜に反して typically used?",
        o: ["予想・期待・規則 (expectation, forecast, rule)", "place names", "personal names only", "material names"], a: 0,
  ...
  {
    id: "g020", g: "〜にわたって／にわたる", m: "on (the whole extent of), during all, covering", f: "Name (duration/extent) + にわたって／にわたる＋Nom",
    ...
    qs: [
      ...
      { t: "nuance", q: "Difference between 〜にわたって and 〜を通して (temporal sense) :",
        o: ["わたって insists on breadth/extent covered; 通して insists on \"from beginning to end without interruption\".", "they are strictly identical", "わたって only used with places", "通して expresses a means only"], a: 0,
        e: "〜にわたって highlights the BIG scope (duration, space, number of domains). 〜を通して emphasizes continuity \"from one end to the other\"." },
      { t: "meaning", q: "「三回にわたる交渉」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「友人の一言をきっかけに、考えが変わった」- role of the \"friend's word\"?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Between 〜を契機に and 〜をきっかけに, which one is the most FORMAL/written?",
      ...
      { t: "meaning", q: "「転職を契機に、家族で引っ越した」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「約束したものの、守れなかった」- meaning?",
      ...
      { t: "nuance", q: "Difference between 〜ものの and 〜のに :",
        o: ["ものの is more written/posed; のに often adds a reproach or emotional disappointment", "のに is more formal", "they have nothing to do", "ものの expresses a cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「プロとはいえ、ミスをすることもある」- meaning?",
      ...
      { t: "nuance", q: "〜とはいえ is typically placed :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「忠告したにもかかわらず」- meaning?",
      ...
      { t: "nuance", q: "Relative to 〜のに, 〜にもかかわらず is :",
        o: ["more formal/written, without the strong emotional coloration of のに", "more familiar", "for oral use only", "synonymous with から"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "In which 〜ながら does it have the CONCESSIVE meaning (\"although\"), not \"at the same time\"?",
      ...
      { t: "meaning", q: "「小さいながらも、力強い」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「人口は減少しつつある」- meaning of つつある?",
      ...
      { t: "nuance", q: "Compared to 〜ながら, 〜つつ belongs to a register :",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "What nuance does 〜くせに add in relation to 〜のに?",
      ...
      { t: "usage", q: "When is 〜くせに NOT RECOMMENDED?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「給料が高いわりに、仕事は楽だ」- meaning?",
      ...
      { t: "nuance", q: "Difference between 〜わりに and 〜にしては :",
        o: ["very similar; にしては starts from a given explicit standard, わりに compares to a general expectation", "わりに expresses a cause", "にしては is familiar", "they are opposed"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「彼女は仕事に厳しい一方で、部下思いだ」- meaning?",
      ...
      { t: "nuance", q: "In addition to contrast, 〜一方（だ） can also mean:",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Nuance that distinguishes 〜反面 from 〜一方で :",
        o: ["反面 contrasts two sides of ONE subject; 一方で can also contrast two distinct subjects/trends.", "反面 expresses a cause", "一方で is familiar", "they are identical in every way"], a: 0,
        e: "〜反面 contrasts two contradictory aspects of one and the same subject. 〜一方で is broader (can compare two different entities)." },
      { t: "meaning", q: "「自由が増えた反面、責任も増えた」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「泣いていたかと思ったら、もう笑っている」- meaning?",
      ...
      { t: "usage", q: "Why is 私は家に着いたかと思うと、すぐに寝た weird?",
        o: ["かと思うと describes an observed change in others, not a voluntary action by the speaker", "the verb is incorrectly conjugated", "a particle is missing", "meaning is temporal impossible"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「考えているうちに、眠ってしまった」- meaning?",
      ...
      { t: "nuance", q: "Difference between 〜うちに and 〜あいだに :",
        o: ["うちに insists on \"before the state changes\"; あいだに simply delimits a given time period", "they are identical", "あいだに expresses a cause", "うちに is familiar only"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「冷めないうちに食べてください」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Which sentence is CORRECT with 次第?",
      ...
      { t: "meaning", q: "「結果が出次第、お知らせします」- when will we warn him?",
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Why is \"家に帰ったとたん、宿題をしよう\" incorrect?",
        o: ["とたん requires an ascertained/involuntary fact in part 2, not a will/order", "the verb is misplaced", "you need a name in front", "とたん never goes to the beginning"], a: 0,
      ...
      { t: "meaning", q: "「彼の顔を見たとたん、泣き出した」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「駅に着くか着かないかのうちに、電車が来た」- meaning?",
      ...
      { t: "nuance", q: "Compared to 〜たとたん, 〜か〜ないかのうちに emphasizes:",
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Which phrase is INCORRECT with 〜て以来?",
      ...
      { t: "meaning", q: "「あの事件以来、町は静かになった」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「許可を取ってからでなければ、使えない」- meaning?",
      ...
      { t: "nuance", q: "The 2nd proposition after 〜てからでないと is typically :",
        o: ["negative/impossible (〜ない・できない)", "an affirmative order", "a question", "an exclamation"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「外国に住んではじめて、母国のよさが分かった」- meaning?",
      ...
      { t: "nuance", q: "〜てはじめて differs from 〜てから (\"after\") in that it :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「私の知る限り、彼は正直な人だ」- meaning of 知る限り?",
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Which suite is BEST after 「約束したからには」?",
      ...
      { t: "meaning", q: "「日本に来たからには、日本語を覚えたい」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「努力家の彼のことだから、合格するでしょう」- What is the basis for this assumption?",
      ...
      { t: "nuance", q: "The name in front of 〜ことだから is almost always :",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Between 〜以上（は） and 〜からには :",
        o: ["very similar meaning; 以上 is a little more formal/logical, からには emphasizes personal determination", "they are opposed", "以上 expresses time", "からには is only written"], a: 0,
        e: "Quasi-synonyms: both connect an established fact with an obligatory consequence. 〜以上 sounds more formal/reasoned." },
      { t: "meaning", q: "「日本で働く以上、ビザが必要だ」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「責任者だけに、彼の発言は重い」- meaning?",
      ...
      { t: "nuance", q: "〜だけに can also express :",
        o: ["a disappointment/effect all the more marked when the result runs counter to expectations", "a goal", "he simple succession", "a ban"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "What's the difference between 〜ばかりに and 〜だけに?",
        o: ["ばかりに = single cause leading to a regretted NEGATIVE result; だけに = \"all the more\", not necessarily negative", "they are identical", "だけに is familiar", "ばかりに expresses time"], a: 0,
      ...
      { t: "meaning", q: "「油断したばかりに、試合に負けた」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「鍵をかけたはずなのに、開いている」- meaning of はず?",
      ...
      { t: "nuance", q: "Difference between 〜はずだ and 〜べきだ :",
        o: ["はずだ = logical prediction (\"it must be\"); べきだ = moral obligation (\"we must\")", "they are identical", "はずだ is an order", "べきだ is an assumption"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「彼女がそんなことを言うはずがない」- meaning?",
      ...
      { t: "nuance", q: "〜はずがない vs 〜に違いない :",
        o: ["はずがない denies (impossible); に違いない affirms with certainty (\"it must necessarily be\")", "they are synonymous", "はずがない asserts", "に違いない nie"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「彼はパリ育ちだ。フランス語が話せるわけだ」- meaning of わけだ?",
      ...
      { t: "nuance", q: "What word often accompanies 〜わけだ to mark \"here's why\"?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「お金がないわけではないが、無駄遣いはしたくない」- meaning?",
      ...
      { t: "nuance", q: "What's the difference between 「行きたくない」 and 「行きたくないわけではない」?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "「泳げないので、わけにはいかない」 is INCORRECT. Why is this?",
        o: ["わけにはいかない expresses a moral/social impossibility, not a physical incapacity", "the verb is misplaced", "you need a name in front", "it's too polite"], a: 0,
      ...
      { t: "meaning", q: "「秘密だから、教えるわけにはいかない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「彼は何か隠しているに違いない」- meaning?",
      ...
      { t: "nuance", q: "Rank from most to least safe: だろう / に違いない / かもしれない.",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Difference between 〜べきだ and 〜なければならない :",
        o: ["べきだ = moral duty/advice (\"il faudrait\"); なければならない = necessity/obligation incontournable (\"il faut absolument\")", "they are identical", "べきだ is stronger", "なければならない is an advice"], a: 0,
        e: "〜べきだ comes under moral judgment (what is right). 〜なければならない expresses a concrete/unavoidable obligation." },
      { t: "usage", q: "Correct form of the negation of 〜べきだ :",
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Correct form of する with 〜ざるを得ない :",
        o: ["せざるを得ない", "しざるを得ない", "するざるを得ない", "さざるを得ない"], a: 0,
        e: "Irregular exception: する → せざるを得ない." },
      { t: "meaning", q: "「赤字続きで、閉店せざるを得なかった」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「みんなの前で約束した以上、守らないわけにはいかない」- meaning?",
      ...
      { t: "nuance", q: "〜ないわけにはいかない and 〜ざるを得ない: difference in register/nuance?",
        o: ["ないわけにはいかない insists on social duty; ざるを得ない is more written and insists on the constraint of circumstances", "they are identical in every way", "ざるを得ない is familiar", "the first expresses a free choice"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Why does 「合格しかねない」 sound weird?",
        o: ["かねない only used for a NEGATIVE/feared result", "the verb is incorrectly conjugated", "a particle is missing", "かねない is too polite"], a: 0,
        e: "〜かねない only accompanies unfortunate consequences. Success being positive, the sentence is incoherent." },
      { t: "meaning", q: "「この問題は大事故につながりかねない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Beware of the trap: 〜かねる and 〜かねない have meanings...",
        o: ["opposites: かねる = \"not being able to do\"; かねない = \"risk doing (sth. wrong)\".", "identical", "both positive", "both refusals"], a: 0,
        e: "Classic N2 trap: 〜かねる = impossibility (polite); 〜かねない = risk of harm happening. Opposite meanings!" },
      { t: "meaning", q: "「賛成しかねる」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「彼は英語どころか、日本語も話せない」- meaning?",
      ...
      { t: "nuance", q: "The central idea of 〜どころか is:",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「これは個人的な意見にすぎません」- meaning?",
      ...
      { t: "nuance", q: "〜にすぎない and 〜にほかならない are :",
        o: ["opposites indeed: すぎない downplays; にほかならない emphatically asserts \"that's exactly right\".", "synonyms", "both minimizations", "both temporal"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「健康こそ財産にほかならない」- meaning?",
      ...
      { t: "nuance", q: "The tone of 〜にほかならない is :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「学生時代はよく徹夜したものだ」- meaning of ものだ here?",
      ...
      { t: "nuance", q: "「人の物を黙って使うものではない」- meaning of ものではない?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Difference between 〜ことだ (advice) and 〜ものだ (general truth) :",
        o: ["ことだ = specific advice to sb in a given situation; ものだ = general truth/norm", "they are identical", "ことだ expresses nostalgia", "ものだ is an order"], a: 0,
        e: "〜ことだ aims at concrete, personal advice; 〜ものだ states a generality or standard valid for all." },
      { t: "meaning", q: "「合格したいなら、努力することだ」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Correct form of する with 〜ずにはいられない :",
        o: ["せずにはいられない", "しずにはいられない", "せざるにはいられない", "するずにはいられない"], a: 0,
        e: "Exception: する → せず → せずにはいられない." },
      { t: "nuance", q: "Shade difference between 〜ずにはいられない and 〜ざるを得ない :",
        o: ["ずにはいられない = internal emotional impulse; ざるを得ない = external constraint of circumstances", "they are identical", "the first is formal/written", "the second is emotional"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「青というより、緑に近い色だ」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「お金がなくて、外食どころではない」- meaning?",
      ...
      { t: "nuance", q: "Distinguish 〜どころではない from 〜どころか :",
        o: ["どころではない = \"not the time to\" (situation that prevents); どころか = \"far from..., on the contrary\" (reversal of expectation)", "they are identical", "どころか is more polite", "どころではない expresses future time"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「線路に沿って歩いた」- meaning of に沿って?",
        o: ["along (the railroad)", "because of", "about", "despite"], a: 0,
        e: "Spatial use: walk \"along\" the track." },
      { t: "nuance", q: "Select \"in accordance with guidelines\":",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「青空のもとで運動会が開かれた」- meaning?",
      ...
      { t: "order", q: "Reconstitute the sentence. Which segment goes in place of ★?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「願いを込めて鐘を鳴らす」- meaning?",
      ...
      { t: "usage", q: "With what type of noun is 〜を込めて typically used?",
        o: ["a feeling / an intention (心, 感謝, 力)", "a place", "a date", "a number"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「経験に加えて、知識も豊富だ」- meaning?",
      ...
      { t: "nuance", q: "Distinguish 〜に加えて from 〜に反して :",
        o: ["に加えて = addition (in addition to); に反して = opposition (unlike)", "they are identical", "に加えて expresses a cause", "に反して expresses addition"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「男女を問わず採用する」- meaning?",
      ...
      { t: "usage", q: "Which name goes best with 〜を問わず?",
        o: ["国の内外（two poles / variety）", "私の弟（precise person）", "明日（date unique）", "この本（unique object）"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Distinguish 〜にかかわらず from 〜にもかかわらず :",
        o: ["にかかわらず = \"it doesn't matter X\" (X doesn't count); にもかかわらず = \"although X\" (despite a fact found)", "they are identical", "にかかわらず expresses a cause", "にもかかわらず expresses a variety"], a: 0,
        e: "にかかわらず neutralizes a parameter; にもかかわらず concedes an actual fact." },
      { t: "usage", q: "Which construction is typical of 〜にかかわらず?",
        o: ["行く行かないにかかわらず（alternatives）", "雨にもかかわらず（observed fact）", "失礼にあたる", "彼について"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「雨にぬれるのもかまわず走った」- meaning?",
      ...
      { t: "nuance", q: "What shade does 〜もかまわず often wear?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「子どもはもちろん、大人も楽しめる」- meaning?",
      ...
      { t: "nuance", q: "Register difference between はもちろん and はもとより :",
        o: ["はもとmore sustained/written; はもちろん more common", "はもちろん is vulgar", "they are used with different verbs", "はもとより expresses the opposite"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「平日はもとより、週末も営業する」- meaning?",
      ...
      { t: "usage", q: "In which register is 〜はもとより favored?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「冗談は抜きにして、本題に入ろう」- meaning?",
...

  {
    ...
    qs: [
      { t: "fill", q: "週末＿＿＿、平日もこの店は混んでいる。", fr: "Not just at weekends: this store is packed on weekdays too.",
        ...
        e: "\"Not just X\" → 〜に限らず." },
      { t: "meaning", q: "「子どもに限らず大人も間違える」- meaning?",
      ...
      { t: "nuance", q: "Distinguish 〜に限らず from 〜に限り :",
        o: ["に限らず = \"not only X\" (broadens); に限り = \"only X / in the case of X only\" (restricts).", "they are identical", "に限らず restricted", "に限り expands"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「国内のみならず海外でも」- meaning?",
      ...
      { t: "usage", q: "〜のみならず is the ... version of だけでなく :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「家族を中心に生活を考える」- meaning?",
      ...
      { t: "usage", q: "〜を中心に mainly expresses :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「成功するにせよ失敗するにせよ、挑戦に意味がある」- meaning?",
      ...
      { t: "usage", q: "Which pair is the most formal?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「理由が何であれ、遅刻は遅刻だ」- meaning?",
      ...
      { t: "usage", q: "〜であれ is often combined with :",
        o: ["an interrogative (どんな, 何, 誰)", "a specific number", "a verb in the て form", "a date"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「失敗したとしても、経験になる」- meaning?",
        o: ["even if you fail, it's still an experience", "as we failed", "because we fail", "to fail"], a: 0,
        e: "としても = even if (assumption)." },
      { t: "nuance", q: "Nuance of としても compared to 〜ても :",
        o: ["としても insists on the hypothesis (assuming that)", "としても is more familiar", "they have no connection", "としても expresses a cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「高いにしても、買う価値はある」- meaning?",
      ...
      { t: "usage", q: "〜にしたって is :",
        o: ["the familiar variant of にしても", "more formal than にしても", "a synonym for に限り", "an interrogative form"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「暑いといっても、日本ほどではない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「日本に住んでいたからといって、納豆が好きとは限らない」- meaning?",
      ...
      { t: "nuance", q: "〜からといって is almost always followed by :",
        o: ["a negation (〜ない／とは限らない)", "a positive imperative", "a question", "a date"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「便利だとはいうものの、欠点もある」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「考えたところで、答えは出ない」- meaning?",
      ...
      { t: "nuance", q: "〜たところで is usually followed by :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「以前に比べて、便利になった」- meaning?",
        o: ["more convenient than before", "despite", "front end", "because of before"], a: 0,
        e: "に比べて = compared to." },
      { t: "usage", q: "The written variant of 〜に比べて is :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「先月の売上にひきかえ、今月は好調だ」- meaning?",
      ...
      { t: "nuance", q: "Difference between にひきかえ and に対して :",
        o: ["にひきかえ adds subjective judgment/appreciation; に対して is more neutral", "they are identical", "にひきかえ is more neutral", "に対して expresses addition"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「少しならまだしも、全部食べるなんて」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「仕事をする上で大切なこと」- meaning?",
        o: ["what is important for/in the work", "after working", "despite work", "because of work"], a: 0,
        e: "V-辞書 + 上で = within / to make X." },
      { t: "nuance", q: "Distinguish V-た上で from 〜てから :",
        o: ["V-た上で insists on a thoughtful two-step process; 〜てから marks a simple temporal succession", "they are identical", "上で is familiar", "てから expresses a cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「契約に当たって、注意すべき点」- meaning?",
      ...
      { t: "nuance", q: "Difference between に当たって and に際して :",
        o: ["very similar meanings (on the occasion of); に際して is slightly more formal/written", "⚠ incorrect particle colloquial", "they are opposed", "に当たって expresses the cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「家を出たところへ雨が降ってきた」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「逃げようとしたところを捕まった」- meaning?",
      ...
      { t: "usage", q: "「お忙しいところをすみません」: ところを is used here to :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「ドアが開くが早いか、犬が飛び出した」- meaning?",
      ...
      { t: "nuance", q: "Register of 〜が早いか :",
        o: ["written / literary", "slang", "childish", "interrogative politeness"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「顔を見るや否や、怒り出した」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「稼ぐそばから使ってしまう」- meaning?",
      ...
      { t: "nuance", q: "What distinguishes そばから from が早いか :",
        o: ["そばから implies repetition (it happens over and over again)", "そばから is more polite", "が早いか implies repetition", "they are identical"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Distinguish 〜末に from 〜あげく :",
        o: ["末に = outcome (good or bad) after a process; あげく = often negative outcome after many complications", "they are identical", "末に is always negative", "あげく is always positive"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「長時間待たされたあげく、会えなかった」- meaning?",
      ...
      { t: "nuance", q: "Typical connotation of 〜あげく :",
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "「これきりにしよう」: きり here means :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「テレビをつけっぱなしで寝た」- meaning?",
      ...
      { t: "nuance", q: "〜っぱなし often carries a shade of :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「試験の最中に居眠りした」- meaning?",
      ...
      { t: "nuance", q: "〜最中に insists on :",
        o: ["the climax of an action in progress (the worst moment)", "he simple succession", "a comparison", "a condition"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「主婦業のかたわら、絵を描く」- meaning?",
      ...
      { t: "nuance", q: "Distinguish 〜かたわら from 〜ながら :",
        o: ["かたわら = two activities over time (life/career); ながら = two simultaneous actions in the moment", "they are identical", "かたわら is familiar", "ながら expresses long time"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「買い物がてら友達に会った」- meaning?",
      ...
      { t: "nuance", q: "Difference between がてら and かたわら :",
        o: ["がてら = a single dual-purpose outing/action; かたわら = two activities carried out durably in parallel", "they are identical", "がてら concerns the quarry", "かたわら is punctual"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「練習さえすれば上手くなる」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「それが本当だとすれば、大変なことだ」- meaning?",
      ...
      { t: "nuance", q: "Which of the three variants places the greatest emphasis on deduction?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「文句を言うものなら、すぐ首にするぞ」- meaning?",
      ...
      { t: "nuance", q: "Distinguish between the two uses of 〜ものなら :",
        o: ["V-可能形 + ものなら = unattainable wish; V-辞書 + ものなら = challenge/threat", "they are always identical", "ものなら = simple condition", "ものなら = cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「彼の前で失敗しようものなら、終わりだ」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「勉強しないことには、試験に受からない」- meaning?",
      ...
      { t: "nuance", q: "The continuation of 〜ないことには is almost always :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「子どもだからこそ、純粋なんだ」- meaning?",
      ...
      { t: "nuance", q: "Nuance of からこそ compared to から :",
        o: ["からこそ insists: it's THIS reason and no other", "they are identical", "からこそ is negative", "から is more insistent."], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「態度が堂々としていることから、リーダーに選ばれた」- meaning?",
      ...
      { t: "nuance", q: "〜ことから is mainly used for :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「長年の経験があるだけあって、判断が的確だ」- meaning?",
      ...
      { t: "nuance", q: "Distinguish だけあって from だけに :",
        o: ["だけあって = expected positive result; だけに = reinforcement (good or bad)", "they are identical", "だけに is always positive", "だけあって is negative"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「驚きのあまり声が出なかった」- meaning?",
      ...
      { t: "nuance", q: "〜あまり generally carries a connotation:",
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "〜につき is mainly used in what register?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「試験前とあって、図書館は満員だ」- meaning?",
      ...
      { t: "nuance", q: "〜とあって describes a circumstance that is :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「考えては書き、書いては消す」- meaning?",
      ...
      { t: "nuance", q: "「ミスをしては困る」: 〜ては expressed here :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「信頼なしには良い関係は築けない」- meaning?",
      ...
      { t: "nuance", q: "〜なくしては and 〜ないことには [[g109]] differ in :",
        o: ["なくしては refers to a name (state); ないことには refers to an action to be performed", "they are identical", "なくしては is positive", "ないことには is used with nouns"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「信頼すればこそ、任せるのだ」- meaning?",
      ...
      { t: "usage", q: "〜ばこそ is the ... version of からこそ :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「新年だることだし、気持ちを切り替えよう」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「転職してからというもの、忙しくなった」- meaning?",
      ...
      { t: "nuance", q: "Distinguish 〜てからというもの from 〜て以来 [[g038]] :",
        o: ["からというもの stresses the radical change; て以来 simply notes the continuity since X", "they are identical", "て以来 expresses radical change", "からというもの is more formal"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「泣くことはない、大丈夫だよ」- meaning?",
      ...
      { t: "nuance", q: "Distinguish 〜ことはない from 〜ないことはない :",
        o: ["ことはない = useless; ないことはない = double negative (it's possible, though...)", "they are identical", "ないことはない = impossible", "ことはない = to do"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「お世話になった人を裏切るものではない」- meaning?",
      ...
      { t: "nuance", q: "Register of 〜もんじゃない :",
        o: ["colloquial / spoken (variant of ものではない)", "very formal", "technical writing", "poetic"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「こんな仕打ちを受けるなんて、理不尽というものだ」- meaning?",
      ...
      { t: "nuance", q: "〜というものだ vs 〜わけだ :",
        o: ["というものだ = emblematic definition; わけだ = logical explanation of a situation", "they are identical", "わけだ expresses the definition", "というものだ = cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「長ければ良い文章というものではない」- meaning?",
      ...
      { t: "nuance", q: "〜というものではない and 〜とは限らない [[g142]]:",
        o: ["similar meanings (not necessarily); というものではない more axiomatic; とは限らない more factual", "opposite", "というものではない is more factual", "they have nothing to do"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「あの映画はもう見るまい」- meaning?",
      ...
      { t: "usage", q: "〜まい belongs to which register?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「こんな状況では、助け＿＿＿」 - complete correctly :",
        o: ["ようがない（no way to help）", "ことはない（unnecessary to help）", "まい（I won't help）", "べきだ（I have to help）"], a: 0,
        e: "ようがない = no method possible." },
      { t: "nuance", q: "Difference between 〜ようがない and 〜できない :",
        o: ["ようがない insists on the total absence of method/way; できない simply states the inability to", "they are identical", "できない is more emphatic", "ようがない is simpler"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「そんな嘘、信じっこない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「まるで知っているかのように話す」- meaning?",
      ...
      { t: "usage", q: "Which adverb is frequently associated with 〜かのようだ?",
        o: ["まるで (it really looks like it)", "たとえば", "もし", "なぜか"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「もう遅いから、店は閉まっているに決まっている」- meaning?",
      ...
      { t: "nuance", q: "〜に決まっている vs 〜に違いない [[g053]] :",
        o: ["に決まっている = more affective/oral; に違いない = more logical/formal", "they are identical", "に違いない is familiar", "に決まっている is logical"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「彼の発言は事実に相違ない」- meaning?",
      ...
      { t: "usage", q: "〜に相違ない belongs to the :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「医者が健康とは限らない」- meaning?",
      ...
      { t: "nuance", q: "〜とは限らない vs 〜わけではない [[g051]]:",
        o: ["とは限らない qualifies a generality; わけではない explains a specific situation.", "they are identical", "わけではない nuances a generality", "とは限らない explains a situation"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「一日くらい休めないものだろうか」- meaning?",
      ...
      { t: "usage", q: "〜ないものか carries a shade of :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「明日、代表者が発表されることになっている」- meaning?",
      ...
      { t: "nuance", q: "Distinguish between ことになっている and ことにしている :",
        o: ["ことになっている = external rule or decided plan; ことにしている = voluntary personal habit", "they are identical", "ことにしている is external", "ことになっている is personal"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「彼が裏切るとはあり得ない」- meaning?",
      ...
      { t: "nuance", q: "〜得る (うる/える) differs from 〜できる by:",
        o: ["得る = theoretical/logical possibility; できる = concrete practical ability", "they are identical", "できる is formal", "得る = impossible"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「状況次第では中止になるかもしれない」- meaning?",
      ...
      { t: "nuance", q: "「ご連絡した次第です」emploie 次第だ for :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「まだチャンスがないとも限らない」- meaning?",
      ...
      { t: "nuance", q: "Distinguish 〜とは限らない from 〜ないとも限らない :",
        o: ["とは限らない nuance an assertion; ないとも限らない nuance a negation (X remains possible)", "identical", "ないとも限らない denies more strongly", "とは限らない expresses the positive possibility"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「だからこそ、大切にしなければならない」- meaning?",
      ...
      { t: "usage", q: "「これこそ私が探していたものだ」: こそ is expressed here:",
...

  {
    ...
    qs: [
      { t: "fill", q: "彼女がそんなことをするなんて、信じられない。", fr: "I can't believe she would do such a thing.",
        o: ["なんて（incredulity depreciative）", "など（liste neutre）", "こそ（emphase）", "さえ（condition）"], a: 0,
        e: "なんて expresses surprise/incredulity, often disparaging." },
      { t: "meaning", q: "「りんごやみかんなど、フルーツが好きです」- meaning of など?",
        o: ["non-exhaustive example (and others)", "depreciation", "emphasis", "opposition"], a: 0,
        e: "など after a list = examples, there are more." },
      { t: "nuance", q: "Registers of など / なんか / なんて :",
        o: ["など neutral; なんか colloquial; なんて colloquial + strong feeling", "など is familiar", "なんか is formal", "they are identical"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「この問題は私には手に負えないほど難しい」- meaning?",
...

  {
    ...
    qs: [
      { t: "fill", q: "日本語は勉強すれ＿＿＿、奥が深いと感じる。", fr: "The more you study Japanese, the more you feel its depth.",
        ...
        e: "Proportional → 〜ば〜ほど." },
      { t: "meaning", q: "「高ければ高いほど品質が良いとは限らない」- meaning?",
      ...
      { t: "usage", q: "Structure of 〜ば〜ほど :",
        o: ["V-ばV-辞書ほど (V repeated)", "V-ばV-た形ほど", "V-たらV-てほど", "V-ているV-るほど"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Which words typically precede 〜ことか?",
        o: ["interrogative: どれほど, 何度, どんなに", "concrete names", "precise figures", "adverbs of time"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「そんなこと、できるものか」- meaning?",
      ...
      { t: "nuance", q: "Difference between ものか and 〜ことか :",
        o: ["ものか = refusal/indignation; ことか = exclamation about the intensity of a feeling", "they are identical", "ことか expresses refusal", "ものか is positive exclamative"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「不思議なことに、彼はそれを知っていた」- meaning?",
      ...
      { t: "usage", q: "With what type of adjective is 〜ことに used?",
        o: ["feeling adjectives (驚いた, 残念な, 嬉しい...)", "color adjectives", "size adjectives", "nationality adjectives"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「彼の笑顔には、人を安心させるものがある」- meaning?",
      ...
      { t: "usage", q: "〜ものがある typically focuses on :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「将来が不安でならない」- meaning?",
      ...
      { t: "nuance", q: "てならない, てたまらない, てしかたがない have in common:",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「彼女のことが好きでたまらない」- meaning?",
      ...
      { t: "nuance", q: "てたまらない is often more _____ than てならない :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「眠くてしようがなかった」- meaning?",
        o: ["I had an unbearable sleep", "I couldn't sleep", "I wasn't sleepy", "I slept"], a: 0,
        e: "てしようがない = so much... it's unmanageable." },
      { t: "nuance", q: "しようがない and しかたがない are :",
        o: ["quasi-synonyms; しようがない is slightly more familiar", "opposite", "the first is formal", "unrelated"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「とうとう会社を首になる始末だ」- meaning?",
      ...
      { t: "nuance", q: "〜始末だ vs 〜あげく [[g099]]:",
        o: ["始末だ emphasizes scandalous/honorable; あげく emphasizes long, arduous process", "they are identical", "あげく is more negative", "始末だ is neutral"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「こんな失敗をしてしまい、恥ずかしい限りです」- meaning?",
      ...
      { t: "nuance", q: "〜限りだ is mainly used in what register?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「完璧主義になりすぎるきらいがある」- meaning?",
      ...
      { t: "usage", q: "〜きらいがある belongs to which register?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Distinguish 〜一方だ from 〜一方で [[g030]]:",
        o: ["一方だ = continuous trend (evolution); 一方で = contrast (on one side X, on the other Y)", "they are identical", "一方で expresses the trend", "一方だ expresses contrast"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「仕事を始めたばかりです」- meaning?",
      ...
      { t: "nuance", q: "Distinguish 〜てばかりいる from 〜たばかり :",
        o: ["てばかりいる = repeated exclusivity (critical); たばかり = just after the action", "they are identical", "たばかり is exclusive", "てばかりは positive"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「貧しいばかりか、病気にもなった」- meaning?",
      ...
      { t: "nuance", q: "〜ばかりか vs 〜ばかりに [[g046]]:",
        o: ["ばかりか = not only (addition); ばかりに = precisely because of (consequence)", "they are identical", "ばかりに = addition", "ばかりか = cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「そんなこと知らないとばかりに、彼はそっぽを向いた。」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "〜んばかり is register :",
        o: ["literary / sustained", "familiar", "childish", "oral fluency"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「言うまでもなく、健康は大切だ」- meaning?",
      ...
      { t: "nuance", q: "〜までもない vs 〜ことはない [[g121]] :",
        o: ["までもない insists on \"no need to go as far as\"; ことはない = simply unnecessary", "identical", "ことはない is stronger", "までもない is familiar"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「人を傷つけてまで、成功したくない」- meaning?",
      ...
      { t: "usage", q: "〜てまで is often followed by :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「つい嬉しかったものだから、言ってしまった」- meaning?",
      ...
      { t: "nuance", q: "〜ものだから vs 〜ので :",
        o: ["ものだから = subjective personal justification (often excuse); ので = neutral/objective cause", "identical", "ので is more personal", "ものだから is more neutral"], a: 0,
  ...
  {
    id: "g161", g: "〜といった", m: "such as, like (list examples)", f: "Name₁（、Name₂）+ といった + Name-category",
    ...
    qs: [
      ...
      { t: "meaning", q: "「東京や大阪といった大都市では家賃が高い」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「嬉しいやら恥ずかしいやら」- meaning?",
      ...
      { t: "usage", q: "〜やら alone (「どうなるやら」) expresses :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「謝るなり説明するなりしてほしい」- meaning?",
      ...
      { t: "nuance", q: "〜なり〜なり vs 〜にしろ〜にしろ [[g080]]:",
        o: ["なり〜なり = offers options (choose); にしろ〜にしろ = whatever the option, the conclusion is the same", "identical", "にしろ offers a range of options", "なりは sets a single option"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「発音からして、この人は日本語が上手だ」- meaning?",
      ...
      { t: "nuance", q: "〜からして can also express :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「偉大な芸術家にして思想家であった」- meaning?",
      ...
      { t: "nuance", q: "〜にして (double quality) differs from 〜として [[g005]] by :",
        o: ["にして = two simultaneous qualities; として = role / capacity in which one acts", "they are identical", "として = double quality", "にして = role"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「居ながらにして世界中の情報が得られる」- meaning?",
      ...
      { t: "nuance", q: "Distinguish ながらに from ながら [[g026]] :",
        o: ["ながらに = state maintained (from birth, tears in eyes); ながら = two simultaneous actions", "identical", "ながらに = two shares", "ながら = state maintained"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「この出会いをきっかけとして、友情が育まれた」- meaning?",
      ...
      { t: "nuance", q: "〜を契機として is the _____ version of 〜を契機に :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「期待に応えて、好成績を残した。」- meaning?",
      ...
      { t: "nuance", q: "〜に応えて vs 〜に応じて [[g011]] :",
        o: ["に応えて = respond actively (concrete effort); に応じて = adapt according to circumstances", "identical", "に応じて is more active", "に応えて = adaptation"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「原発をめぐる問題は複雑だ」- meaning?",
      ...
      { t: "usage", q: "〜をめぐる is the _____ form of 〜をめぐって :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「データをもとにして分析した」- meaning?",
        o: ["analysis based on data", "analyze despite data", "analyze data", "analyze without data"], a: 0,
        e: "をもとにして = take X as the basis for work." },
      { t: "nuance", q: "〜をもとにして and 〜をもとに [[g008]]:",
        o: ["quasi-synonyms; をもとにして slightly more formal", "opposite", "をもとにして is less formal", "they cannot change a name"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「この法律はプライバシーに関する規定だ」- meaning?",
      ...
      { t: "usage", q: "〜に関する is the adnominal form of :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「ビジネスにおける信頼の重要性」- meaning?",
      ...
      { t: "nuance", q: "〜における is the _____ form of 〜において [[g004]] :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「人によっては賛成しない場合もある」- meaning?",
      ...
      { t: "usage", q: "〜によっては vs 〜によって [[g003]] :",
        o: ["によっては = possible variation depending on the case; によって = cause/medium/agent", "identical", "によって expresses the variation", "によっては expresses the cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「彼にとっては、お金より時間が大切だ」- meaning?",
      ...
      { t: "nuance", q: "Difference between にとって and にとっては :",
        o: ["にとっては adds contrastive nuance (especially for X)", "identical", "にとっては is more general", "にとって implies contrast"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「スマホをはじめとするデジタル機器が普及した」- meaning?",
      ...
      { t: "usage", q: "〜をはじめとする is the _____ form of 〜をはじめ :",
...

  {
    ...
    qs: [
      { t: "fill", q: "医療の分野＿＿、AI の活用が進んでいる。", fr: "In the medical field, the use of AI is progressing.",
        o: ["においては", "について", "として", "に基づいて"], a: 0,
        e: "Formal thematic framework → 〜においては." },
      { t: "meaning", q: "「科学においては、証拠が重要だ」- meaning?",
      ...
      { t: "usage", q: "〜においては is :",
        o: ["〜において + は (thematization)", "an interrogative form", "an adnominal form", "a familiar shape"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「苦労しただけのことはある」- meaning?",
      ...
      { t: "nuance", q: "〜だけの vs 〜だけに [[g045]] :",
        o: ["だけの = sufficient quantity for; だけに = precisely because of (causal reinforcement)", "identical", "だけに = quantity", "だけの = cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「機会のある折に、ぜひ挑戦してください」- meaning?",
      ...
      { t: "usage", q: "〜折に belongs to which register?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「どんなに苦しかったことだろう」- meaning?",
      ...
      { t: "nuance", q: "〜ことだろう vs 〜ことか [[g142]] :",
        o: ["ことだろう = empathy (imagining a state); ことか = speaker's direct exclamation", "identical", "ことか expresses empathy", "ことだろう is a direct exclamation"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「伝えたいことが伝えられずじまいだった」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「私の気持ちをよそに、話は進んだ」- meaning?",
      ...
      { t: "nuance", q: "Distinguish 〜をよそに from 〜もかまわず [[g073]] :",
        o: ["をよそに insists on disregard for the concerns of others; もかまわず on indifference to one's own inconvenience", "identical", "もかまわず concerns others", "をよそに is about yourself"], a: 0,
