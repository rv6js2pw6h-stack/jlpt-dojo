...
const N3_GRAMMAR = [
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「社長をはじめ、社員全員が参加した」- meaning of をはじめ?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜にかかわらず vs 〜にもかかわらず: what's the difference?",
        o: ["にかかわらず = no matter (regardless of variation); にもかかわらず = despite (concession on a specific fact)", "they are identical", "にもかかわらず expresses a variation", "にかかわらず expresses a concession"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「国籍を問わず採用する」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜をもとに vs 〜に基づいて: nuance?",
        o: ["をもとに insists on the starting material for a creation; に基づいて insists on conformity to a rule/principle", "identical", "をもとに is more formal", "に基づいて is for stories only"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「一年を通して雨が多い」- meaning of を通して?",
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Which sentence is the most natural?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜に応じて vs 〜によって（変化）: nuance?",
        o: ["に応じて insists on active adaptation to a variation; によって simply notes that it varies from case to case", "identical", "に応じて is familiar", "によって never marks the variation"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「海岸に沿って歩く」- meaning of に沿って?",
  ...
  {
    id: "g009", g: "〜にわたって／にわたる", m: "over an area of, for the entire duration of the", f: "Name (duration/quantity/space) + にわたって／にわたる＋Nom",
    ...
    qs: [
      ...
      { t: "nuance", q: "〜にわたって vs 〜を通して: nuance?",
        o: ["にわたって emphasizes breadth/extent; を通して stresses continuity \"throughout\"", "identical", "を通して is not used for time", "にわたって is familiar"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Most formal register for \"during the ceremony\"?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜に際して vs 〜際（に）: nuance?",
        o: ["に際して is more solemn and concerns a significant moment; 際に is more neutral (\"during\")", "identical", "際に is more formal", "に際して concerns the past only"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜に先立って vs 〜前に: nuance?",
        o: ["に先立って is formal and implies preparation for a milestone event; 前に is neutral and general", "identical", "前に is more formal", "に先立って concerns the future only"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜に伴って vs 〜につれて: nuance?",
        o: ["に伴って also accepts one-off changes and is more formal; につれて requires gradual, continuous variation", "identical", "につれて is formal", "に伴って never marks the change"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「年を取るに従って、体力が落ちる」- meaning of に従って?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜にとって vs 〜に対して: nuance?",
        o: ["にとって = point of view/evaluation (\"for X\"); に対して = action directed toward a target (\"toward X\").", "identical", "にとって marks an opposition", "に対して expresses a point of view"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「できないくせに、口だけは達者だ」- meaning of くせに?",
      ...
      { t: "nuance", q: "〜くせに vs 〜のに: difference?",
        o: ["くせに contains a strong personal reproach; のに expresses a more neutral contradiction/disappointment", "identical", "のに is always a reproach", "くせに is not used with people"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「この仕事は大変な割に給料が安い」- meaning of 割に?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ものの vs 〜のに: nuance?",
        o: ["ものの is more written/posed; のに often adds a sense of disappointment or reproach", "identical", "のに is more formal", "ものの expresses a cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "In \"歩きながら話す\" and \"狭いながらも快適だ\", the meaning of ながら is:",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「収入が増える一方で、支出も増えた」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「便利になったとはいえ、問題も多い」- meaning of とはいえ?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜にもかかわらず vs 〜にかわらず: difference?",
        o: ["にもかかわらず = despite (a specific fact); にかかわらず = regardless of variation", "identical", "にかかわらず = in spite of", "にもかかわらず = whatever"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Which connector expresses disappointment after a favorable cause?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「季節が変わるたびに服を買う」- meaning?",
  ...
  {
    id: "g026", g: "〜おきに", m: "every... (at intervals of)", f: "Duration／Number + おきに",
    ...
    qs: [
      ...
      { t: "nuance", q: "「一週間おきに」signifies most naturally:",
  ...
  {
    id: "g027", g: "〜ごとに", m: "every, every, every", f: "Duration／Number／N + ごとに",
    ...
    qs: [
      ...
      { t: "nuance", q: "「二日ごとに」vs「二日おきに」- which pair is correct?",
        o: ["ごとに = every 2 days; おきに = 2 days apart (= every 3 days)", "they are identical", "おきに = every 2 days", "ごとに implies an empty interval"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「子供が寝ているうちに掃除する」- meaning of うちに?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜たとたん vs 〜次第: difference?",
        o: ["とたん: Y arrives spontaneously/unplanned after X (past); 次第: Y is done voluntarily as soon as X (often future)", "identical", "次第 is familiar", "とたん expresses a will"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「結果は君の頑張り次第だ」- meaning of 次第?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「予約してからでないと入れない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜際に vs 〜とき: nuance?",
        o: ["際に is more formal (instructions, announcements); とき is neutral and commonplace", "identical", "とき is more formal", "際に is familiar"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜おかげで vs 〜せいで: difference?",
        o: ["おかげで = cause of a positive result (gratitude); せいで = cause of a negative result (reproach)", "identical", "せいで is positive", "おかげで is negative"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「気のせいか、音が聞こえた」- meaning of せいか?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ので vs 〜から: nuance?",
        o: ["ので = cause presented as objective, more polite; から = cause more subjective/assertive", "identical", "から is more polite", "ので expresses a concession"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「日本に来たからには、日本語を勉強しよう」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜以上は vs 〜からには: nuance?",
        o: ["very similar meaning; 以上は is a little more written/logical, からには more focused on personal resolution", "totally opposed", "以上は expresses time", "からには expresses a concession"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Which sentence best expresses resolution after an irreversible event?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「天気さえよければ、出かけよう」- meaning of さえ〜ば?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「健康があってこそ、仕事もできる」- meaning of てこそ?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ために (goal) vs 〜ように (goal): when do we use ように?",
        o: ["ように is used with non-voluntary/potential verbs (見えるように); ために with voluntary verbs (合格するために)", "identical", "ために concerns the states", "ように expresses a cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「手伝うかわりに、お昼をおごってね」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜に違いない vs 〜に決まっている: nuance?",
        o: ["に違いない = reasoned conviction (posed); に決まっている = clear-cut subjective certainty (colloquial)", "identical", "に決まっている is formal", "に違いない expresses doubt"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「子供が喜ぶに決まっている」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜はずだ vs 〜に違いない: nuance?",
        o: ["はずだ = objective logical expectation; に違いない = strong subjective conviction", "identical", "はずだ is more subjective", "に違いない is a neutral deduction"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜はずがない vs 〜わけがない: nuance?",
        o: ["very close meaning (\"impossible\"); わけがない is often more oral/emphatic", "totally opposed", "はずがない is positive", "わけがない expresses a cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜べきだ vs 〜なければならない: nuance?",
        o: ["べきだ = moral judgment/advice (\"it is advisable to\"); なければならない = factual obligation/rule", "identical", "べきだ relates to laws", "なければならない is an advice"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「秘密を漏らすべきではない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「フランスに住んでいたのか。フランス語が話せるわけだ」- meaning of わけだ?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜わけがない vs 〜わけではない: difference?",
        o: ["わけがない = totally impossible; わけではない = not necessarily / it's not that", "identical", "わけがない = partially true", "わけではない = totally impossible"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「日本語が話せないわけではない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「秘密を話さないわけにはいかなかった」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「昔はよく映画を見たものだ」- meaning of ものだ?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ものだから vs 〜から: nuance?",
        o: ["ものだから insists on an involuntary and strong apology/reason; から is neutral", "identical", "から is an excuse", "ものだから expresses a goal"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「まるで時間が止まったかのようだった」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Which expression concludes a line of reasoning by rephrasing?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「彼は一社員に過ぎない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜に他ならない vs 〜に過ぎない: nuance?",
        o: ["に他ならない emphasizes (\"it's precisely X\"); に過ぎない minimizes (\"it's only X\")", "identical", "に他ならない minimizes", "に過ぎない adds value"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜てたまらない vs 〜てしょうがない: nuance?",
        o: ["very similar meaning; しょうがない is more familiar/oral", "totally opposed", "たまらない is familiar", "しょうがない expresses an obligation"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜てならない is mostly used with :",
        o: ["spontaneous feelings/sensations (心配だ、気になる...)", "orders", "banns", "weather forecasts"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ことなく vs 〜ないで: nuance?",
        o: ["same meaning; ことなく is more formal/written", "opposite", "ないで is more formal", "ことなく expresses a cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「赤いことから『赤橋』と名付けられた」- meaning of ことから?",
...

  {
    ...
    c: "modality", lv: 1, rel: [],
    note: "Indicates an established rule, usage or arrangement that is binding. \"That's how it was planned/agreed\".",
    ex: [
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ことになっている vs 〜ことにしている: difference?",
        o: ["ことになっている = external/convenient rule; ことにしている = self-imposed rule", "identical", "ことにしている = external rule", "ことになっている = personal habit"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜さえ vs 〜すら: nuance?",
        o: ["close meaning (\"same\"); すら is more written/literary and more emphatic", "opposite", "すら is familiar", "さえ is only conditional"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「挨拶すらしない」- meaning of すら?",
...

  {
    ...
    note: "Familiar. (1) \"same X\" (as でも); (2) \"it seems that / I heard that\" (oral hearsay).",
    ex: [
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜からこそ vs 〜から: nuance?",
        o: ["からこそ strongly emphasizes exclusive reason; から is neutral", "identical", "から is emphatic", "からこそ expresses a concession"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「来年こそ合格する」- meaning of こそ?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「休むどころか、もっと忙しくなった」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ばかりか vs 〜どころか: nuance?",
        o: ["ばかりか = addition in the same direction (\"en plus\"); どころか = reversal (\"au contraire\")", "identical", "ばかりか reverses expectation", "どころか adds"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "What word often follows 〜だけでなく?",
        o: ["も (\"also\")", "を", "が", "へ"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜のみならず vs 〜だけでなく: nuance?",
        o: ["same meaning; のみならず is more written/formal", "opposite", "だけでなく is more formal", "のみならず reverses expectation"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「仲間とともに戦う」- meaning of とともに?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Is 〜につれて used with a punctual change?",
        o: ["no: it requires gradual, continuous variation", "yes, especially punctual", "yes, like とたんに", "only in the past tense"], a: 0,
...

  {
    ...
    note: "Parallel progression (like につれて) with the added nuance of \"following/in accordance with\". Slightly more formal register.",
    ex: [
    ...
    qs: [
      ...
      { t: "nuance", q: "〜にしたがって and 〜につれて are :",
        o: ["very similar (parallel progression); にしたがって is a little more formal and retains the idea of \"following\"", "opposite", "につれて is formal", "にしたがって is punctual"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "When do we use ように rather than ために for the purpose?",
        o: ["with a potential/non-voluntary verb or negation (見えるように、忘れないように)", "always", "never with negation", "only with names"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「赤ちゃんが歩こうとしている」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「真実を認めようとしない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜てもかまわない vs 〜てもいい: nuance?",
        o: ["close meaning; かまわない insists on \"no matter / unashamedly\"", "opposite", "てもいい expresses a prohibition", "かまわない is an obligation"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「死ぬほど疲れた」- meaning of ほど?",
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Correct form of the correlation \"the more you read, the more you understand\"?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「できるだけ手伝う」- meaning of だけ?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜なり vs 〜たとたん: nuance?",
        o: ["very similar; なり is more literary and the 2nd action is often an impulsive action by the same person", "opposite", "なり is familiar", "たとたん expresses a willingness"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「着くか着かないかのうちに」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜をよそに vs 〜もかまわず: nuance?",
        o: ["をよそに = ignoring the concerns of others; もかまわず = not caring about a bother (often to oneself).", "identical", "もかまわず concerns others", "をよそに is about yourself"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「危険もかまわず助けに行った」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「願いを込めて鐘を鳴らす」- meaning of を込めて?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜あげく vs 〜末に: nuance?",
        o: ["あげく often has a negative/regrettable outcome; 末に is more neutral (\"finally, after\")", "identical", "末に is negative", "あげく is positive"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜上で vs 〜てから: nuance?",
        o: ["上で insists on \"based on X (reflected step)\"; てから = simple temporal succession", "identical", "てから is formal", "上で = before"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜上に vs 〜反面: difference?",
        o: ["上に adds an element of the same orientation; 反面 introduces an opposite aspect", "identical", "上に = opposition", "反面 = addition"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜かねる vs 〜かねない: relationship?",
        o: ["かねる = can't do; かねない = risk of (could well happen)", "synonyms", "かねる = risk", "かねない = can't"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「うそをつきかねない人だ」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜がたい vs 〜にくい: nuance?",
        o: ["がたい = psychological/abstract difficulty (sustained); にくい = practical/physical difficulty", "identical", "にくい is supported", "がたい is familiar"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ことだ vs 〜ものだ: nuance?",
        o: ["ことだ = targeted advice to an interlocutor; ものだ = general truth/standard", "identical", "ものだ = advice", "ことだ = nostalgia"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「子供のことだから、すぐ飽きるよ」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「困ったことに、鍵をなくした」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜最中に vs 〜ているうちに: nuance?",
        o: ["最中に = at the climax of the action (often interruption); うちに = enjoy the duration", "identical", "うちに = interruption", "最中に = profit"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Form in ざるを得ない from する?",
...

  {
    ...
    note: "Only one option remains: \"nothing left but to...\". With a noun: \"il n'y a que...\".",
    ex: [
    ...
    qs: [
      ...
      { t: "nuance", q: "〜しかない vs 〜ざるを得ない: nuance?",
        o: ["close meaning; ざるを得ない is more formal and emphasizes external constraint", "opposite", "しかない is formal", "ざるを得ない = free choice"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「感動せずにはいられない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「留学しただけあって、英語が上手だ」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜だけに vs 〜だけあって: nuance?",
        o: ["だけに often reinforces a feeling (positive OR negative); だけあって emphasizes a deserved result (positive)", "identical", "だけに is always positive", "だけあって is negative"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜たところで vs 〜ても: nuance?",
        o: ["たところで emphasizes uselessness/low effect; ても = simple concession", "identical", "ても = uselessness", "たところで = cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜つ vs 〜ながら: nuance?",
        o: ["same meaning; つつ is more written/literary", "opposite", "ながら is literary", "つつ = cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜つつある vs 〜ている: nuance?",
        o: ["つある = written, insists on moving towards a term; ている = state/action in progress (neutral)", "identical", "ている is literary", "つある = frozen state"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜っこない is equivalent to :",
        o: ["〜わけがない／はずがない (familiar)", "〜かもしれない", "〜に違いない", "〜ことになる"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜て以来 vs 〜てから: nuance?",
        o: ["以来 = from a starting point, enduring state until now (sustained); てから = simple succession", "identical", "てから is supported", "以来 = before"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「先生といえば、来週来るそうだ」- role of といえば?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜というものだ vs 〜というわけだ: nuance?",
        o: ["というものだ = emphatic general definition/judgment; というわけだ = logical conclusion to a line of reasoning", "identical", "というわけだ = definition", "というものだ = conclusion"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「休みといっても、仕事の連絡が来る」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「思いどおりにならない」- meaning?",
...

  {
    ...
    note: "(1) uncertain relationship (\"it seems that / I heard that\"); (2) vague enumeration of examples.",
    ex: [
    ...
    qs: [
      { t: "fill", q: "天気予報では、明日は雪が降る＿＿＿。", fr: "According to the weather forecast, it will snow tomorrow.",
        o: ["とか", "から", "ので", "のに"], a: 0,
        e: "〜とか (end of sentence) = uncertain relationship (\"it seems that / I heard that\")." },
      { t: "nuance", q: "〜とか (hearsay) is more... than 〜そうだ :",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「逃げるところを捕まえた」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜としても vs 〜とすれば: difference?",
        o: ["としても = concession (\"even if\"); とすれば = hypothesis-consequence (\"if we assume, then\")", "identical", "としても = simple assumption", "とすれば = concession"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「君がやらないとしたら、誰がやる？」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「合格するとは驚きだ」- meaning of とは?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「お金がないことには、何もできない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜にあたって vs 〜に際して: nuance?",
        o: ["very close (formal occasion); にあたって is turned towards an action we're about to undertake", "opposite", "に際して = familiar", "にあたって = past tense"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜に応えて vs 〜に応じて: nuance?",
        o: ["に応えて = meeting an expectation/demand; に応じて = adapting to a variation/condition", "identical", "に応じて = to meet an expectation", "に応えて = variation"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「歌にかけては誰にも負けない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「経験に加えて知識も豊富だ」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「手紙にかわってメールが使われる」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「以前に比べて元気になった」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜にしては vs 〜割に: nuance?",
        o: ["near sense (offset from expectation); にしては starts from a precise criterion/standard", "opposite", "割に = precise standard", "にしては = no offset"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜にしろ／にせよ is equivalent to :",
        o: ["〜にしても (formal concession)", "〜から (cause)", "〜ために (goal)", "〜ながら (simultaneity)"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜に相違ない vs 〜に違いない: nuance?",
        o: ["same meaning; に相違ない is more written/formal", "opposite", "に違いない is formal", "に相違ない expresses doubt"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「何かにつけ世話になる」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「人は見かけによらない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「厳しい規則のもとで働く」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ばかりに vs 〜せいで: nuance?",
        o: ["ばかりに insists on a single cause with regrettable consequences; せいで = simple negative cause", "identical", "ばかりに = positive result", "せいで = single cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「子供はもちろん、大人も楽しめる」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「冗談はともかく、本題に入ろう」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜反面 vs 〜上に: difference?",
        o: ["反面 opposes two aspects; 上に adds two aspects of the same meaning.", "identical", "反面 = addition", "上に = opposition"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜向き vs 〜向け: nuance?",
        o: ["向き = suitable/fit (spontaneously); 向け = designed especially for (intention)", "identical", "向き = designed for", "向け = exposure"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「彼の決意には固いものがある」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ゆえに is equivalent, in more sustained form, to :",
        o: ["〜から／ので (cause)", "〜ても (concession)", "〜ように (goal)", "〜たり (enumeration)"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「事故をきっかけに安全対策を見直した」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜を契機に vs 〜をきっかけに: nuance?",
        o: ["same meaning; を契機に is more formal/written", "opposite", "をきっかけに is formal", "を契機に = familiar"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「環境問題を中心に議論した」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜をめぐって vs 〜について: nuance?",
        o: ["をめぐって involves several opposing/debating parties; について = simple theme", "identical", "について = conflict", "をめぐって = neutral theme"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「誠意をもって対応する」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ぬきには vs 〜抜きで: nuance?",
        o: ["ぬきには = without X it's impossible (followed by negation); 抜きで = without X (simple omission)", "identical", "抜きで = impossible", "ぬきには = simple omission"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ばかりだ (evolution) is distinguished from 〜てばかり (excess) because:",
        o: ["ばかりだ = trend that is only moving in one direction; てばかり = only doing (repeating)", "identical", "ばかりだ = repeat", "てばかり = evolution"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「お礼を言えずじまいだった」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ことなしに vs 〜ことなく: nuance?",
        o: ["very close meaning; ことなしに is often followed by an impossibility/condition", "opposite", "ことなく = impossible", "ことなしに = familiar"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「初公開とあって、行列ができた」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜とあれば vs 〜とあって: difference?",
        o: ["とあれば = hypothesis (\"if this is the case\"); とあって = established fact (\"given that\")", "identical", "とあって = assumption", "とあれば = established fact"], a: 0,
        e: "あれば (hypothetical) ≠ あって (factual)." },
    ],
  },

  {
    id: "g167", g: "〜たりとも", m: "not even one", f: "一＋counter + たりとも（＋negation）",
    ...
    qs: [
      ...
      { t: "meaning", q: "「一人たりとも逃さない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「誰であれ、ルールは守るべきだ」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「無理してでもやり遂げる」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜限りだ is mostly used with :",
        o: ["feeling adjectives (うれしい、寂しい...).", "action verbs", "numbers", "banns"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「年上が正しいとは限らない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜に限らず vs 〜はもちろん: nuance?",
        o: ["close meaning (enlargement); に限らず = \"not limited to X\".", "opposite", "に限らず = restriction", "はもちろん = exclusion"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「働きすぎたあまり、倒れた」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜だらけ vs 〜まみれ: nuance?",
        o: ["だらけ = full of (objects, faults, everywhere); まみれ = covered with a substance (sweat, blood, mud)", "identical", "まみれ = mistakes", "だらけ = liquid substance"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜がてら vs 〜ながら: nuance?",
        o: ["がてら = taking advantage of an outing to do a 2nd thing (secondary purpose); ながら = two strictly simultaneous actions", "identical", "ながら = second-hand", "がてら = strict simultaneity"], a: 0,
...

  {
    ...
    qs: [
      { t: "fill", q: "注意する＿＿＿、また同じ間違いをする。", fr: "No sooner had I taken him back than he made the same mistake again.",
        ...
        e: "〜そばから = no sooner done than undone (注意するそばから)." },
      { t: "nuance", q: "〜そばから vs 〜たとたん: nuance?",
        o: ["そばから = immediate annoying repetition; たとたん = a single event occurring immediately afterwards", "identical", "たとたん = repetition", "そばから = unique"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Nuance of 〜ことだし compared to 〜から?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜や否や is, in more literary terms, close to :",
        o: ["〜とたんに／〜なり (immediacy)", "〜ながら (long simultaneity)", "〜ために (goal)", "〜ので (cause)"], a: 0,
