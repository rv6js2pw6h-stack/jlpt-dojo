...
const N4_GRAMMAR = [
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「歴史について調べる」- meaning of について?",
  ...
  {
    id: "g002", g: "〜に対して／に対する", m: "toward, against, facing; contrary to", f: "Nom + に対して／に対する＋Nom",
    ...
    qs: [
      ...
      { t: "nuance", q: "〜に対して vs 〜について: difference?",
        o: ["に対して = action/attitude directed at a target; について = simple theme talked about", "identical", "について expresses opposition", "に対して expresses a neutral theme"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "To report information (\"according to the weather...\"), we say 天気予報＿＿＿....",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「大雨のために試合が中止になった」- meaning of ために?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜にとって vs 〜に対して: difference?",
        o: ["にとって = point of view/assessment; に対して = action directed at a target", "identical", "にとって marks an opposition", "に対して expresses a point of view"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「記念として写真を撮る」- meaning of として?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜において vs 〜で: nuance?",
        o: ["において is more formal/written; で is neutral and current", "identical", "で is more formal", "において is familiar"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜に関して vs 〜について: nuance?",
        o: ["same meaning (\"about\"); に関して is more formal/written", "opposite", "について is more formal", "に関して expresses a cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「一年を通して観光客が多い」- meaning of を通して?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「経験をもとに本を書いた」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜が vs 〜けど: nuance?",
        o: ["same meaning (\"but\"); が is a bit more formal/written, けど more colloquial", "opposite", "けど is more formal", "が expresses a cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Most polite/written form among: けど / けれど / けれども?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜のに vs 〜けど: nuance?",
        o: ["のに adds disappointment/criticism; けど is a simple neutral contrast", "identical", "けど expresses disappointment", "のに expresses a cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「失敗しても、また挑戦する」- meaning of ても?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「収入が増えたのに対して、支出も増えた」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「働く一方で、勉強も続けている」- meaning of 一方で?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "In \"歩きながら\" and \"知っていながら\", ながら means:",
...

  {
    ...
    note: "Taking advantage of a period of time, or a change that occurs during that period (\"by dint of...\").",
    ex: [
    ...
    qs: [
      ...
      { t: "meaning", q: "「住んでいるうちに、町が好きになった」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜たばかり vs 〜たところ: nuance?",
        o: ["ばかり = subjectively recent (may be several days old); ところ = objectively right now", "identical", "ところ = a long time ago", "ばかり = future"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「卒業してから、ずっと働いている」- meaning of てから?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「窓を開けたら、鳥がいた」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜までに vs 〜まで: difference?",
        o: ["までに = before a deadline (one-time action); まで = until (continuous action)", "identical", "まで = due date", "までに = continuity"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「これから始めるところだ」- meaning?",
...

  {
    ...
    qs: [
      { t: "fill", q: "国を出る＿＿＿、両親が泣いた。", fr: "As I left the country, my parents cried.",
        ...
        e: "〜とき = when." },
      { t: "nuance", q: "「日本に行くとき」vs「日本に行ったとき」- difference?",
        o: ["行くとき = before/when leaving; 行ったとき = once there", "identical", "行くとき = after arrival", "行ったとき = before departure"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜あいだ vs 〜あいだに: difference?",
        o: ["あいだ = continuous action over the entire duration; あいだに = one-off action at one point in the interval", "identical", "あいだに = continuous action", "あいだ = one-off action"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Which sentence is NATURAL with ば?",
        o: ["ボタンを押せば、ドアが開く（general truth）", "雨が降れば、傘を貸してあげる（request/offer）", "暑ければ、窓を開けてください（ordre）", "高ければ、買ってください（demande）"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜たら vs 〜ば: main nuance?",
        o: ["たら accepts requests/orders/desires in principal; ば avoids them (general truths)", "identical", "ば is more flexible", "たら never marks the future"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Can we say \"春になると、出かけてください\"?",
        o: ["no: the principal of と cannot be a request/order", "yes, that's correct", "yes, like たら", "only in the past tense"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "「日本に行ったら写真を撮る」vs「日本に行くなら、カメラを買う」- role of なら?",
        o: ["なら: the main action precedes or advises on the condition; たら: the action follows the realized condition", "identical", "なら = action after", "たら = advice before"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜おかげで vs 〜せいで: difference?",
        o: ["おかげで = positive result (gratitude); せいで = negative result (reproach)", "identical", "せいで = positive", "おかげで = negative"], a: 0,
        e: "おかげで → good; せいで → bad." },
    ],
  },

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「機械の故障のせいで作業が止まった」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「雪のために道が閉鎖された」- meaning of ために?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「心配してもしょうがない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜そうだ (様態) vs 〜そうだ (伝聞): difference in form?",
        o: ["様態 : V-ます stem + そう (降りそう); 伝聞 : plain form + そう (降るそうだ)", "identical", "伝聞 removes the radical", "様態 uses the plain form"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「春らしい天気だ」- meaning of らしい?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ようだ vs 〜らしい: nuance?",
        o: ["ようだ = deduction based on one's own observations; らしい = rather external/heard information", "identical", "らしい = direct feeling", "ようだ = hearsay"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜はずだ vs 〜つもりだ: difference?",
        o: ["はずだ = objective logical expectation; つもりだ = personal intention to do", "identical", "はずだ = intention", "つもりだ = deduction"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「彼に会わないつもりだ」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜かもしれない vs 〜にちがいない: difference in certainty?",
        o: ["かもしれない = low certainty; にちがいない = high certainty", "identical", "かもしれない = high degree of certainty", "にちがいない = doubt"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「彼は知っているにちがいない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜べきだ vs 〜なければならない: nuance?",
        o: ["べきだ = moral judgment; なければならない = concrete necessity/rule", "identical", "べきだ = official rule", "なければならない = moral advice"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「電車が行ってしまった」- meaning of てしまう?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ていく vs 〜てくる (change): nuance?",
        o: ["ていく = evolution towards the future (from now); てくる = evolution from the past to now", "identical", "ていく = to the past", "てくる = towards the future"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「日本語が分かってきた」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "「窓が開けてある」vs「窓が開いている」- difference?",
        o: ["開けてある = someone has opened it voluntarily (resulting state); 開いている = simple state (without implied agent)", "identical", "開けてある = natural state", "開いている = voluntary action"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜てほしい vs 〜たい: difference?",
        o: ["てほしい = wanting SOMEONE ELSE to do; たい = wanting to do IT YOURSELF", "identical", "てほしい = yourself", "たい = others"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ようにする vs 〜ことにする: nuance?",
        o: ["ようにする = progressive effort/habit; ことにする = firm one-off decision", "identical", "ことにする = gradual effort", "ようにする = single decision"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ようになる vs 〜ようにする: difference?",
        o: ["ようになる = change undergone/result (\"to become\"); ようにする = voluntary effort (\"to strive\")", "identical", "ようになる = volunteer", "ようにする = suffered"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ことにする vs 〜ことになる: difference?",
        o: ["ことにする = I decide for myself; ことになる = it's decided by circumstances/others", "identical", "ことになる = personal decision", "ことにする = external decision"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「結婚することになりました」- nuance compared to \"結婚することにしました\"?",
        o: ["なる presents marriage as an outcome/announcement (less focused on personal decision)", "なる = strictly personal decision", "なる and する are identical here", "なる = refusal to marry"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ことにしている vs 〜ことになっている: difference?",
        o: ["している = personal rule; なっている = external/convenient rule", "identical", "している = external rule", "なっている = personal habit"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "「行くことがある」vs「行ったことがある」- difference?",
        o: ["行くことがある = I sometimes go there (sometimes); 行ったことがある = I've been there (experience)", "identical", "行くことがある = past experience", "行ったことがある = future habit"], a: 0,
...

  {
    ...
    qs: [
      { t: "fill", q: "お酒を飲み＿＿＿て、頭が痛い。", fr: "I've had too much to drink and my head hurts.",
        o: ["すぎ", "やすく", "にくく", "たく"], a: 0,
        e: "〜すぎる = excess (飲みすぎて)." },
      { t: "usage", q: "Correct form of \"too expensive\" with すぎる?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「考え方が違う」- meaning of 方?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「三日ほどかかる」- meaning of ほど?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜だけ vs 〜しか: difference?",
        o: ["だけ is built with the affirmative (neutral tone); しか requires the negative (insists on \"nothing more\")", "identical", "だけ requires the negative", "しか is built with the affirmative"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「一回しか会ったことがない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「タバコは吸わないほうがいい」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜てもいい vs 〜てはいけない: relationship?",
        o: ["てもいい = permission; てはいけない = prohibition (opposed)", "synonyms", "both = permission", "both = prohibition"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Common colloquial form of なければならない?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜なくてもいい vs 〜なければならない: relationship?",
        o: ["なくてもいい = not required; なければならない = required (opposed)", "synonyms", "both = mandatory", "both = optional"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「最近、忙しいということだ」- meaning of ということだ?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜といった vs 〜という: difference?",
        o: ["といった = gives examples (\"such as\"); という = names/cites (\"called\")", "identical", "という = examples", "といった = proper noun"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜てもらう vs 〜てくれる: difference in perspective?",
        o: ["てもらう = recipient's perspective (\"I'm having it done\"); てくれる = donor's perspective (\"he's doing it for me\")", "identical", "てもらう = donor", "てくれる = forced beneficiary"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜てあげる vs 〜てくれる: difference?",
        o: ["てあげる = I do FOR others; てくれる = others do FOR me", "identical", "てあげる = others for me", "てくれる = me for others"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜てくれる vs 〜てあげる: difference?",
        o: ["てくれる = others do FOR ME; てあげる = I do FOR others", "identical", "てくれる = I do for others", "てあげる = others do for me"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Humble form of 〜てもらう?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "When do we use 〜てやる rather than 〜てあげる?",
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Volitive form of 食べる?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ようと思う vs 〜つもりだ: nuance?",
        o: ["ようと思う = intention decided at the moment (more flexible); つもりだ = firm, fixed project", "identical", "つもりだ is more spontaneous", "ようと思う expresses an obligation"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜予定だ vs 〜つもりだ: nuance?",
        o: ["予定 = program objective set; つもり = personal intention", "identical", "予定 = personal intention", "つもり = official schedule"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Potential form of 食べる?",
        o: ["食べられる", "食べれる (colloquial)", "食べさせる", "食べる"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜はじめる vs 〜だす: nuance?",
        o: ["はじめる = neutral start; だす = sudden/unexpected start", "identical", "だす = end", "はじめる = sudden"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜おわる and 〜はじめる are :",
        o: ["antonyms (finish / start)", "synonyms", "both = continuous", "unrelated"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜たい vs 〜たがる: who?",
        o: ["たい = my own desire; たがる = the observed desire of others", "identical", "たい = others", "たがる = yourself"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "Why do we say 「彼は寂しがっている」et non「彼は寂しい」?",
        o: ["other people's feelings are described from the outside with がる", "寂しい does not exist", "がる is more polite", "both are impossible"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ないで vs 〜なくて: difference in use?",
        o: ["ないで = manner (\"without doing\"); なくて = cause/state (\"as does not... not\")", "identical", "なくて = way", "ないで = cause"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "To express \"as I didn't understand, I was annoyed\", we use :",
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Imperative of 食べる?",
        o: ["食べろ", "食べれ", "食べよ (written)", "食べな"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "Correct form after 予定 (noun) ?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "When do you use ように rather than ために for the goal?",
        o: ["with potential/non-voluntary or negation (見えるように、忘れないように)", "always", "never", "only with a name"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ような vs 〜みたいな: nuance?",
        o: ["same meaning (\"like\"); みたいな is more colloquial", "opposite", "みたいな is more formal", "ような is familiar"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「買わなければよかった」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「医者に行ったらどうですか」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「分からない場合は質問してください」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「行けるかどうか分からない」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜かどうか vs 疑問詞＋か: difference?",
        o: ["かどうか = yes/no question; 疑問詞＋か = open question (who/what/where...)", "identical", "かどうか = open question", "疑問詞か = yes/no"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "usage", q: "To \"walk with a happy air\" (幸せ):",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「名前を聞いただけで分かった」- meaning?",
  ...
  {
    id: "g107", g: "〜さ（名詞化）", m: "-ness, -ity (nominalizes an adjective)", f: "A-い→さ ／ A-な→さ（高さ、便利さ）",
    ...
    qs: [
      ...
      { t: "usage", q: "Nominalization of 長い (long) ?",
        o: ["長さ (the length)", "長み", "長く", "長そう"], a: 0,
        e: "A-い → さ (長さ)." },
    ],
  },

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜さ vs 〜み: nuance?",
        o: ["さ = objective measurement; み = perceived/subjective quality (and less productive)", "identical", "み = objective", "さ = subjective"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ぎみ vs 〜がち: nuance?",
        o: ["ぎみ = occasional mild symptom; がち = frequent habitual tendency", "identical", "ぎみ = frequent", "がち = light"], a: 0,
...

  {
    ...
    qs: [
      { t: "fill", q: "今、仕事＿＿＿だから、後でかけ直す。", fr: "I'm in the middle of work right now, so I'll call you back later.",
        ...
        e: "仕事中（ちゅう）= working." },
      { t: "nuance", q: "「世界中」se reads and means:",
        o: ["せかいじゅう = anywhere in the world", "せかいちゅう = going to the world", "reads ちゅう = limit", "does not exist"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「忙しいとか言っていた」- meaning of とか?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「日本語の勉強って楽しい」- role of って?",
        o: ["marks the theme (= は) orally", "expresses a cause", "imposes a ban", "marks the object"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "How do you distinguish \"学生じゃない\" (negation) from \"学生じゃない！\" (statement)?",
        o: ["by intonation/context: rising = observation (\"he's a student, isn't he?\")", "they are always identical", "the finding takes です", "negation takes か"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「そんなことまで言われた」- meaning of まで?",
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「待つように伝えてください」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜ないうちに vs 〜まえに: nuance?",
        o: ["ないうちに = before an unwanted change occurs (enjoy the moment); まえに = simple anteriority", "identical", "まえに implies danger", "ないうちに = after"], a: 0,
        e: "ないうちに insists on \"as long as it hasn't happened yet\"." },
    ],
  },

  {
    id: "g121", g: "〜もう〜ない", m: "don't... more", f: "もう + V-ない／negative",
    ...
    qs: [
      ...
      { t: "nuance", q: "「もう寝ない」vs「まだ寝ない」- difference?",
        o: ["もう寝ない = I'm not sleeping anymore; まだ寝ない = I'm not sleeping yet", "identical", "もう = not yet", "まだ = no longer"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜たところ vs 〜たばかり: nuance?",
        o: ["たところ = objectively right now; たばかり = subjectively recent (may be several days old)", "identical", "たばかり = at the moment", "たところ = a long time ago"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "meaning", q: "「準備しているところだ」- meaning?",
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜たまま vs 〜ながら: nuance?",
        o: ["たまま = a frozen state persists; ながら = two simultaneous active actions", "identical", "たまま = active simultaneity", "ながら = frozen state"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜たって is equivalent to :",
        o: ["〜ても (even if), familiar register", "〜から (because)", "〜ので (car)", "〜ために (for)"], a: 0,
...

  {
    ...
    qs: [
      ...
      { t: "nuance", q: "〜てばかりいる vs 〜たばかり: difference?",
        o: ["てばかりいる = only do (excess); たばかり = just do", "identical", "てばかりいる = come from do", "たばかり = excess"], a: 0,
