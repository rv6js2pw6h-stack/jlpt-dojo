...
var N2_VOCAB = [
  ...
  {
    id: "n2-0671", w: "経緯", r: "いきさつ", m: "circumstances; background; how things came about", c: "noun", lv: 1,
    ex: [{ jp: "事件の経緯を詳しく説明してください。", en: "Please explain in detail the circumstances of the incident." }],
    qs: [
      { t: "fitb", s: "なぜこうなったのか、その＿＿＿＿を正直に話してほしい。", en: "I want you to honestly explain the background of how this came about.", o: ["経緯", "原因", "理由", "背景"], a: 0, e: "経緯(いきさつ) = the course of events / how things unfolded over time. 原因(げんいん) = the cause. 理由(りゆう) = a stated reason. 背景(はいけい) = background/context." },
      { t: "meaning", s: "「経緯」の意味は？", o: ["circumstances; how things came about", "cause; reason", "stated reason", "background; context"], a: 0, e: "経緯(いきさつ) describes the sequence of events that led to a situation (事件の経緯 = the circumstances of the incident). Also read けいい in formal/written contexts." }
    ]
  },
  {
    id: "n2-0672", w: "手がかり", r: "てがかり", m: "clue; lead; starting point", c: "noun", lv: 1,
    ex: [{ jp: "警察は犯人を追う手がかりをようやく見つけた。", en: "The police finally found a clue to pursue the culprit." }],
    qs: [
      { t: "fitb", s: "解決の＿＿＿＿をつかむまで、調査を続けるつもりだ。", en: "I intend to continue the investigation until I get a clue to the solution.", o: ["手がかり", "糸口", "きっかけ", "証拠"], a: 0, e: "手がかり(てがかり) = a clue/lead (something to grab onto). 糸口(いとぐち) = a starting point / thread to pull (to unravel a problem). きっかけ = a trigger/opportunity. 証拠(しょうこ) = evidence." },
      { t: "meaning", s: "「手がかり」の意味は？", o: ["clue; lead; something to go on", "starting thread; opening", "trigger; opportunity", "evidence; proof"], a: 0, e: "手がかり is what you use to make progress (犯人の手がかり = a lead on the culprit, 手がかりをつかむ = to get a lead). 糸口 is the point from which you start unraveling a problem." }
    ]
  },
  {
    id: "n2-0673", w: "見解", r: "けんかい", m: "view; opinion; standpoint (formal)", c: "noun", lv: 1,
    ex: [{ jp: "政府はこの問題について公式の見解を発表した。", en: "The government announced an official view on this issue." }],
    qs: [
      { t: "fitb", s: "専門家の＿＿＿＿を聞いてから、最終的な判断をしたい。", en: "I would like to hear the experts' views before making a final decision.", o: ["見解", "意見", "見方", "主張"], a: 0, e: "見解(けんかい) = a formal view or position (公式見解 = official position). 意見(いけん) = opinion (general). 見方(みかた) = a way of seeing. 主張(しゅちょう) = an assertion." },
      { t: "meaning", s: "「見解」の意味は？", o: ["view; standpoint (formal)", "opinion (general)", "way of seeing; perspective", "assertion; claim"], a: 0, e: "見解 is used in formal or official contexts (見解の相違 = a difference of opinion, 見解を示す = to present a view). It is more formal than 意見." }
    ]
  },
  {
    id: "n2-0674", w: "余裕", r: "よゆう", m: "margin; room; composure; leeway", c: "noun", lv: 1,
    ex: [{ jp: "締め切りまで余裕があるうちに、早めに取りかかろう。", en: "Let's get started early while we still have time to spare before the deadline." }],
    qs: [
      { t: "fitb", s: "毎日残業が続き、趣味を楽しむ心の＿＿＿＿がなくなってしまった。", en: "With overtime continuing every day, I have lost the mental room to enjoy my hobbies.", o: ["余裕", "時間", "ゆとり", "余暇"], a: 0, e: "余裕(よゆう) = margin/leeway/composure (time, money, mental capacity to spare). ゆとり = space/latitude (broader sense of ease). 時間(じかん) = time. 余暇(よか) = leisure time." },
      { t: "meaning", s: "「余裕」の意味は？", o: ["margin; leeway; composure", "space; latitude (broad)", "time", "leisure time"], a: 0, e: "余裕 means having more than the minimum required (余裕がある = to have room to spare, 余裕をもって = with composure, 余裕の勝利 = an easy win)." }
    ]
  },
  {
    id: "n2-0675", w: "手間", r: "てま", m: "time and effort; trouble; labor", c: "noun", lv: 1,
    ex: [{ jp: "手間がかかるが、手作りの料理はやはりおいしい。", en: "It takes time and effort, but homemade food is still delicious." }],
    qs: [
      { t: "fitb", s: "この書類は記入箇所が多く、かなり＿＿＿＿がかかる。", en: "This document has many fields to fill in and takes quite a bit of effort.", o: ["手間", "手数", "労力", "時間"], a: 0, e: "手間(てま) = time and effort (手間がかかる = to take effort). 手数(てすう) = trouble/steps (お手数をおかけします = sorry for the trouble). 労力(ろうりょく) = labor/effort (more formal). 時間(じかん) = time." },
      { t: "meaning", s: "「手間」の意味は？", o: ["time and effort; trouble", "steps; formalities", "labor; effort (formal)", "time"], a: 0, e: "手間 is the practical effort something requires (手間を省く = to save effort, 手間暇かける = to take great pains over something)." }
    ]
  },
  {
    id: "n2-0676", w: "見当", r: "けんとう", m: "estimate; idea; guess; sense of direction", c: "noun", lv: 1,
    ex: [{ jp: "彼がどこにいるのか見当もつかない。", en: "I have no idea where he is." }],
    qs: [
      { t: "fitb", s: "費用がどのくらいかかるか、大まかな＿＿＿＿もつかない。", en: "I don't even have a rough idea of how much the costs will be.", o: ["見当", "目安", "見込み", "目標"], a: 0, e: "見当(けんとう) = a rough idea/guess (見当がつく = to have an idea, 見当違い = being totally off the mark). 目安(めやす) = a rough guide/benchmark. 見込み(みこみ) = a prospect/expectation. 目標(もくひょう) = a goal." },
      { t: "meaning", s: "「見当」の意味は？", o: ["rough idea; estimate; guess", "rough benchmark; guide", "prospect; expectation", "goal; target"], a: 0, e: "見当 is an intuitive estimate (見当をつける = to make a rough guess, 見当違い = completely off target/beside the point)." }
    ]
  },
  {
    id: "n2-0677", w: "手順", r: "てじゅん", m: "procedure; steps; order of operations", c: "noun", lv: 1,
    ex: [{ jp: "正しい手順に従って機器を操作してください。", en: "Please operate the device following the correct procedure." }],
    qs: [
      { t: "fitb", s: "作業の＿＿＿＿を間違えると、取り返しのつかないことになる。", en: "If you get the order of operations wrong, it can lead to irreversible consequences.", o: ["手順", "手続き", "順序", "工程"], a: 0, e: "手順(てじゅん) = procedure/steps (the sequence for doing something). 手続き(てつづき) = procedure/formalities (administrative steps). 順序(じゅんじょ) = order/sequence. 工程(こうてい) = a process/stage (manufacturing)." },
      { t: "meaning", s: "「手順」の意味は？", o: ["procedure; steps; order", "administrative formalities", "order; sequence", "manufacturing process; stage"], a: 0, e: "手順 is the step-by-step method for completing a task (手順書 = procedure manual, 手順を踏む = to follow the proper steps)." }
    ]
  },
  {
    id: "n2-0678", w: "反響", r: "はんきょう", m: "response; reaction; repercussion; echo", c: "noun", lv: 1,
    ex: [{ jp: "その記事は多くの読者から大きな反響を呼んだ。", en: "That article generated a huge response from many readers." }],
    qs: [
      { t: "fitb", s: "新商品の発表に対して、予想を超える大きな＿＿＿＿があった。", en: "The announcement of the new product generated a bigger response than expected.", o: ["反響", "反応", "反論", "評判"], a: 0, e: "反響(はんきょう) = response/repercussion (wide, social ripple). 反応(はんのう) = reaction (immediate, individual). 反論(はんろん) = counterargument. 評判(ひょうばん) = reputation." },
      { t: "meaning", s: "「反響」の意味は？", o: ["response; repercussion (wide/social)", "reaction (immediate/individual)", "counterargument; rebuttal", "reputation; word of mouth"], a: 0, e: "反響 is the ripple effect of something on society (大きな反響を呼ぶ = to generate a big response, 反響が広がる = the response spreads). Also means a literal echo." }
    ]
  },
  {
    id: "n2-0679", w: "節約", r: "せつやく", m: "economy; saving; frugality", c: "noun", lv: 1,
    ex: [{ jp: "光熱費を節約するために、こまめに電気を消している。", en: "I turn off lights diligently to save on utility bills." }],
    qs: [
      { t: "fitb", s: "旅行のために毎月三万円ずつ＿＿＿＿している。", en: "I am saving 30,000 yen every month for a trip.", o: ["節約", "貯金", "蓄え", "倹約"], a: 0, e: "節約(せつやく) = saving/reducing expenditure (not wasting). 貯金(ちょきん) = saving money (accumulating). 蓄え(たくわえ) = savings/reserve (stored up). 倹約(けんやく) = frugality (virtue of not spending)." },
      { t: "meaning", s: "「節約」の意味は？", o: ["saving; reducing waste/expenditure", "saving money (accumulating)", "savings; reserve (stored up)", "frugality (as a virtue)"], a: 0, e: "節約 is about cutting back on use (エネルギー節約 = energy saving, 時間を節約する = to save time). 貯金 is accumulating money in a bank or piggy bank." }
    ]
  },
  {
    id: "n2-0680", w: "工場", r: "こうじょう", m: "factory; plant; works", c: "noun", lv: 1,
    ex: [{ jp: "この工場では一日に千台の車が製造されている。", en: "A thousand cars are manufactured at this factory per day." }],
    qs: [
      { t: "fitb", s: "海外に＿＿＿＿を建設し、人件費を削減する計画が進んでいる。", en: "A plan is advancing to build a factory overseas and reduce labor costs.", o: ["工場", "工場団地", "製造所", "拠点"], a: 0, e: "工場(こうじょう) = factory/plant (general). 工場団地(こうじょうだんち) = an industrial estate. 製造所(せいぞうしょ) = a manufacturing facility (formal/legal). 拠点(きょてん) = a base of operations." },
      { t: "meaning", s: "「工場」の意味は？", o: ["factory; plant", "industrial estate", "manufacturing facility (formal)", "base of operations"], a: 0, e: "工場 is the standard word for a factory (工場長 = factory manager, 工場見学 = factory tour, 工場勤務 = factory work)." }
    ]
  },
  {
    id: "n2-0681", w: "仕組み", r: "しくみ", m: "mechanism; structure; how it works", c: "noun", lv: 1,
    ex: [{ jp: "このアプリの仕組みを理解するのに少し時間がかかった。", en: "It took a little time to understand how this app works." }],
    qs: [
      { t: "fitb", s: "税金の＿＿＿＿を学校でもっと教えるべきだという声がある。", en: "There are voices saying the mechanism of taxation should be taught more in schools.", o: ["仕組み", "制度", "構造", "システム"], a: 0, e: "仕組み(しくみ) = mechanism/how something works (explanatory). 制度(せいど) = a system/institution (established). 構造(こうぞう) = structure (physical or analytical). システム = system (loanword, often technical)." },
      { t: "meaning", s: "「仕組み」の意味は？", o: ["mechanism; how it works", "institution; established system", "structure (physical/analytical)", "system (technical loanword)"], a: 0, e: "仕組み answers the question 'how does it work?' (社会の仕組み = how society works, 仕組みを理解する = to understand the mechanism)." }
    ]
  },
  {
    id: "n2-0682", w: "見通す", r: "みとおす", m: "to see through; to foresee; to look ahead", c: "verb", lv: 1,
    ex: [{ jp: "経験豊富な彼女は状況の先を見通す力を持っている。", en: "With her wealth of experience, she has the ability to foresee how situations will unfold." }],
    qs: [
      { t: "fitb", s: "彼は相手の意図を鋭く＿＿＿＿、冷静に対応した。", en: "He sharply saw through the other party's intentions and responded calmly.", o: ["見通し", "見抜き", "見透かし", "看破し"], a: 0, e: "見通す(みとおす) = to see through / look ahead to the end. 見抜く(みぬく) = to see through / detect (a lie, a weakness). 見透かす(みすかす) = to see through (someone's hidden motives). 看破する(かんぱする) = to see through / expose (formal)." },
      { t: "meaning", s: "「見通す」の意味は？", o: ["to see through; to foresee", "to detect; to see through (a lie)", "to see through (hidden motives)", "to expose; to see through (formal)"], a: 0, e: "見通す = looking all the way through or ahead (将来を見通す = to foresee the future). 見抜く focuses on detecting what is hidden or false." }
    ]
  },
  {
    id: "n2-0683", w: "思い込む", r: "おもいこむ", m: "to be convinced; to assume; to take for granted", c: "verb", lv: 1,
    ex: [{ jp: "自分が正しいと思い込んでいると、人の意見が聞けなくなる。", en: "If you are convinced you are right, you become unable to hear others' opinions." }],
    qs: [
      { t: "fitb", s: "彼はその噂を事実だと＿＿＿＿んでいたが、実は嘘だった。", en: "He was convinced that the rumour was true, but it was actually a lie.", o: ["思い込", "信じ込", "決めつけ", "思い違い"], a: 0, e: "思い込む(おもいこむ) = to be convinced of something (often mistakenly). 信じ込む(しんじこむ) = to fully believe (completely taken in). 決めつける(きめつける) = to judge/conclude without sufficient reason. 思い違い(おもいちがい) = a misconception." },
      { t: "meaning", s: "「思い込む」の意味は？", o: ["to be (wrongly) convinced; to assume", "to fully believe; to be taken in", "to judge without basis; to assume", "a misconception; being mistaken"], a: 0, e: "思い込む = being firmly (and often wrongly) convinced (思い込みが激しい = very prone to assumptions, 思い込みを捨てる = to let go of assumptions)." }
    ]
  },
  {
    id: "n2-0684", w: "打ち消す", r: "うちけす", m: "to deny; to negate; to cancel out", c: "verb", lv: 1,
    ex: [{ jp: "会社はその報道を即座に打ち消す声明を出した。", en: "The company immediately issued a statement denying the report." }],
    qs: [
      { t: "fitb", s: "良い部分も多いが、今回の失敗がそれを＿＿＿＿してしまった。", en: "There are many good points too, but this failure has cancelled them out.", o: ["打ち消し", "否定し", "相殺し", "消し去り"], a: 0, e: "打ち消す(うちけす) = to negate/cancel out (a claim, an effect). 否定する(ひていする) = to deny/negate. 相殺する(そうさいする) = to offset/cancel out (financial). 消し去る(けしさる) = to erase/wipe out." },
      { t: "meaning", s: "「打ち消す」の意味は？", o: ["to negate; to cancel out; to deny", "to deny; to negate (general)", "to offset; to cancel (financial)", "to erase; to wipe out"], a: 0, e: "打ち消す = actively negating something (噂を打ち消す = to deny a rumour, 効果を打ち消す = to cancel out an effect). 打ち消し形 in grammar = the negative form." }
    ]
  },
  {
    id: "n2-0685", w: "引き起こす", r: "ひきおこす", m: "to cause; to trigger; to bring about", c: "verb", lv: 1,
    ex: [{ jp: "その一言が大きな誤解を引き起こした。", en: "That single remark triggered a major misunderstanding." }],
    qs: [
      { t: "fitb", s: "このウイルスは重篤な症状を＿＿＿＿可能性がある。", en: "This virus has the potential to cause severe symptoms.", o: ["引き起こす", "もたらす", "生じさせる", "招く"], a: 0, e: "引き起こす(ひきおこす) = to trigger/cause (an undesirable event). もたらす = to bring about (can be positive or negative). 生じさせる(しょうじさせる) = to generate/cause (formal). 招く(まねく) = to invite/cause (often unintended)." },
      { t: "meaning", s: "「引き起こす」の意味は？", o: ["to cause; to trigger (an event)", "to bring about (positive or negative)", "to generate; to cause (formal)", "to invite; to cause (unintended)"], a: 0, e: "引き起こす has a strong nuance of triggering something undesirable (事故を引き起こす = to cause an accident, 問題を引き起こす = to cause problems)." }
    ]
  },
  {
    id: "n2-0686", w: "言い訳", r: "いいわけ", m: "excuse; justification", c: "noun", lv: 1,
    ex: [{ jp: "失敗した時に言い訳をするより、素直に謝る方が信頼される。", en: "When you fail, being honest and apologizing is more trusted than making excuses." }],
    qs: [
      { t: "fitb", s: "どんな理由があっても、遅刻の＿＿＿＿は通用しない。", en: "No matter what the reason, an excuse for being late doesn't hold.", o: ["言い訳", "弁解", "弁明", "釈明"], a: 0, e: "言い訳(いいわけ) = an excuse (often dismissive: 言い訳にならない = that's no excuse). 弁解(べんかい) = justification/defense (more neutral). 弁明(べんめい) = a formal explanation of one's actions. 釈明(しゃくめい) = an explanation to clear oneself (formal/public)." },
      { t: "meaning", s: "「言い訳」の意味は？", o: ["excuse (often dismissive)", "justification; defense (neutral)", "formal explanation of one's actions", "public clarification (formal)"], a: 0, e: "言い訳 is an excuse you give to avoid blame (言い訳をする = to make excuses, 言い訳がましい = full of excuses). 弁解 is more neutral and can be a legitimate explanation." }
    ]
  },
  {
    id: "n2-0687", w: "行き違い", r: "ゆきちがい", m: "miscommunication; crossed wires; misunderstanding", c: "noun", lv: 1,
    ex: [{ jp: "連絡の行き違いで、二人は別の場所で待ち続けた。", en: "Due to a communication mix-up, the two kept waiting at different places." }],
    qs: [
      { t: "fitb", s: "どうやらメールの＿＿＿＿があったようで、会議の時間が伝わっていなかった。", en: "It seems there was a miscommunication in the emails and the meeting time was not conveyed.", o: ["行き違い", "すれ違い", "誤解", "連絡ミス"], a: 0, e: "行き違い(ゆきちがい) = a communication mix-up (messages crossing / missing each other). すれ違い(すれちがい) = passing without meeting / emotional disconnect. 誤解(ごかい) = a misunderstanding. 連絡ミス(れんらくミス) = a communication error." },
      { t: "meaning", s: "「行き違い」の意味は？", o: ["miscommunication; crossed wires", "passing without meeting; disconnect", "misunderstanding", "communication error"], a: 0, e: "行き違い is specifically when messages or people miss each other (連絡の行き違い = wires got crossed). すれ違い often refers to an emotional or relationship disconnect." }
    ]
  },
  {
    id: "n2-0688", w: "立場", r: "たちば", m: "position; standpoint; situation", c: "noun", lv: 1,
    ex: [{ jp: "相手の立場に立って考えることが、円滑なコミュニケーションの鍵だ。", en: "Thinking from the other person's standpoint is the key to smooth communication." }],
    qs: [
      { t: "fitb", s: "上司という＿＿＿＿上、部下の失敗には責任をとらなければならない。", en: "Given my position as a superior, I must take responsibility for my subordinates' mistakes.", o: ["立場", "立場", "地位", "役職"], a: 0, e: "立場(たちば) = one's position/standpoint (social or argumentative). 地位(ちい) = status/rank. 役職(やくしょく) = one's post/title." },
      { t: "meaning", s: "「立場」の意味は？", o: ["position; standpoint; situation", "status; rank", "post; job title", "role; function"], a: 0, e: "立場 = the position you occupy, which determines your perspective and responsibilities (立場をわきまえる = to know one's place, 立場が違う = to have different standpoints)." }
    ]
  },
  {
    id: "n2-0689", w: "切り替える", r: "きりかえる", m: "to switch; to change over; to shift", c: "verb", lv: 1,
    ex: [{ jp: "気持ちをうまく切り替えて、次の試合に集中しよう。", en: "Let's switch our mindset well and focus on the next match." }],
    qs: [
      { t: "fitb", s: "仕事モードからプライベートモードに素早く＿＿＿＿ことが、健康の秘訣だ。", en: "The secret to good health is quickly switching from work mode to private mode.", o: ["切り替える", "転換する", "変える", "移行する"], a: 0, e: "切り替える(きりかえる) = to switch/change over (modes, channels, thinking). 転換する(てんかんする) = to shift/convert (broader, more formal). 変える(かえる) = to change. 移行する(いこうする) = to transition/migrate." },
      { t: "meaning", s: "「切り替える」の意味は？", o: ["to switch; to change over", "to shift; to convert (formal)", "to change (general)", "to transition; to migrate"], a: 0, e: "切り替える is an active, clean switch (チャンネルを切り替える = to switch channels, 気持ちを切り替える = to switch one's mindset). 切り替えが早い = quick to move on." }
    ]
  },
  {
    id: "n2-0690", w: "踏み切る", r: "ふみきる", m: "to take the plunge; to decide to act; to cross a line", c: "verb", lv: 1,
    ex: [{ jp: "長年迷っていたが、ついに独立に踏み切った。", en: "I had been hesitating for years, but finally took the plunge and went independent." }],
    qs: [
      { t: "fitb", s: "大きなリスクを伴う投資に＿＿＿＿のは、勇気が必要だ。", en: "It takes courage to take the plunge on an investment that involves a large risk.", o: ["踏み切る", "踏み出す", "決断する", "踏み込む"], a: 0, e: "踏み切る(ふみきる) = to take the plunge / make a decisive move (after hesitation). 踏み出す(ふみだす) = to take a first step. 決断する(けつだんする) = to make a decision. 踏み込む(ふみこむ) = to step into / delve into (a topic or place)." },
      { t: "meaning", s: "「踏み切る」の意味は？", o: ["to take the plunge; to make a decisive move", "to take a first step (forward)", "to make a decision", "to step into; to delve into"], a: 0, e: "踏み切る implies overcoming hesitation to act (辞表を提出することに踏み切った = took the plunge and submitted the resignation letter). 踏み出す is the first step forward." }
    ]
  },
  {
    id: "n2-0691", w: "見極める", r: "みきわめる", m: "to determine; to ascertain; to judge accurately", c: "verb", lv: 1,
    ex: [{ jp: "相手の本音を見極めることが、交渉では重要だ。", en: "In negotiations, accurately determining the other party's true intentions is important." }],
    qs: [
      { t: "fitb", s: "商品の品質を正しく＿＿＿＿目が必要だ。", en: "You need an eye to correctly judge the quality of products.", o: ["見極める", "見分ける", "判断する", "評価する"], a: 0, e: "見極める(みきわめる) = to ascertain / judge to the end (thoroughly). 見分ける(みわける) = to distinguish / tell apart. 判断する(はんだんする) = to judge/assess. 評価する(ひょうかする) = to evaluate." },
      { t: "meaning", s: "「見極める」の意味は？", o: ["to determine; to ascertain thoroughly", "to distinguish; to tell apart", "to judge; to assess", "to evaluate; to rate"], a: 0, e: "見極める = reaching a definitive conclusion through careful observation (本物かどうか見極める = to determine whether it is genuine, タイミングを見極める = to judge the timing precisely)." }
    ]
  },
  {
    id: "n2-0692", w: "成り立つ", r: "なりたつ", m: "to hold true; to be established; to come to be", c: "verb", lv: 1,
    ex: [{ jp: "この契約は双方の合意があって初めて成り立つ。", en: "This contract only holds when both parties agree." }],
    qs: [
      { t: "fitb", s: "社会は人々の信頼関係の上に＿＿＿＿いる。", en: "Society is established upon relationships of trust among people.", o: ["成り立って", "成立して", "築かれて", "支えられて"], a: 0, e: "成り立つ(なりたつ) = to hold/be constituted (naturally, as an ongoing state). 成立する(せいりつする) = to be established/concluded (an event: 契約が成立する = the contract is concluded). 築く(きずく) = to build/construct. 支える(ささえる) = to support." },
      { t: "meaning", s: "「成り立つ」の意味は？", o: ["to hold; to be constituted; to be founded on", "to be established; to be concluded", "to build; to construct", "to support; to sustain"], a: 0, e: "成り立つ = existing or being valid based on certain conditions (論理が成り立つ = the logic holds, 商売が成り立つ = the business is viable)." }
    ]
  },
  {
    id: "n2-0693", w: "見かける", r: "みかける", m: "to happen to see; to come across; to spot", c: "verb", lv: 1,
    ex: [{ jp: "近所で彼女を見かけたが、声をかけられなかった。", en: "I happened to spot her in the neighborhood but couldn't bring myself to call out to her." }],
    qs: [
      { t: "fitb", s: "このあたりでは最近、野生の鹿を＿＿＿＿ことが増えた。", en: "In this area, sightings of wild deer have increased recently.", o: ["見かける", "目撃する", "見つける", "発見する"], a: 0, e: "見かける(みかける) = to happen to see/spot (casually, in passing). 目撃する(もくげきする) = to witness (an incident). 見つける(みつける) = to find (after looking). 発見する(はっけんする) = to discover." },
      { t: "meaning", s: "「見かける」の意味は？", o: ["to happen to see; to spot (casually)", "to witness (an incident)", "to find (after looking)", "to discover"], a: 0, e: "見かける = noticing something without particularly looking for it (見かけない顔 = an unfamiliar face, 最近見かけない = haven't seen around lately)." }
    ]
  },
  {
    id: "n2-0694", w: "言い張る", r: "いいはる", m: "to insist; to assert stubbornly; to maintain", c: "verb", lv: 1,
    ex: [{ jp: "証拠を見せても、彼は自分は無関係だと言い張った。", en: "Even when shown evidence, he stubbornly insisted he had nothing to do with it." }],
    qs: [
      { t: "fitb", s: "彼女は自分のやり方が正しいと最後まで＿＿＿＿た。", en: "She stubbornly maintained to the end that her way was correct.", o: ["言い張っ", "主張し", "言い続け", "強調し"], a: 0, e: "言い張る(いいはる) = to stubbornly insist (despite opposition). 主張する(しゅちょうする) = to assert/claim (neutral). 言い続ける(いいつづける) = to keep saying. 強調する(きょうちょうする) = to emphasize." },
      { t: "meaning", s: "「言い張る」の意味は？", o: ["to insist stubbornly; to maintain", "to assert; to claim (neutral)", "to keep saying; to repeat", "to emphasize; to stress"], a: 0, e: "言い張る implies refusing to back down (無実を言い張る = to stubbornly maintain one's innocence). It carries a negative nuance of being unreasonably insistent." }
    ]
  },
  {
    id: "n2-0695", w: "仕上げる", r: "しあげる", m: "to finish; to complete; to put the finishing touches on", c: "verb", lv: 1,
    ex: [{ jp: "締め切り前夜に、ようやくレポートを仕上げた。", en: "On the night before the deadline, I finally finished the report." }],
    qs: [
      { t: "fitb", s: "三年かけて作った作品を、来月ついに＿＿＿＿予定だ。", en: "The work I have spent three years on is scheduled to be finally completed next month.", o: ["仕上げる", "完成させる", "仕上がる", "まとめる"], a: 0, e: "仕上げる(しあげる) = to finish/complete (transitive: you complete it). 完成させる(かんせいさせる) = to bring to completion (formal). 仕上がる(しあがる) = to be finished (intransitive). まとめる = to put together/compile." },
      { t: "meaning", s: "「仕上げる」の意味は？", o: ["to finish; to complete (transitive)", "to bring to completion (formal)", "to be finished (intransitive)", "to compile; to put together"], a: 0, e: "仕上げる = bringing something to its final, polished state (作品を仕上げる = to complete a work, 仕上げに = for the finishing touch)." }
    ]
  },
  {
    id: "n2-0696", w: "使い捨て", r: "つかいすて", m: "disposable; throwaway; single-use", c: "noun", lv: 1,
    ex: [{ jp: "環境のために使い捨てプラスチックの使用を減らすべきだ。", en: "We should reduce the use of disposable plastics for the environment." }],
    qs: [
      { t: "fitb", s: "このカメラは＿＿＿＿タイプで、現像後に返却する形式だ。", en: "This camera is a disposable type, returned after the film is developed.", o: ["使い捨て", "一回限り", "インスタント", "レンタル"], a: 0, e: "使い捨て(つかいすて) = disposable/single-use (物理的に捨てる). 一回限り(いっかいかぎり) = one-time only. インスタント = instant (loanword). レンタル = rental." },
      { t: "meaning", s: "「使い捨て」の意味は？", o: ["disposable; single-use; throwaway", "one-time only", "instant (loanword)", "rental; for hire"], a: 0, e: "使い捨て = designed to be used once and discarded (使い捨てカイロ = disposable hand warmer, 使い捨て文化 = throwaway culture). Used figuratively: 使い捨ての労働者 = disposable workers." }
    ]
  },
  {
    id: "n2-0697", w: "やり取り", r: "やりとり", m: "exchange; back-and-forth; communication", c: "noun", lv: 1,
    ex: [{ jp: "メールでのやり取りを通じて、彼女とは良い関係が築けた。", en: "Through email exchanges, I was able to build a good relationship with her." }],
    qs: [
      { t: "fitb", s: "契約の詳細については、弁護士との＿＿＿＿を重ねてから決定する。", en: "Regarding the details of the contract, we will decide after repeated exchanges with the lawyer.", o: ["やり取り", "交渉", "話し合い", "交流"], a: 0, e: "やり取り(やりとり) = back-and-forth exchange (messages, opinions). 交渉(こうしょう) = negotiation. 話し合い(はなしあい) = discussion/talk. 交流(こうりゅう) = exchange/interaction (broader relationship)." },
      { t: "meaning", s: "「やり取り」の意味は？", o: ["back-and-forth exchange", "negotiation", "discussion; talk", "exchange; interaction (broad)"], a: 0, e: "やり取り is the mutual giving and receiving in communication (メールのやり取り = email exchange, 意見のやり取り = exchange of opinions)." }
    ]
  },
  {
    id: "n2-0698", w: "受け入れる", r: "うけいれる", m: "to accept; to receive; to take in", c: "verb", lv: 1,
    ex: [{ jp: "異なる意見を受け入れることで、視野が広がる。", en: "By accepting different opinions, your perspective expands." }],
    qs: [
      { t: "fitb", s: "現実をそのまま＿＿＿＿ことが、前に進む第一歩だ。", en: "Accepting reality as it is is the first step to moving forward.", o: ["受け入れる", "受け止める", "認める", "容認する"], a: 0, e: "受け入れる(うけいれる) = to accept/take in (a person, idea, situation). 受け止める(うけとめる) = to receive/take on board (an impact, news). 認める(みとめる) = to recognize/acknowledge. 容認する(ようにんする) = to tolerate/permit (formal)." },
      { t: "meaning", s: "「受け入れる」の意味は？", o: ["to accept; to take in", "to receive; to take on board (an impact)", "to acknowledge; to recognize", "to tolerate; to permit (formal)"], a: 0, e: "受け入れる = welcoming or accepting something (移民を受け入れる = to accept immigrants, 条件を受け入れる = to accept the terms). 受け止める has more of a 'taking the hit' nuance." }
    ]
  },
  {
    id: "n2-0699", w: "引き受ける", r: "ひきうける", m: "to take on; to undertake; to accept responsibility for", c: "verb", lv: 1,
    ex: [{ jp: "難しい仕事だとわかっていたが、喜んで引き受けた。", en: "I knew it was a difficult job, but I willingly took it on." }],
    qs: [
      { t: "fitb", s: "その仕事は私が＿＿＿＿ます。責任をもって対応します。", en: "I will take on that job. I will handle it with responsibility.", o: ["引き受け", "担当し", "対応し", "請け負い"], a: 0, e: "引き受ける(ひきうける) = to take on/accept (a task, responsibility). 担当する(たんとうする) = to be in charge of. 対応する(たいおうする) = to deal with/respond to. 請け負う(うけおう) = to contract/undertake (commercially)." },
      { t: "meaning", s: "「引き受ける」の意味は？", o: ["to take on; to accept (responsibility)", "to be in charge of", "to deal with; to respond to", "to contract; to undertake (commercial)"], a: 0, e: "引き受ける = committing to take responsibility for something (仕事を引き受ける = to take on a job, 保証人を引き受ける = to become a guarantor)." }
    ]
  },
  {
    id: "n2-0700", w: "落ち着く", r: "おちつく", m: "to calm down; to settle; to feel at ease", c: "verb", lv: 1,
    ex: [{ jp: "深呼吸して少し落ち着いてから、話してください。", en: "Take a deep breath, calm down a little, then speak." }],
    qs: [
      { t: "fitb", s: "引越しが終わり、新居での生活がようやく＿＿＿＿いた。", en: "The move was over and life in the new home had finally settled down.", o: ["落ち着", "安定し", "慣れ", "落ち着き"], a: 0, e: "落ち着く(おちつく) = to calm/settle down (emotionally or situationally). 安定する(あんていする) = to stabilize. 慣れる(なれる) = to get used to. 落ち着き(おちつき) = composure/calmness (noun)." },
      { t: "meaning", s: "「落ち着く」の意味は？", o: ["to calm down; to settle", "to stabilize", "to get used to", "composure; calmness (noun)"], a: 0, e: "落ち着く = returning to a calm, settled state (気持ちが落ち着く = feelings settle, 状況が落ち着く = the situation calms down, 落ち着いた色 = subdued/calm colour)." }
    ]
  },
  {
    id: "n2-0701", w: "申し出る", r: "もうしでる", m: "to offer; to propose; to report (formally)", c: "verb", lv: 1,
    ex: [{ jp: "困っている人を見かけたので、手伝いを申し出た。", en: "Seeing someone in trouble, I offered to help." }],
    qs: [
      { t: "fitb", s: "彼はボランティアとして参加することを自ら＿＿＿＿た。", en: "He voluntarily offered to participate as a volunteer.", o: ["申し出", "申し込み", "提案し", "名乗り出"], a: 0, e: "申し出る(もうしでる) = to offer/volunteer proactively (formal, you initiate). 申し込む(もうしこむ) = to apply/register. 提案する(ていあんする) = to propose. 名乗り出る(なのりでる) = to come forward/identify oneself." },
      { t: "meaning", s: "「申し出る」の意味は？", o: ["to offer; to volunteer (proactively)", "to apply; to register", "to propose; to suggest", "to come forward; to identify oneself"], a: 0, e: "申し出る = proactively making an offer or proposal to someone of higher standing (辞表を申し出る = to tender a resignation, 援助を申し出る = to offer assistance)." }
    ]
  },
  {
    id: "n2-0702", w: "うなずく", r: "うなずく", m: "to nod; to nod in agreement", c: "verb", lv: 1,
    ex: [{ jp: "彼は黙ってうなずき、話を聞き続けた。", en: "He silently nodded and continued listening." }],
    qs: [
      { t: "fitb", s: "説明を聞いてようやく納得し、深く＿＿＿＿た。", en: "After finally being convinced by the explanation, I nodded deeply.", o: ["うなずい", "同意し", "頷き", "賛成し"], a: 0, e: "うなずく = to nod (the physical action of lowering the head in agreement). 同意する(どういする) = to agree (verbal/formal). 頷く = alternate spelling of うなずく. 賛成する(さんせいする) = to be in favour of." },
      { t: "meaning", s: "「うなずく」の意味は？", o: ["to nod; to nod in agreement", "to agree (formally)", "to be in favour; to support", "to consent; to approve"], a: 0, e: "うなずく is the physical gesture of nodding to show understanding or agreement (深くうなずく = to nod deeply, 思わずうなずく = to nod involuntarily in agreement)." }
    ]
  },
  {
    id: "n2-0703", w: "見舞う", r: "みまう", m: "to visit (sb ill or in difficulty); to strike; to befall", c: "verb", lv: 1,
    ex: [{ jp: "入院している友人をお見舞いに行った。", en: "I went to visit my friend who was in the hospital." }],
    qs: [
      { t: "fitb", s: "大雪が地域を＿＿＿＿い、交通機関がすべて止まった。", en: "Heavy snowfall struck the region and all transportation came to a halt.", o: ["見舞", "襲", "直撃し", "降り注"], a: 0, e: "見舞う(みまう) = to visit (a sick person) or to befall/strike (a disaster). 襲う(おそう) = to attack/strike. 直撃する(ちょくげきする) = to hit directly. 降り注ぐ(ふりそそぐ) = to pour down." },
      { t: "meaning", s: "「見舞う」の意味は？", o: ["to visit (sb ill); to befall (disaster)", "to attack; to strike", "to hit directly", "to pour down"], a: 0, e: "見舞う has two uses: お見舞い(おみまい)に行く = to pay a visit to someone who is sick/in trouble; and 災害に見舞われる = to be struck by a disaster." }
    ]
  },
  {
    id: "n2-0704", w: "思い浮かべる", r: "おもいうかべる", m: "to picture; to call to mind; to imagine", c: "verb", lv: 1,
    ex: [{ jp: "故郷の景色を思い浮かべると、自然と笑顔になれる。", en: "When I picture the scenery of my hometown, I naturally find myself smiling." }],
    qs: [
      { t: "fitb", s: "その曲を聴くと、学生時代の思い出が自然と＿＿＿＿れる。", en: "When I hear that song, memories of my student days naturally come to mind.", o: ["思い浮かべら", "思い出さ", "想起さ", "よみがえ"], a: 0, e: "思い浮かべる(おもいうかべる) = to picture/visualize (deliberately). 思い出す(おもいだす) = to recall/remember (a memory comes back). 想起する(そうきする) = to recall/evoke (formal). よみがえる(蘇る) = to revive/come flooding back." },
      { t: "meaning", s: "「思い浮かべる」の意味は？", o: ["to picture; to call to mind (deliberately)", "to recall; to remember (a memory)", "to evoke; to recall (formal)", "to revive; to come flooding back"], a: 0, e: "思い浮かべる = actively visualizing something in the mind (顔を思い浮かべる = to picture someone's face, 具体例を思い浮かべる = to picture a concrete example)." }
    ]
  },
  {
    id: "n2-0705", w: "差し支える", r: "さしつかえる", m: "to be a problem; to interfere; to cause inconvenience", c: "verb", lv: 1,
    ex: [{ jp: "もし差し支えなければ、お名前を教えていただけますか？", en: "If it is not a problem, could you tell me your name?" }],
    qs: [
      { t: "fitb", s: "明日の会議の時間を変更しても＿＿＿＿ないでしょうか？", en: "Would it not cause any inconvenience if we change the time of tomorrow's meeting?", o: ["差し支え", "支障が", "問題が", "困り"], a: 0, e: "差し支える(さしつかえる) = to cause inconvenience / be a problem. 支障をきたす(ししょうをきたす) = to cause an obstacle/problem. 問題がある(もんだいがある) = to be a problem. 困る(こまる) = to be troubled." },
      { t: "meaning", s: "「差し支える」の意味は？", o: ["to be a problem; to cause inconvenience", "to cause an obstacle; to hinder", "to be a problem (neutral)", "to be troubled; to be at a loss"], a: 0, e: "差し支える is used politely to ask if something is inconvenient (差し支えなければ = if it is not inconvenient, 差し支えない = no problem / no objection)." }
    ]
  },
  {
    id: "n2-0706", w: "出来事", r: "できごと", m: "event; happening; incident", c: "noun", lv: 1,
    ex: [{ jp: "今日は忘れられない出来事があった。", en: "Today an unforgettable event occurred." }],
    qs: [
      { t: "fitb", s: "その日の＿＿＿＿は、その後の人生に大きな影響を与えた。", en: "The happenings of that day had a great influence on the rest of his life.", o: ["出来事", "事件", "事象", "出来"], a: 0, e: "出来事(できごと) = an event/happening (neutral, everyday). 事件(じけん) = an incident/case (noteworthy, often negative). 事象(じしょう) = phenomenon/event (scientific/formal). 出来(でき) = result/quality (e.g. 出来がいい = well made)." },
      { t: "meaning", s: "「出来事」の意味は？", o: ["event; happening; incident (neutral)", "incident; case (noteworthy)", "phenomenon; event (scientific)", "result; quality"], a: 0, e: "出来事 is a neutral word for something that happened (日常の出来事 = everyday happenings, 歴史的な出来事 = a historic event)." }
    ]
  },
  {
    id: "n2-0707", w: "年齢", r: "ねんれい", m: "age; one's years", c: "noun", lv: 1,
    ex: [{ jp: "採用にあたって年齢は問いませんと求人票に書いてあった。", en: "The job listing stated that age would not be a factor in hiring." }],
    qs: [
      { t: "fitb", s: "彼女は＿＿＿＿のわりに落ち着いていて、年上に見られることが多い。", en: "She is calm for her age and is often taken to be older.", o: ["年齢", "年", "歳", "年代"], a: 0, e: "年齢(ねんれい) = age (formal noun, used in documents). 年(とし) = age (colloquial: 年のわりに = for one's age). 歳(さい) = age (numerical counter). 年代(ねんだい) = generation/era." },
      { t: "meaning", s: "「年齢」の意味は？", o: ["age; one's years (formal)", "age (colloquial)", "age (counter)", "generation; era"], a: 0, e: "年齢 is the formal term for age (年齢制限 = age limit, 年齢確認 = age verification, 平均年齢 = average age)." }
    ]
  },
  {
    id: "n2-0708", w: "物事", r: "ものごと", m: "things; matters; everything", c: "noun", lv: 1,
    ex: [{ jp: "物事をポジティブに考える習慣をつけることが大切だ。", en: "It is important to develop the habit of thinking about things positively." }],
    qs: [
      { t: "fitb", s: "＿＿＿＿には必ず表と裏がある。", en: "Everything has two sides.", o: ["物事", "物", "事柄", "こと"], a: 0, e: "物事(ものごと) = things in general / matters (abstract and concrete combined). 物(もの) = a thing (physical). 事柄(ことがら) = a matter/subject (abstract). こと = a thing/fact (abstract)." },
      { t: "meaning", s: "「物事」の意味は？", o: ["things; matters (abstract & concrete)", "a thing (physical)", "a matter; a subject (abstract)", "a fact; an abstract thing"], a: 0, e: "物事 is a general term for 'things in general' (物事を深く考える = to think deeply about things, 物事の本質 = the essence of things)." }
    ]
  },
  {
    id: "n2-0709", w: "見本", r: "みほん", m: "sample; specimen; model; example", c: "noun", lv: 1,
    ex: [{ jp: "購入前に見本を見せてもらえますか？", en: "Could you show me a sample before I purchase?" }],
    qs: [
      { t: "fitb", s: "新製品の＿＿＿＿を配布して、顧客の反応を確かめた。", en: "We distributed samples of the new product and confirmed customer reactions.", o: ["見本", "サンプル", "試供品", "モデル"], a: 0, e: "見本(みほん) = a sample/specimen/model (something representing the real thing). サンプル = sample (loanword). 試供品(しきゅうひん) = a free sample/giveaway. モデル = model (person or object)." },
      { t: "meaning", s: "「見本」の意味は？", o: ["sample; specimen; model", "sample (loanword)", "free sample; giveaway", "fashion model; exemplary person"], a: 0, e: "見本 is something shown as a representative example (見本市 = trade fair/expo, 見本を見せる = to show a sample, 手本 = a model to copy/follow)." }
    ]
  },
  {
    id: "n2-0710", w: "後回し", r: "あとまわし", m: "putting off; deferring; leaving for later", c: "noun", lv: 1,
    ex: [{ jp: "重要な課題を後回しにする癖がついてしまっている。", en: "I have developed the habit of putting off important tasks." }],
    qs: [
      { t: "fitb", s: "健康のことを仕事の＿＿＿＿にし続けた結果、体を壊してしまった。", en: "As a result of constantly putting health behind work, I broke down my body.", o: ["後回し", "二の次", "先送り", "棚上げ"], a: 0, e: "後回し(あとまわし) = pushing something to later / not doing it now. 二の次(にのつぎ) = of secondary importance. 先送り(さきおくり) = postponing/deferring. 棚上げ(たなあげ) = shelving/putting on the back burner (indefinitely)." },
      { t: "meaning", s: "「後回し」の意味は？", o: ["putting off; leaving for later", "of secondary importance", "postponing; deferring", "shelving; putting on the back burner"], a: 0, e: "後回しにする = to push something to later (後回しにしてはいけない = must not put off). 先送り is more formal/political. 棚上げ implies the issue is suspended indefinitely." }
    ]
  },
  {
    id: "n2-0711", w: "取り扱い", r: "とりあつかい", m: "handling; treatment; dealing with", c: "noun", lv: 1,
    ex: [{ jp: "この機器の取り扱いには十分な注意が必要だ。", en: "Sufficient care is required when handling this device." }],
    qs: [
      { t: "fitb", s: "危険物の＿＿＿＿には資格が必要な場合がある。", en: "Handling hazardous materials may require a license.", o: ["取り扱い", "扱い", "処理", "操作"], a: 0, e: "取り扱い(とりあつかい) = handling/treatment (formal; 取り扱い説明書 = instruction manual). 扱い(あつかい) = treatment/handling (general). 処理(しょり) = processing/dealing with (data, waste). 操作(そうさ) = operation/manipulation (a device)." },
      { t: "meaning", s: "「取り扱い」の意味は？", o: ["handling; treatment (formal)", "treatment; handling (general)", "processing; dealing with", "operation; manipulation"], a: 0, e: "取り扱い is the formal term for handling or dealing with something (個人情報の取り扱い = handling of personal information, 取り扱い注意 = handle with care)." }
    ]
  },
  {
    id: "n2-0712", w: "欠点", r: "けってん", m: "fault; defect; shortcoming; weak point", c: "noun", lv: 1,
    ex: [{ jp: "自分の欠点を認めて改善しようとすることは、成長につながる。", en: "Acknowledging your own shortcomings and trying to improve them leads to growth." }],
    qs: [
      { t: "fitb", s: "この計画の＿＿＿＿は、コストが高すぎる点だ。", en: "The shortcoming of this plan is that the costs are too high.", o: ["欠点", "弱点", "短所", "デメリット"], a: 0, e: "欠点(けってん) = a fault/defect (something that should not be there). 弱点(じゃくてん) = a weak point (already in earlier batches). 短所(たんしょ) = a shortcoming/weakness (opposite of 長所). デメリット = disadvantage (loanword)." },
      { t: "meaning", s: "「欠点」の意味は？", o: ["fault; defect; shortcoming", "weak point; vulnerability", "weakness; shortcoming (vs. strength)", "disadvantage (loanword)"], a: 0, e: "欠点 is a flaw or defect (欠点を補う = to make up for one's faults). 短所 pairs with 長所(ちょうしょ) = strong point, in the context of personal pros and cons." }
    ]
  },
  {
    id: "n2-0713", w: "長所", r: "ちょうしょ", m: "strong point; merit; advantage", c: "noun", lv: 1,
    ex: [{ jp: "面接で長所と短所を聞かれるのは定番の質問だ。", en: "Being asked about your strengths and weaknesses in an interview is a standard question." }],
    qs: [
      { t: "fitb", s: "彼の最大の＿＿＿＿は、どんな人とも仲良くなれる社交性だ。", en: "His greatest strength is his sociability — he can get along with anyone.", o: ["長所", "強み", "メリット", "利点"], a: 0, e: "長所(ちょうしょ) = a strong point (personal quality, pairs with 短所). 強み(つよみ) = strength/edge (competitive). メリット = merit/advantage (loanword). 利点(りてん) = advantage/benefit (of a plan/option)." },
      { t: "meaning", s: "「長所」の意味は？", o: ["strong point (personal quality)", "competitive strength; edge", "merit; advantage (loanword)", "advantage; benefit (of a plan)"], a: 0, e: "長所 is used in personal context (長所を伸ばす = to develop one's strengths). 強み is more about competitive advantage. 利点 is practical benefit." }
    ]
  },
  {
    id: "n2-0714", w: "物価", r: "ぶっか", m: "prices; cost of living", c: "noun", lv: 1,
    ex: [{ jp: "近年、物価の上昇が家計を圧迫している。", en: "In recent years, rising prices have been squeezing household budgets." }],
    qs: [
      { t: "fitb", s: "この国は＿＿＿＿が高く、外国人観光客には出費が多い。", en: "Prices in this country are high and foreign tourists have many expenses.", o: ["物価", "物値", "価格", "料金"], a: 0, e: "物価(ぶっか) = the general price level / cost of living. 価格(かかく) = the price of a specific item. 料金(りょうきん) = a fee/charge (for services). 物値(ものね) = the price of goods (colloquial variant)." },
      { t: "meaning", s: "「物価」の意味は？", o: ["general price level; cost of living", "price (of a specific item)", "fee; charge (for services)", "goods price (colloquial)"], a: 0, e: "物価 is a macro-economic term (物価上昇 = price rise/inflation, 物価安定 = price stability). 価格 is the individual price of one thing." }
    ]
  },
  {
    id: "n2-0715", w: "収納", r: "しゅうのう", m: "storage; putting away; storing", c: "noun", lv: 1,
    ex: [{ jp: "この家具は収納スペースが多く、部屋がすっきり片付く。", en: "This furniture has plenty of storage space and keeps the room tidy." }],
    qs: [
      { t: "fitb", s: "狭い部屋を広く使うために、＿＿＿＿を工夫することが大切だ。", en: "To make good use of a small room, it is important to be creative with storage.", o: ["収納", "収蔵", "保管", "格納"], a: 0, e: "収納(しゅうのう) = everyday storage (of household items, clothing). 収蔵(しゅうぞう) = storing a collection (museum/archive). 保管(ほかん) = safekeeping/storage (important items). 格納(かくのう) = storage/housing (planes in a hangar, data)." },
      { t: "meaning", s: "「収納」の意味は？", o: ["everyday storage; putting away", "storing a collection (museum)", "safekeeping; storage (important items)", "housing; storage (technical)"], a: 0, e: "収納 is the daily-life word for storing things (収納スペース = storage space, 収納家具 = storage furniture, 上手な収納 = clever storage)." }
    ]
  },
  {
    id: "n2-0716", w: "出費", r: "しゅっぴ", m: "expenditure; outgoing expense", c: "noun", lv: 1,
    ex: [{ jp: "今月は急な出費が重なり、家計が苦しい。", en: "Unexpected expenses piled up this month and the household budget is tight." }],
    qs: [
      { t: "fitb", s: "子育てには何かと＿＿＿＿がかかる。", en: "Raising children involves various expenses.", o: ["出費", "費用", "支出", "経費"], a: 0, e: "出費(しゅっぴ) = an expense that goes out (急な出費 = an unexpected expense). 費用(ひよう) = cost/expense (of a project). 支出(ししゅつ) = expenditure (accounting/formal). 経費(けいひ) = business expenses." },
      { t: "meaning", s: "「出費」の意味は？", o: ["outgoing expense; money spent", "cost (of a project)", "expenditure (accounting)", "business expenses"], a: 0, e: "出費 is money that flows out (出費を抑える = to hold down expenses, 無駄な出費 = wasteful spending). More personal/household than 支出 which is an accounting term." }
    ]
  },
  {
    id: "n2-0717", w: "下請け", r: "したうけ", m: "subcontract; subcontractor", c: "noun", lv: 1,
    ex: [{ jp: "大手ゼネコンの下請けとして、建設工事を請け負っている。", en: "We take on construction work as a subcontractor for a major general contractor." }],
    qs: [
      { t: "fitb", s: "この製品の一部は海外の＿＿＿＿工場で製造されている。", en: "Part of this product is manufactured at overseas subcontract factories.", o: ["下請け", "外注", "委託", "提携"], a: 0, e: "下請け(したうけ) = a subcontractor (receives work from a prime contractor). 外注(がいちゅう) = outsourcing (to an external party). 委託(いたく) = consignment/entrusting. 提携(ていけい) = partnership/tie-up." },
      { t: "meaning", s: "「下請け」の意味は？", o: ["subcontract; subcontractor", "outsourcing (to external party)", "consignment; entrusting", "partnership; tie-up"], a: 0, e: "下請け is when a company takes on work passed down from a larger contractor (下請け業者 = subcontractor, 下請け構造 = subcontracting structure). 外注 is outsourcing to an outside company." }
    ]
  },
  {
    id: "n2-0718", w: "目処", r: "めど", m: "prospect; target; aim; rough schedule", c: "noun", lv: 1,
    ex: [{ jp: "来月末を目処に、プロジェクトを完了させたい。", en: "I would like to complete the project with the end of next month as the target." }],
    qs: [
      { t: "fitb", s: "修理が終わる＿＿＿＿が立たず、代替品を手配することにした。", en: "With no clear prospect of when the repair would finish, I decided to arrange a replacement.", o: ["目処", "見通し", "目安", "目標"], a: 0, e: "目処(めど) = a rough target or schedule (目処がつく = to get a rough idea of timing, 目処が立たない = no prospect in sight). 見通し(みとおし) = outlook. 目安(めやす) = a benchmark. 目標(もくひょう) = a goal." },
      { t: "meaning", s: "「目処」の意味は？", o: ["rough target; prospect; rough schedule", "outlook; future view", "benchmark; rough guide", "goal; concrete target"], a: 0, e: "目処 is a rough timing or completion target (完成の目処が立つ = a completion date is in sight, 目処をつける = to figure out a rough schedule)." }
    ]
  },
  {
    id: "n2-0719", w: "余地", r: "よち", m: "room; scope; margin; leeway", c: "noun", lv: 1,
    ex: [{ jp: "この計画にはまだ改善の余地がある。", en: "There is still room for improvement in this plan." }],
    qs: [
      { t: "fitb", s: "彼の主張には疑いの＿＿＿＿がない。", en: "There is no room for doubt in his argument.", o: ["余地", "余裕", "余剰", "空き"], a: 0, e: "余地(よち) = scope/room for something (abstract: 余地がない = no room for). 余裕(よゆう) = margin/leeway (time, money, mental capacity). 余剰(よじょう) = surplus/excess. 空き(あき) = an opening/vacancy (physical)." },
      { t: "meaning", s: "「余地」の意味は？", o: ["room; scope (abstract)", "margin; leeway (time/money/mental)", "surplus; excess", "opening; vacancy (physical)"], a: 0, e: "余地 is always abstract scope or margin (改善の余地 = room for improvement, 疑いの余地なく = beyond doubt, 交渉の余地 = room to negotiate)." }
    ]
  },
  {
    id: "n2-0720", w: "重なる", r: "かさなる", m: "to pile up; to overlap; to coincide", c: "verb", lv: 1,
    ex: [{ jp: "不運なことが重なり、最悪の月になった。", en: "Unfortunate things piled up and it became the worst month." }],
    qs: [
      { t: "fitb", s: "今週は予定が＿＿＿＿っていて、忙しくて仕方がない。", en: "My schedule is piling up this week and I am helplessly busy.", o: ["重な", "詰ま", "積み重な", "集中し"], a: 0, e: "重なる(かさなる) = to pile up / overlap (events, misfortunes coinciding). 詰まる(つまる) = to get packed/blocked. 積み重なる(つみかさなる) = to accumulate layer by layer. 集中する(しゅうちゅうする) = to concentrate/converge." },
      { t: "meaning", s: "「重なる」の意味は？", o: ["to pile up; to overlap; to coincide", "to get packed; to be blocked", "to accumulate layer by layer", "to concentrate; to converge"], a: 0, e: "重なる = things happening on top of each other (不幸が重なる = misfortunes pile up, 日程が重なる = schedules overlap). Different from 重ねる(かさねる) = to stack/layer (transitive)." }
    ]
  },
  {
    id: "n2-0721", w: "掘り下げる", r: "ほりさげる", m: "to dig into; to delve deeper into; to pursue", c: "verb", lv: 1,
    ex: [{ jp: "表面的な理解で満足せず、テーマをもっと掘り下げることが大切だ。", en: "It is important not to be satisfied with superficial understanding but to delve deeper into the theme." }],
    qs: [
      { t: "fitb", s: "問題の根本原因を＿＿＿＿ために、追加調査が必要だ。", en: "Additional investigation is necessary to dig deeper into the root cause of the problem.", o: ["掘り下げる", "突き詰める", "探る", "分析する"], a: 0, e: "掘り下げる(ほりさげる) = to dig deeper/investigate thoroughly. 突き詰める(つきつめる) = to pursue to the very end / think through completely. 探る(さぐる) = to probe/explore. 分析する(ぶんせきする) = to analyze." },
      { t: "meaning", s: "「掘り下げる」の意味は？", o: ["to dig into; to delve deeper", "to pursue to the very end", "to probe; to explore", "to analyze; to break down"], a: 0, e: "掘り下げる = going deeper beneath the surface (問題を掘り下げる = to dig into an issue, 内容を掘り下げた議論 = an in-depth discussion)." }
    ]
  },
  {
    id: "n2-0722", w: "通じる", r: "つうじる", m: "to get through; to be understood; to connect", c: "verb", lv: 1,
    ex: [{ jp: "英語が通じる国なら、旅行に困らない。", en: "If it's a country where English gets through, I won't have trouble traveling." }],
    qs: [
      { t: "fitb", s: "どんなに言葉を尽くしても、気持ちが＿＿＿＿ないことがある。", en: "No matter how many words you use, there are times when your feelings don't get through.", o: ["通じ", "伝わら", "届か", "理解され"], a: 0, e: "通じる(つうじる) = to get through / be understood / be connected (言葉が通じる = language gets through, 電話が通じる = the call goes through). 伝わる(つたわる) = to be conveyed/transmitted. 届く(とどく) = to reach/arrive. 理解される = to be understood." },
      { t: "meaning", s: "「通じる」の意味は？", o: ["to get through; to be understood", "to be conveyed; to be transmitted", "to reach; to arrive", "to be understood (passive)"], a: 0, e: "通じる = a link or understanding being established (外国語が通じる = foreign language is understood, AはBに通じる = A connects to B, A is related to B)." }
    ]
  },
  {
    id: "n2-0723", w: "恐れ", r: "おそれ", m: "fear; risk; possibility (of something bad)", c: "noun", lv: 1,
    ex: [{ jp: "この地域には大雨による洪水の恐れがある。", en: "There is a risk of flooding from heavy rain in this area." }],
    qs: [
      { t: "fitb", s: "このままでは、プロジェクトが失敗する＿＿＿＿がある。", en: "As things stand, there is a risk that the project will fail.", o: ["恐れ", "危険", "可能性", "見込み"], a: 0, e: "恐れ(おそれ) = fear or the risk/possibility of something bad. 危険(きけん) = danger. 可能性(かのうせい) = possibility (neutral). 見込み(みこみ) = expectation/likelihood." },
      { t: "meaning", s: "「恐れ」の意味は？", o: ["fear; risk (of something bad)", "danger; hazard", "possibility (neutral)", "expectation; likelihood"], a: 0, e: "恐れ has two uses: fear (恐れをなす = to be afraid) and formal risk/possibility (崩壊の恐れがある = there is a risk of collapse). The second usage is common in news and formal writing." }
    ]
  },
  {
    id: "n2-0724", w: "依頼", r: "いらい", m: "request; commission; asking a favor", c: "noun", lv: 1,
    ex: [{ jp: "知人から翻訳の依頼を受け、快く引き受けた。", en: "I received a translation request from an acquaintance and gladly accepted." }],
    qs: [
      { t: "fitb", s: "弁護士に事件の調査を＿＿＿＿することにした。", en: "I decided to commission a lawyer to investigate the case.", o: ["依頼", "委託", "要請", "申し込み"], a: 0, e: "依頼(いらい)する = to request/ask (someone to do something for you). 委託(いたく)する = to entrust/consign (work to another). 要請(ようせい)する = to request (formally, often from authority to authority). 申し込む(もうしこむ) = to apply/register." },
      { t: "meaning", s: "「依頼」の意味は？", o: ["request; asking a favor", "entrustment; consignment", "formal request (authority to authority)", "application; registration"], a: 0, e: "依頼 = asking someone to do something on your behalf (依頼人 = client, 依頼書 = letter of request). 委託 is giving something into someone else's care. 要請 is an official call to action." }
    ]
  },
  {
    id: "n2-0725", w: "余分", r: "よぶん", m: "extra; surplus; unnecessary", c: "noun", lv: 1,
    ex: [{ jp: "余分な出費を避けるため、購入前によく考えるようにしている。", en: "I try to think carefully before buying in order to avoid unnecessary expenditure." }],
    qs: [
      { t: "fitb", s: "作りすぎた料理の＿＿＿＿分は、タッパーに入れて冷凍した。", en: "The extra portion of the food I made too much of went into a container and was frozen.", o: ["余分", "余剰", "余り", "余計"], a: 0, e: "余分(よぶん) = an extra/surplus amount (often unwanted). 余剰(よじょう) = surplus (economic/official term). 余り(あまり) = the remainder/leftover. 余計(よけい) = extra / unnecessary / making things worse." },
      { t: "meaning", s: "「余分」の意味は？", o: ["extra; surplus; unnecessary", "surplus (economic term)", "remainder; leftover", "unnecessary; unwanted; making it worse"], a: 0, e: "余分 = more than needed (余分に買う = to buy extra, 余分な説明 = an unnecessary explanation). 余計 is similar but stronger — it actively makes things worse (余計なお世話 = meddling)." }
    ]
  },
  {
    id: "n2-0726", w: "先行き", r: "さきゆき", m: "future prospects; outlook; what lies ahead", c: "noun", lv: 1,
    ex: [{ jp: "業績不振が続き、会社の先行きが不透明になってきた。", en: "With poor business performance continuing, the company's future outlook has become unclear." }],
    qs: [
      { t: "fitb", s: "不安定な経済状況の中、多くの企業が＿＿＿＿を懸念している。", en: "In the unstable economic climate, many companies are concerned about what lies ahead.", o: ["先行き", "将来", "見通し", "行方"], a: 0, e: "先行き(さきゆき) = the near-term outlook/future (of a business or economy). 将来(しょうらい) = the (longer-term) future. 見通し(みとおし) = outlook/prospect. 行方(ゆくえ) = whereabouts / where things are headed." },
      { t: "meaning", s: "「先行き」の意味は？", o: ["near-term outlook; what lies ahead", "the (long-term) future", "outlook; prospect", "whereabouts; direction things are headed"], a: 0, e: "先行き is used for the near-to-medium-term business or economic outlook (先行き不透明 = uncertain outlook, 先行きを楽観する = to be optimistic about the future)." }
    ]
  },
  {
    id: "n2-0727", w: "見送る", r: "みおくる", m: "to see off; to pass on; to defer", c: "verb", lv: 1,
    ex: [{ jp: "今回の投資案件は見送ることにした。", en: "I decided to pass on this investment deal." }],
    qs: [
      { t: "fitb", s: "予算不足のため、新システムの導入を今年度は＿＿＿＿ことになった。", en: "Due to budget shortfalls, the introduction of the new system was deferred for this fiscal year.", o: ["見送る", "先送りする", "延期する", "諦める"], a: 0, e: "見送る(みおくる) = to pass on/defer (a plan, deal). 先送りする = to postpone. 延期する(えんきする) = to postpone (with a new date). 諦める(あきらめる) = to give up entirely." },
      { t: "meaning", s: "「見送る」の意味は？", o: ["to see off; to pass on; to defer", "to postpone (no set date)", "to postpone (to a new date)", "to give up entirely"], a: 0, e: "見送る covers seeing someone off (駅で見送る = to see off at the station) and deciding not to proceed with something (計画を見送る = to pass on a plan)." }
    ]
  },
  {
    id: "n2-0728", w: "割り当てる", r: "わりあてる", m: "to assign; to allocate; to apportion", c: "verb", lv: 1,
    ex: [{ jp: "各チームに作業を均等に割り当てた。", en: "I assigned the work equally to each team." }],
    qs: [
      { t: "fitb", s: "プロジェクトの予算をどのように＿＿＿＿かが重要な課題だ。", en: "How to allocate the project budget is an important issue.", o: ["割り当てる", "配分する", "割り振る", "分配する"], a: 0, e: "割り当てる(わりあてる) = to assign/allocate (a task, quota). 配分する(はいぶんする) = to distribute/apportion (resources). 割り振る(わりふる) = to allot/assign (slightly more casual). 分配する(ぶんぱいする) = to distribute/share out." },
      { t: "meaning", s: "「割り当てる」の意味は？", o: ["to assign; to allocate (a task/quota)", "to distribute; to apportion (resources)", "to allot; to assign (casual)", "to share out; to distribute equally"], a: 0, e: "割り当てる = giving each person or group their designated share (役割を割り当てる = to assign roles, 割り当て量 = quota)." }
    ]
  },
  {
    id: "n2-0729", w: "見直し", r: "みなおし", m: "review; revision; reconsideration", c: "noun", lv: 1,
    ex: [{ jp: "制度の見直しが急務となっている。", en: "A review of the system has become an urgent task." }],
    qs: [
      { t: "fitb", s: "料金体系の＿＿＿＿を求める声が消費者から上がっている。", en: "Voices calling for a revision of the pricing structure are rising from consumers.", o: ["見直し", "改正", "改革", "修正"], a: 0, e: "見直し(みなおし) = a review/reconsideration (often leading to change). 改正(かいせい) = revision/amendment (of a law). 改革(かいかく) = reform (large-scale). 修正(しゅうせい) = correction/revision (of a document or plan)." },
      { t: "meaning", s: "「見直し」の意味は？", o: ["review; reconsideration", "revision; amendment (of a law)", "reform (large-scale)", "correction; revision (of a document)"], a: 0, e: "見直し = taking another look at something to potentially change it (規則の見直し = review of rules, 見直しを図る = to seek to revise)." }
    ]
  },
  {
    id: "n2-0730", w: "受け止める", r: "うけとめる", m: "to receive; to take in; to accept; to take seriously", c: "verb", lv: 1,
    ex: [{ jp: "上司の批判を真摯に受け止め、改善に努めた。", en: "I sincerely took my boss's criticism on board and worked to improve." }],
    qs: [
      { t: "fitb", s: "悪い知らせをどう＿＿＿＿かによって、その後の行動が変わる。", en: "How you receive bad news changes your subsequent actions.", o: ["受け止める", "受け入れる", "受け取る", "捉える"], a: 0, e: "受け止める(うけとめる) = to take/absorb (an impact, news — absorbing the weight of it). 受け入れる(うけいれる) = to accept/take in (without resistance). 受け取る(うけとる) = to receive (physically or informationally). 捉える(とらえる) = to grasp/perceive." },
      { t: "meaning", s: "「受け止める」の意味は？", o: ["to absorb; to take on board", "to accept; to take in", "to receive (physically)", "to grasp; to perceive"], a: 0, e: "受け止める implies bearing the weight of something (ショックを受け止める = to absorb a shock, 重く受け止める = to take something seriously)." }
    ]
  },
  {
    id: "n2-0731", w: "取り除く", r: "とりのぞく", m: "to remove; to eliminate; to get rid of", c: "verb", lv: 1,
    ex: [{ jp: "障害を取り除くことで、プロジェクトはスムーズに進んだ。", en: "By removing the obstacles, the project proceeded smoothly." }],
    qs: [
      { t: "fitb", s: "不安の原因を＿＿＿＿ことが、ストレス解消の第一歩だ。", en: "Removing the cause of anxiety is the first step to relieving stress.", o: ["取り除く", "排除する", "除去する", "なくす"], a: 0, e: "取り除く(とりのぞく) = to remove/get rid of (an obstacle, cause). 排除する(はいじょする) = to exclude/eliminate (formally). 除去する(じょきょする) = to remove (technical/official). なくす = to eliminate/lose." },
      { t: "meaning", s: "「取り除く」の意味は？", o: ["to remove; to get rid of", "to exclude; to eliminate (formal)", "to remove (technical/official)", "to eliminate; to lose"], a: 0, e: "取り除く is the everyday verb for removing something unwanted (ゴミを取り除く = to clear rubbish, 不安を取り除く = to dispel anxiety)." }
    ]
  },
  {
    id: "n2-0732", w: "使い果たす", r: "つかいはたす", m: "to use up; to exhaust; to spend completely", c: "verb", lv: 1,
    ex: [{ jp: "旅行で貯金を使い果たしてしまった。", en: "I used up all my savings on the trip." }],
    qs: [
      { t: "fitb", s: "体力を＿＿＿＿すまで働き続けるのは、健康によくない。", en: "Continuing to work until you have exhausted your physical strength is not good for your health.", o: ["使い果た", "消耗し", "使い切ら", "費や"], a: 0, e: "使い果たす(つかいはたす) = to completely use up (resources, money). 消耗する(しょうもうする) = to wear down/exhaust. 使い切る(つかいきる) = to use up completely (similar). 費やす(ついやす) = to spend/devote (time, money)." },
      { t: "meaning", s: "「使い果たす」の意味は？", o: ["to use up completely; to exhaust", "to wear down; to deplete", "to use up (similar, slightly casual)", "to spend; to devote (time/money)"], a: 0, e: "使い果たす = leaving nothing left (お金を使い果たす = to spend every last penny, エネルギーを使い果たす = to be completely drained)." }
    ]
  },
  {
    id: "n2-0733", w: "取り戻す", r: "とりもどす", m: "to get back; to recover; to regain", c: "verb", lv: 1,
    ex: [{ jp: "休養をとって、失った体力を取り戻した。", en: "I took rest and regained the physical strength I had lost." }],
    qs: [
      { t: "fitb", s: "信頼を一度失うと、＿＿＿＿のに長い時間がかかる。", en: "Once trust is lost, it takes a long time to get it back.", o: ["取り戻す", "回復する", "取り返す", "取り戻せる"], a: 0, e: "取り戻す(とりもどす) = to get back/regain (something lost). 回復する(かいふくする) = to recover (health, economy). 取り返す(とりかえす) = to get back/recoup (something taken away). 取り返しがつかない = irreversible." },
      { t: "meaning", s: "「取り戻す」の意味は？", o: ["to get back; to regain", "to recover (health, economy)", "to recoup; to get back (what was taken)", "irreversible (idiom)"], a: 0, e: "取り戻す = returning something to its former state (自信を取り戻す = to regain confidence, リードを取り戻す = to reclaim the lead)." }
    ]
  },
  {
    id: "n2-0734", w: "言い表す", r: "いいあらわす", m: "to express; to put into words", c: "verb", lv: 1,
    ex: [{ jp: "その感動を言葉で言い表すことができなかった。", en: "I could not put that feeling of being moved into words." }],
    qs: [
      { t: "fitb", s: "複雑な感情を的確に＿＿＿＿語彙力が必要だ。", en: "Vocabulary is needed to accurately express complex emotions.", o: ["言い表す", "表現する", "伝える", "描写する"], a: 0, e: "言い表す(いいあらわす) = to express in words / put into language. 表現する(ひょうげんする) = to express (through any medium). 伝える(つたえる) = to convey/communicate. 描写する(びょうしゃする) = to describe/depict." },
      { t: "meaning", s: "「言い表す」の意味は？", o: ["to express; to put into words", "to express (through any medium)", "to convey; to communicate", "to describe; to depict"], a: 0, e: "言い表す focuses on verbal expression (うまく言い表せない = hard to put into words, 一言で言い表す = to sum up in one word)." }
    ]
  },
  {
    id: "n2-0735", w: "差し引く", r: "さしひく", m: "to deduct; to subtract; to net out", c: "verb", lv: 1,
    ex: [{ jp: "税金を差し引いた手取り額は思ったより少なかった。", en: "The take-home amount after deducting taxes was less than I expected." }],
    qs: [
      { t: "fitb", s: "経費を＿＿＿＿と、今月の利益はわずかだ。", en: "After deducting expenses, this month's profit is minimal.", o: ["差し引く", "引く", "控除する", "差し引いた"], a: 0, e: "差し引く(さしひく) = to deduct/net out. 引く(ひく) = to subtract (math). 控除する(こうじょする) = to deduct (tax/official term). 差し引いた後 = after deducting." },
      { t: "meaning", s: "「差し引く」の意味は？", o: ["to deduct; to net out", "to subtract (arithmetic)", "to deduct (tax, official)", "to offset; to balance out"], a: 0, e: "差し引く = subtracting one amount from another (経費を差し引く = to deduct expenses, 差し引きゼロ = net zero / breaks even)." }
    ]
  },
  {
    id: "n2-0736", w: "呼びかける", r: "よびかける", m: "to call out to; to appeal to; to urge", c: "verb", lv: 1,
    ex: [{ jp: "市は市民に節水を呼びかけている。", en: "The city is appealing to citizens to save water." }],
    qs: [
      { t: "fitb", s: "政府は国民にワクチン接種を＿＿＿＿けた。", en: "The government urged citizens to get vaccinated.", o: ["呼びか", "訴えか", "働きか", "促し"], a: 0, e: "呼びかける(よびかける) = to call out/appeal to (the public, a person). 訴えかける(うったえかける) = to appeal emotionally. 働きかける(はたらきかける) = to work on/lobby (someone to do something). 促す(うながす) = to urge/prompt." },
      { t: "meaning", s: "「呼びかける」の意味は？", o: ["to call out to; to appeal to (public)", "to appeal emotionally", "to lobby; to work on (someone)", "to urge; to prompt"], a: 0, e: "呼びかける = directing a message or appeal at someone (注意を呼びかける = to call for caution, 参加を呼びかける = to call for participation)." }
    ]
  },
  {
    id: "n2-0737", w: "取り上げる", r: "とりあげる", m: "to take up; to feature; to pick up; to confiscate", c: "verb", lv: 1,
    ex: [{ jp: "その問題はニュースで大きく取り上げられた。", en: "That issue was prominently featured in the news." }],
    qs: [
      { t: "fitb", s: "この会議では環境問題を主なテーマとして＿＿＿＿予定だ。", en: "Environmental issues are scheduled to be taken up as the main theme at this meeting.", o: ["取り上げる", "扱う", "議論する", "採用する"], a: 0, e: "取り上げる(とりあげる) = to take up/feature (a topic). 扱う(あつかう) = to deal with/handle. 議論する(ぎろんする) = to debate/discuss. 採用する(さいようする) = to adopt/hire." },
      { t: "meaning", s: "「取り上げる」の意味は？", o: ["to take up; to feature (a topic)", "to deal with; to handle", "to debate; to discuss", "to adopt; to hire"], a: 0, e: "取り上げる = selecting something to focus on (問題を取り上げる = to take up an issue, メディアに取り上げられる = to be covered by the media). Also: to confiscate (免許を取り上げる = to revoke a licence)." }
    ]
  },
  {
    id: "n2-0738", w: "見渡す", r: "みわたす", m: "to look out over; to survey; to scan", c: "verb", lv: 1,
    ex: [{ jp: "展望台から街全体を見渡すことができた。", en: "From the observation deck I could look out over the entire city." }],
    qs: [
      { t: "fitb", s: "丘の上に立って、広大な平野を＿＿＿＿た。", en: "Standing on the hill, I surveyed the vast plain.", o: ["見渡し", "見回し", "眺め", "一望し"], a: 0, e: "見渡す(みわたす) = to look out over a wide area. 見回す(みまわす) = to look around (in all directions). 眺める(ながめる) = to gaze at / admire. 一望する(いちぼうする) = to take in the whole view at once." },
      { t: "meaning", s: "「見渡す」の意味は？", o: ["to look out over; to survey (wide view)", "to look around (in all directions)", "to gaze at; to admire", "to take in the whole view at once"], a: 0, e: "見渡す = sweeping one's gaze across a wide expanse (地平線まで見渡す = to see all the way to the horizon, 見渡す限り = as far as the eye can see)." }
    ]
  },
  {
    id: "n2-0739", w: "受け継ぐ", r: "うけつぐ", m: "to inherit; to succeed to; to take over", c: "verb", lv: 1,
    ex: [{ jp: "父の会社を受け継いで、三代目社長になった。", en: "I inherited my father's company and became the third-generation president." }],
    qs: [
      { t: "fitb", s: "この地域の伝統文化を次世代に＿＿＿＿ことが私たちの使命だ。", en: "It is our mission to pass on the traditional culture of this region to the next generation.", o: ["受け継ぐ", "引き継ぐ", "伝える", "継承する"], a: 0, e: "受け継ぐ(うけつぐ) = to inherit/receive and carry on (heritage, spirit). 引き継ぐ(ひきつぐ) = to take over (a job, task — handover). 伝える(つたえる) = to pass on/convey. 継承する(けいしょうする) = to succeed to/inherit (formal)." },
      { t: "meaning", s: "「受け継ぐ」の意味は？", o: ["to inherit; to carry on (heritage)", "to take over (a job/task)", "to pass on; to convey", "to succeed to; inherit (formal)"], a: 0, e: "受け継ぐ emphasises receiving and carrying forward a legacy (伝統を受け継ぐ = to carry on a tradition, 遺伝子を受け継ぐ = to inherit genes)." }
    ]
  },
  {
    id: "n2-0740", w: "問い直す", r: "といなおす", m: "to re-examine; to reconsider; to question again", c: "verb", lv: 1,
    ex: [{ jp: "この事件は、私たちの価値観を根本から問い直すきっかけになった。", en: "This incident became an opportunity to fundamentally re-examine our values." }],
    qs: [
      { t: "fitb", s: "当たり前だと思っていたことを＿＿＿＿必要があるかもしれない。", en: "It may be necessary to re-examine what we have taken for granted.", o: ["問い直す", "見直す", "再考する", "疑う"], a: 0, e: "問い直す(といなおす) = to question again from scratch (深く問い直す = to deeply re-examine). 見直す(みなおす) = to review/revise. 再考する(さいこうする) = to reconsider. 疑う(うたがう) = to doubt/suspect." },
      { t: "meaning", s: "「問い直す」の意味は？", o: ["to re-examine; to question again", "to review; to revise", "to reconsider (formally)", "to doubt; to suspect"], a: 0, e: "問い直す = asking the fundamental question all over again (自分自身を問い直す = to re-examine oneself, 存在意義を問い直す = to question one's raison d'être)." }
    ]
  },
  {
    id: "n2-0741", w: "持ち込む", r: "もちこむ", m: "to bring in; to introduce; to carry in", c: "verb", lv: 1,
    ex: [{ jp: "試験会場への電子機器の持ち込みは禁止されている。", en: "Bringing electronic devices into the examination venue is prohibited." }],
    qs: [
      { t: "fitb", s: "個人的な問題を職場に＿＿＿＿ことは避けるべきだ。", en: "Bringing personal problems into the workplace should be avoided.", o: ["持ち込む", "持ち込ませる", "引き込む", "押し込む"], a: 0, e: "持ち込む(もちこむ) = to bring something into a space. 引き込む(ひきこむ) = to draw in/pull into. 押し込む(おしこむ) = to push/cram in." },
      { t: "meaning", s: "「持ち込む」の意味は？", o: ["to bring in; to carry in", "to draw in; to pull into", "to push in; to cram in", "to carry out; to take outside"], a: 0, e: "持ち込む = carrying something from outside into a space (食べ物の持ち込み禁止 = no outside food allowed, 問題を持ち込む = to bring a problem to someone)." }
    ]
  },
  {
    id: "n2-0742", w: "立ち向かう", r: "たちむかう", m: "to confront; to face up to; to stand up against", c: "verb", lv: 1,
    ex: [{ jp: "どんな困難にも立ち向かう勇気を持ちたい。", en: "I want to have the courage to stand up to any difficulty." }],
    qs: [
      { t: "fitb", s: "不正に黙って従うのではなく、勇気を持って＿＿＿＿べきだ。", en: "Rather than silently going along with injustice, one should bravely stand up against it.", o: ["立ち向かう", "立ち上がる", "対抗する", "向き合う"], a: 0, e: "立ち向かう(たちむかう) = to confront/face up to (adversity, an opponent). 立ち上がる(たちあがる) = to stand up / rise up. 対抗する(たいこうする) = to compete against. 向き合う(むきあう) = to face up to / come face to face with." },
      { t: "meaning", s: "「立ち向かう」の意味は？", o: ["to confront; to stand up against", "to stand up; to rise up", "to compete against", "to face up to; to come face to face with"], a: 0, e: "立ち向かう = actively going up against a challenge or adversary (困難に立ち向かう = to face difficulties, 強敵に立ち向かう = to stand up to a strong opponent)." }
    ]
  },
  {
    id: "n2-0743", w: "打ち込む", r: "うちこむ", m: "to devote oneself to; to throw oneself into", c: "verb", lv: 1,
    ex: [{ jp: "大学時代はサッカーに打ち込み、全国大会にも出場した。", en: "In my university days I devoted myself to football and even competed in the national tournament." }],
    qs: [
      { t: "fitb", s: "仕事に＿＿＿＿すぎて、家族との時間を疎かにしていた。", en: "I was too absorbed in work and was neglecting time with my family.", o: ["打ち込み", "没頭し", "熱中し", "集中し"], a: 0, e: "打ち込む(うちこむ) = to throw oneself into (with passion). 没頭する(ぼっとうする) = to be absorbed in. 熱中する(ねっちゅうする) = to be enthusiastic/engrossed in. 集中する(しゅうちゅうする) = to concentrate on." },
      { t: "meaning", s: "「打ち込む」の意味は？", o: ["to devote oneself; to throw oneself into", "to be absorbed in; to be immersed in", "to be engrossed; to be enthusiastic", "to concentrate on; to focus on"], a: 0, e: "打ち込む = wholehearted dedication (勉強に打ち込む = to throw oneself into studying). Also: to type in / drive in (data entry, a nail)." }
    ]
  },
  {
    id: "n2-0744", w: "引き継ぐ", r: "ひきつぐ", m: "to take over; to hand over; to succeed", c: "verb", lv: 1,
    ex: [{ jp: "前任者から業務を引き継ぐのに二週間かかった。", en: "It took two weeks to take over the duties from my predecessor." }],
    qs: [
      { t: "fitb", s: "プロジェクトの途中で担当者が変わり、新しい人が＿＿＿＿だ。", en: "The person in charge changed mid-project and a new person will take over.", o: ["引き継ぐ", "受け継ぐ", "担当する", "引き受ける"], a: 0, e: "引き継ぐ(ひきつぐ) = to take over a job/task from someone (handover). 受け継ぐ(うけつぐ) = to inherit (a legacy/tradition). 担当する(たんとうする) = to be in charge of. 引き受ける(ひきうける) = to accept/take on." },
      { t: "meaning", s: "「引き継ぐ」の意味は？", o: ["to take over (a job/task, handover)", "to inherit (a legacy/tradition)", "to be in charge of", "to accept; to take on"], a: 0, e: "引き継ぐ is specifically a work handover (業務を引き継ぐ = to take over duties, 引き継ぎ書類 = handover documents). 受け継ぐ is inheriting something more lasting." }
    ]
  },
  {
    id: "n2-0745", w: "追いつく", r: "おいつく", m: "to catch up; to keep up", c: "verb", lv: 1,
    ex: [{ jp: "必死に練習して、ようやくチームのレベルに追いついた。", en: "I trained desperately and finally caught up to the team's level." }],
    qs: [
      { t: "fitb", s: "需要の増加に供給が＿＿＿＿けず、品不足が続いている。", en: "Supply cannot keep up with the increase in demand and the shortage is continuing.", o: ["追いつ", "追いつかれ", "追い越せ", "追いかけ"], a: 0, e: "追いつく(おいつく) = to catch up (close a gap). 追い越す(おいこす) = to overtake/surpass. 追いかける(おいかける) = to chase after. 追いつかれる = to be caught up to." },
      { t: "meaning", s: "「追いつく」の意味は？", o: ["to catch up; to close the gap", "to overtake; to surpass", "to chase after", "to be caught up to"], a: 0, e: "追いつく = closing the distance to someone/something ahead (トップに追いつく = to catch up to the leader). 追いつかない = can't keep up / not enough." }
    ]
  },
  {
    id: "n2-0746", w: "なお", r: "なお", m: "furthermore; in addition; still; moreover", c: "adv", lv: 1,
    ex: [{ jp: "なお、詳細については担当者にお問い合わせください。", en: "Furthermore, please contact the person in charge for details." }],
    qs: [
      { t: "fitb", s: "本日の営業は十八時までとなります。＿＿＿＿、明日は定休日です。", en: "Today's business hours are until 6 p.m. Note that tomorrow is our regular day off.", o: ["なお", "また", "さらに", "ただし"], a: 0, e: "なお = furthermore/note that (adds supplementary information, often in formal notices). また = also/again. さらに = furthermore/even more. ただし = however/provided that (a condition or exception)." },
      { t: "meaning", s: "「なお」の意味は？", o: ["furthermore; note that (supplementary)", "also; again", "furthermore; even more", "however; provided that (exception)"], a: 0, e: "なお is used in written/formal contexts to add supplementary information (なお書き = a note/addendum). Also means 'still' or 'even more so' (なお一層 = all the more)." }
    ]
  },
  {
    id: "n2-0747", w: "ただし", r: "ただし", m: "however; but; provided that; with the exception that", c: "adv", lv: 1,
    ex: [{ jp: "参加は自由です。ただし、事前に登録が必要です。", en: "Participation is free. However, prior registration is required." }],
    qs: [
      { t: "fitb", s: "この割引は会員に限ります。＿＿＿＿、新規会員は対象外です。", en: "This discount is limited to members. However, new members are not eligible.", o: ["ただし", "なお", "ところが", "しかし"], a: 0, e: "ただし = however/but (introduces an exception or condition). なお = furthermore/note. ところが = but/however (unexpected result). しかし = however/but (general contrast)." },
      { t: "meaning", s: "「ただし」の意味は？", o: ["however; provided that (exception/condition)", "furthermore; in addition (note)", "but; however (unexpected result)", "however; but (general contrast)"], a: 0, e: "ただし introduces a limiting condition or exception (ただし書き = a proviso/condition clause). It is more formal/written than しかし." }
    ]
  },
  {
    id: "n2-0748", w: "あえて", r: "あえて", m: "deliberately; dare to; on purpose (against the expected)", c: "adv", lv: 1,
    ex: [{ jp: "皆が賛成する中、あえて反対意見を述べた。", en: "While everyone agreed, I deliberately voiced a dissenting opinion." }],
    qs: [
      { t: "fitb", s: "わかっていても＿＿＿＿難しい道を選ぶのが彼のスタイルだ。", en: "His style is to deliberately choose the difficult path even when he knows it.", o: ["あえて", "わざと", "意図的に", "故意に"], a: 0, e: "あえて = deliberately doing something against the easy/expected choice (challenging, not negative). わざと = on purpose (often with negative nuance, to cause trouble). 意図的に(いとてきに) = intentionally. 故意に(こいに) = with malicious intent." },
      { t: "meaning", s: "「あえて」の意味は？", o: ["deliberately (against expectations, challenging)", "on purpose (negative nuance)", "intentionally", "with malicious intent"], a: 0, e: "あえて implies choosing the harder or less obvious path by intention (あえて言えば = if I dare say, あえてリスクを取る = to deliberately take a risk). No negative nuance." }
    ]
  },
  {
    id: "n2-0749", w: "むしろ", r: "むしろ", m: "rather; on the contrary; if anything", c: "adv", lv: 1,
    ex: [{ jp: "謝るよりもむしろ、行動で示してほしい。", en: "Rather than apologizing, I'd prefer you show it through action." }],
    qs: [
      { t: "fitb", s: "失敗は恥ずかしいことでは無く、＿＿＿＿成長のチャンスだ。", en: "Failure is not something to be ashamed of; rather, it is a chance to grow.", o: ["むしろ", "逆に", "かえって", "いっそ"], a: 0, e: "むしろ = rather/if anything (showing preference or a different frame). 逆に(ぎゃくに) = conversely/on the contrary. かえって = rather/instead (things turned out the opposite way, often unintended). いっそ = rather/better off (making a decisive choice)." },
      { t: "meaning", s: "「むしろ」の意味は？", o: ["rather; if anything (preference/reframe)", "conversely; on the contrary", "rather; instead (unintended opposite)", "rather; better off (decisive choice)"], a: 0, e: "むしろ reframes or corrects a view (むしろ逆だ = it's rather the opposite, むしろ好ましい = if anything preferable). かえって implies an unintended reversal." }
    ]
  },
  {
    id: "n2-0750", w: "かえって", r: "かえって", m: "on the contrary; instead; unexpectedly in the opposite way", c: "adv", lv: 1,
    ex: [{ jp: "薬を飲んだら、かえって具合が悪くなった。", en: "After taking the medicine, I unexpectedly felt worse instead." }],
    qs: [
      { t: "fitb", s: "助けようとしたのに、＿＿＿＿迷惑をかけてしまった。", en: "I tried to help but instead ended up causing trouble.", o: ["かえって", "むしろ", "逆に", "かなり"], a: 0, e: "かえって = instead/contrary to expectations (often an unintended negative outcome). むしろ = rather (preference). 逆に(ぎゃくに) = conversely (deliberate flip). かなり = quite/considerably." },
      { t: "meaning", s: "「かえって」の意味は？", o: ["instead; contrary to expectations", "rather (preference/reframe)", "conversely (deliberate flip)", "quite; considerably"], a: 0, e: "かえって marks an unintended reversal (かえって悪化した = things got worse instead, かえって助かった = it actually helped unexpectedly)." }
    ]
  },
  {
    id: "n2-0751", w: "一方", r: "いっぽう", m: "on the other hand; meanwhile; one side", c: "adv", lv: 1,
    ex: [{ jp: "都市部では人口が増える一方、地方では過疎化が進んでいる。", en: "While the population grows in urban areas, depopulation is advancing in rural areas." }],
    qs: [
      { t: "fitb", s: "売上は増加している。＿＿＿＿、コストも上昇しており、利益は伸び悩んでいる。", en: "Sales are increasing. On the other hand, costs are also rising and profits are not growing.", o: ["一方", "反面", "逆に", "それに対し"], a: 0, e: "一方(いっぽう) = on the other hand / meanwhile (contrasting two things). 反面(はんめん) = on the other hand/flip side (same subject, opposite aspect). 逆に(ぎゃくに) = conversely. それに対して = in contrast." },
      { t: "meaning", s: "「一方」の意味は？", o: ["on the other hand; meanwhile", "on the flip side (same subject)", "conversely", "in contrast to that"], a: 0, e: "一方 juxtaposes two different things or trends (一方で = on the one hand). Also: ～する一方だ = keeps getting more ~(悪化する一方だ = it just keeps getting worse)." }
    ]
  },
  {
    id: "n2-0752", w: "そもそも", r: "そもそも", m: "in the first place; to begin with; originally", c: "adv", lv: 1,
    ex: [{ jp: "そもそもこの計画は実現可能だったのだろうか。", en: "Was this plan even feasible in the first place?" }],
    qs: [
      { t: "fitb", s: "＿＿＿＿、この問題はなぜ起きたのかを考える必要がある。", en: "To begin with, we need to think about why this problem occurred.", o: ["そもそも", "もともと", "はじめから", "本来"], a: 0, e: "そもそも = in the first place / when you go back to the root (questioning the premise). もともと = originally/by nature. はじめから = from the start. 本来(ほんらい) = originally/by rights." },
      { t: "meaning", s: "「そもそも」の意味は？", o: ["in the first place; at the root", "originally; by nature", "from the start; from the beginning", "originally; by rights; ideally"], a: 0, e: "そもそも challenges the premise (そもそも無理だった = it was impossible from the start). It digs back to the fundamental origin or question." }
    ]
  },
  {
    id: "n2-0753", w: "余程", r: "よほど", m: "considerably; very much; greatly; must really", c: "adv", lv: 1,
    ex: [{ jp: "彼はよほど疲れていたらしく、すぐに眠ってしまった。", en: "He must have been very tired, as he fell asleep right away." }],
    qs: [
      { t: "fitb", s: "あの人が怒るなんて、＿＿＿＿のことがあったのだろう。", en: "For that person to get angry, something must have really happened.", o: ["よほど", "かなり", "相当", "よっぽど"], a: 0, e: "よほど = considerably/must really (implies an exceptional degree). かなり = quite/considerably. 相当(そうとう) = considerably/quite (more formal). よっぽど = casual spoken variant of よほど." },
      { t: "meaning", s: "「余程」の意味は？", o: ["considerably; must really (exceptional degree)", "quite; considerably", "considerably (formal)", "considerably (casual spoken)"], a: 0, e: "よほど marks an unusually large degree (よほど嬉しかったのだろう = must have been very happy, よほどでなければ = unless it's really serious)." }
    ]
  },
  {
    id: "n2-0754", w: "景気", r: "けいき", m: "economic conditions; business climate; boom or bust", c: "noun", lv: 1,
    ex: [{ jp: "景気が回復してきたことで、雇用も改善されつつある。", en: "As economic conditions have recovered, employment is also starting to improve." }],
    qs: [
      { t: "fitb", s: "不況で＿＿＿＿が悪化し、多くの中小企業が廃業を余儀なくされた。", en: "With the recession the business climate worsened and many small and medium enterprises were forced to close.", o: ["景気", "経済", "業績", "市況"], a: 0, e: "景気(けいき) = economic conditions/business climate (景気がいい = the economy is good). 経済(けいざい) = economy (broader). 業績(ぎょうせき) = business results/performance. 市況(しきょう) = market conditions." },
      { t: "meaning", s: "「景気」の意味は？", o: ["economic conditions; business climate", "economy (broad)", "business results; performance", "market conditions"], a: 0, e: "景気 is the general health of the economy as felt in daily life (景気回復 = economic recovery, 景気刺激策 = economic stimulus, 景気がいい = doing well financially)." }
    ]
  },
  {
    id: "n2-0755", w: "事情", r: "じじょう", m: "circumstances; situation; reasons", c: "noun", lv: 1,
    ex: [{ jp: "諸事情により、イベントを中止することになりました。", en: "Due to various circumstances, the event has been cancelled." }],
    qs: [
      { t: "fitb", s: "彼が欠席した＿＿＿＿については、後日説明があるだろう。", en: "There will probably be an explanation later regarding the circumstances of his absence.", o: ["事情", "理由", "原因", "背景"], a: 0, e: "事情(じじょう) = circumstances/reasons (often personal or complex). 理由(りゆう) = a stated reason. 原因(げんいん) = a cause. 背景(はいけい) = background/context." },
      { t: "meaning", s: "「事情」の意味は？", o: ["circumstances; reasons (complex/personal)", "stated reason", "cause", "background; context"], a: 0, e: "事情 implies there's more going on beneath the surface (事情がある = there are circumstances/reasons, 家庭の事情 = family circumstances, 事情を知る = to know the details)." }
    ]
  },
  {
    id: "n2-0756", w: "傷", r: "きず", m: "wound; injury; scratch; scar", c: "noun", lv: 1,
    ex: [{ jp: "転んで膝に傷を作ったが、大したことはなかった。", en: "I fell and got a wound on my knee, but it was nothing serious." }],
    qs: [
      { t: "fitb", s: "彼女の言葉は深い心の＿＿＿＿を残した。", en: "Her words left a deep wound in my heart.", o: ["傷", "傷跡", "ダメージ", "打撃"], a: 0, e: "傷(きず) = a wound/scratch/scar (physical or emotional). 傷跡(きずあと) = a scar (the mark left after healing). ダメージ = damage (loanword). 打撃(だげき) = a blow/blow to something." },
      { t: "meaning", s: "「傷」の意味は？", o: ["wound; injury; scratch (physical/emotional)", "scar (left after healing)", "damage (loanword)", "blow; heavy impact"], a: 0, e: "傷 = a wound or blemish (傷つける = to hurt/wound, 傷がつく = to get scratched, 心の傷 = emotional wound/trauma)." }
    ]
  },
  {
    id: "n2-0757", w: "手法", r: "てほう", m: "technique; method; approach", c: "noun", lv: 1,
    ex: [{ jp: "この作家は独特の手法で知られており、作品はすぐに見分けられる。", en: "This author is known for their unique technique and their works are immediately recognizable." }],
    qs: [
      { t: "fitb", s: "問題解決のための新しい＿＿＿＿を開発した。", en: "We developed a new technique for problem solving.", o: ["手法", "方法", "手順", "技法"], a: 0, e: "手法(てほう) = a technique or stylistic approach (artistic, intellectual). 方法(ほうほう) = method (general). 手順(てじゅん) = procedure/steps. 技法(ぎほう) = technical method (craftsmanship)." },
      { t: "meaning", s: "「手法」の意味は？", o: ["technique; approach (artistic/intellectual)", "method (general)", "procedure; steps", "technical method (craft)"], a: 0, e: "手法 implies a characteristic or sophisticated way of doing something (演出手法 = directorial technique, 手法を変える = to change one's approach)." }
    ]
  },
  {
    id: "n2-0758", w: "内容", r: "ないよう", m: "content; substance; details", c: "noun", lv: 1,
    ex: [{ jp: "メールの内容を確認してから、返信することにした。", en: "I decided to check the content of the email before replying." }],
    qs: [
      { t: "fitb", s: "この本は表紙は地味だが、＿＿＿＿は非常に充実している。", en: "The cover of this book is plain, but the content is very rich.", o: ["内容", "中身", "概要", "詳細"], a: 0, e: "内容(ないよう) = content/substance (what is inside: 授業内容 = lesson content). 中身(なかみ) = what's inside (more physical/tangible). 概要(がいよう) = overview/summary. 詳細(しょうさい) = details." },
      { t: "meaning", s: "「内容」の意味は？", o: ["content; substance; what's inside", "the physical contents; what's inside", "overview; summary", "details; specifics"], a: 0, e: "内容 is what something consists of or contains (内容を把握する = to grasp the content, 内容が濃い = content-rich)." }
    ]
  },
  {
    id: "n2-0759", w: "根本", r: "こんぽん", m: "root; fundamentals; basis; the essential point", c: "noun", lv: 1,
    ex: [{ jp: "問題の根本を解決しなければ、同じことが繰り返される。", en: "Unless we solve the root of the problem, the same thing will keep repeating." }],
    qs: [
      { t: "fitb", s: "この事件は社会の＿＿＿＿にある不平等を示している。", en: "This incident reveals the inequality at the root of society.", o: ["根本", "根底", "根拠", "根源"], a: 0, e: "根本(こんぽん) = root/fundamentals (根本的な問題 = a fundamental problem). 根底(こんてい) = the underlying base (根底から覆す = to overturn from the ground up). 根拠(こんきょ) = basis/grounds. 根源(こんげん) = the original source/root cause." },
      { t: "meaning", s: "「根本」の意味は？", o: ["root; fundamentals; the essential point", "underlying base; foundation", "basis; grounds", "original source; root cause"], a: 0, e: "根本 = the deepest level (根本的に = fundamentally, 根本から変える = to change from the ground up). 根底 emphasizes what everything rests on." }
    ]
  },
  {
    id: "n2-0760", w: "体験", r: "たいけん", m: "experience; personal experience", c: "noun", lv: 1,
    ex: [{ jp: "実際に現地を訪れて体験することが、理解を深める近道だ。", en: "Actually visiting and experiencing the place first-hand is a shortcut to deepening understanding." }],
    qs: [
      { t: "fitb", s: "その授業では、歴史的な建築物を実際に見学する＿＿＿＿学習が取り入れられている。", en: "In that class, experiential learning where you actually visit historical buildings has been incorporated.", o: ["体験", "経験", "実体験", "見学"], a: 0, e: "体験(たいけん) = personal hands-on experience. 経験(けいけん) = experience (accumulated over time). 実体験(じったいけん) = actual first-hand experience. 見学(けんがく) = a field trip/observation visit." },
      { t: "meaning", s: "「体験」の意味は？", o: ["personal hands-on experience", "accumulated experience (over time)", "actual first-hand experience", "field trip; observation visit"], a: 0, e: "体験 is direct, sensory experience (体験談 = personal account, 体験学習 = experiential learning, 初体験 = first-time experience). 経験 is broader, including things you've done over time." }
    ]
  },
  {
    id: "n2-0761", w: "仕方", r: "しかた", m: "way; method; means; no help for it", c: "noun", lv: 1,
    ex: [{ jp: "やり方がわからないときは、遠慮なく聞いてください。", en: "If you don't know the way to do it, please don't hesitate to ask." }],
    qs: [
      { t: "fitb", s: "もう決まったことだ。＿＿＿＿がない。", en: "It's already decided. There's no help for it.", o: ["仕方", "方法", "やり方", "手段"], a: 0, e: "仕方(しかた) = way/method (仕方がない = can't be helped, it's hopeless). 方法(ほうほう) = method (neutral). やり方(やりかた) = how to do something (practical). 手段(しゅだん) = means/instrument." },
      { t: "meaning", s: "「仕方」の意味は？", o: ["way; method; no help for it", "method (neutral)", "how to do it (practical)", "means; instrument"], a: 0, e: "仕方 = the way something is done (仕方がない = can't be helped/nothing to be done about it, 仕方なく = reluctantly, 仕方を教える = to show how to do something)." }
    ]
  },
  {
    id: "n2-0762", w: "全体", r: "ぜんたい", m: "the whole; entirety; overall", c: "noun", lv: 1,
    ex: [{ jp: "細部にこだわるあまり、全体のバランスを見失わないようにしよう。", en: "While paying attention to details, let's not lose sight of the overall balance." }],
    qs: [
      { t: "fitb", s: "一部の問題だけでなく、プロジェクト＿＿＿＿を見渡す視点が必要だ。", en: "A perspective that surveys not just part of the problem but the entire project is needed.", o: ["全体", "全般", "全域", "全部"], a: 0, e: "全体(ぜんたい) = the whole/entirety (as a unit). 全般(ぜんぱん) = overall/in general (across the board). 全域(ぜんいき) = the entire area/region. 全部(ぜんぶ) = all of it / everything." },
      { t: "meaning", s: "「全体」の意味は？", o: ["the whole; entirety (as a unit)", "overall; in general (across the board)", "the entire area/region", "all of it; everything"], a: 0, e: "全体 = the thing as a whole (全体像 = the overall picture, 全体的に = overall/as a whole). 全般 = broadly across all aspects (全般的に問題がある = problems across the board)." }
    ]
  },
  {
    id: "n2-0763", w: "一部", r: "いちぶ", m: "part; portion; some; a copy (of a document)", c: "noun", lv: 1,
    ex: [{ jp: "計画の一部を変更することになった。", en: "It was decided to change part of the plan." }],
    qs: [
      { t: "fitb", s: "この情報はまだ＿＿＿＿の関係者にしか公開されていない。", en: "This information has only been disclosed to some of the relevant parties.", o: ["一部", "一部分", "ごく一部", "少数"], a: 0, e: "一部(いちぶ) = a part/some (一部の人 = some people, 一部変更 = a partial change). 一部分(いちぶぶん) = a part/portion (emphasizing it's a fraction). ごく一部 = only a very small portion. 少数(しょうすう) = a minority/small number." },
      { t: "meaning", s: "「一部」の意味は？", o: ["part; portion; some", "a portion (fraction emphasized)", "only a very small portion", "a minority; small number"], a: 0, e: "一部 = a part of the whole (一部始終 = the whole story, 一部を除いて = except for a part). As a counter: 書類一部 = one copy of the document." }
    ]
  },
  {
    id: "n2-0764", w: "目安", r: "めやす", m: "rough guide; benchmark; rough standard", c: "noun", lv: 1,
    ex: [{ jp: "一日の勉強時間の目安は二時間程度だ。", en: "The rough guide for daily study time is about two hours." }],
    qs: [
      { t: "fitb", s: "完成まで一週間が＿＿＿＿ですが、内容次第で変わる場合があります。", en: "One week is a rough guide to completion, but it may vary depending on the content.", o: ["目安", "目処", "目標", "基準"], a: 0, e: "目安(めやす) = a rough guide/yardstick (approximate). 目処(めど) = a rough timing target. 目標(もくひょう) = a concrete goal. 基準(きじゅん) = a standard/criterion (more official)." },
      { t: "meaning", s: "「目安」の意味は？", o: ["rough guide; yardstick (approximate)", "rough timing target", "concrete goal; target", "standard; criterion (official)"], a: 0, e: "目安 = a rough benchmark to go by (費用の目安 = a rough cost estimate, 目安にする = to use as a rough guide). Less rigid than 基準." }
    ]
  },
  {
    id: "n2-0765", w: "手がける", r: "てがける", m: "to work on; to be involved in; to handle", c: "verb", lv: 1,
    ex: [{ jp: "この建築家は世界中で多くの有名な建物を手がけている。", en: "This architect has worked on many famous buildings around the world." }],
    qs: [
      { t: "fitb", s: "若手ながら、すでに多くの大型プロジェクトを＿＿＿＿いる実力派だ。", en: "Despite being young, he is already a talented professional who has handled many large projects.", o: ["手がけて", "担当して", "手掛けて", "手がけた"], a: 0, e: "手がける(てがける) = to be personally involved in/work on (with skill). 担当する(たんとうする) = to be in charge of (assigned). 手を染める(てをそめる) = to get involved in (often with negative nuance)." },
      { t: "meaning", s: "「手がける」の意味は？", o: ["to work on; to be personally involved in", "to be in charge of (assigned)", "to specialize in", "to get involved in (negative nuance)"], a: 0, e: "手がける implies personal craft or expertise (作品を手がける = to work on a piece, 初めて手がける仕事 = a job handled for the first time). 手掛け is an alternate spelling." }
    ]
  },
  {
    id: "n2-0766", w: "もたらす", r: "もたらす", m: "to bring; to cause; to produce; to bring about", c: "verb", lv: 1,
    ex: [{ jp: "新しい技術は私たちの生活に大きな変化をもたらした。", en: "New technology has brought great changes to our lives." }],
    qs: [
      { t: "fitb", s: "この政策は経済に好影響を＿＿＿＿と期待されている。", en: "This policy is expected to bring positive effects to the economy.", o: ["もたらす", "与える", "生む", "引き起こす"], a: 0, e: "もたらす = to bring about (results, changes — can be positive or negative). 与える(あたえる) = to give/have (an effect). 生む(うむ) = to produce/generate. 引き起こす(ひきおこす) = to trigger (usually negative)." },
      { t: "meaning", s: "「もたらす」の意味は？", o: ["to bring about; to produce (positive or negative)", "to give; to have (an effect)", "to produce; to generate", "to trigger; to cause (usually negative)"], a: 0, e: "もたらす = being the cause that brings a result (利益をもたらす = to bring profits, 被害をもたらす = to cause damage). Neutral about whether the result is good or bad." }
    ]
  },
  {
    id: "n2-0767", w: "手放す", r: "てばなす", m: "to let go of; to give up; to sell; to release", c: "verb", lv: 1,
    ex: [{ jp: "長年大切にしてきた本を手放すのは寂しかった。", en: "It was sad to let go of books I had cherished for many years." }],
    qs: [
      { t: "fitb", s: "このビジネスチャンスを＿＿＿＿のは惜しい。", en: "It would be a shame to let go of this business opportunity.", o: ["手放す", "手離す", "逃す", "捨てる"], a: 0, e: "手放す(てばなす) = to release from your hands / give up (a possession, opportunity). 手離す = variant writing. 逃す(のがす) = to miss/let slip (a chance). 捨てる(すてる) = to throw away/discard." },
      { t: "meaning", s: "「手放す」の意味は？", o: ["to let go of; to give up; to sell", "to miss; to let slip (a chance)", "to throw away; to discard", "to release; to set free"], a: 0, e: "手放す = releasing something you were holding (手放せない = can't let go of, 手放しで喜ぶ = to rejoice unreservedly/without reservation)." }
    ]
  },
  {
    id: "n2-0768", w: "踏み出す", r: "ふみだす", m: "to step forward; to take a first step; to venture", c: "verb", lv: 1,
    ex: [{ jp: "失敗を恐れずに新しい世界へ踏み出すことが大切だ。", en: "It is important to step out into a new world without fearing failure." }],
    qs: [
      { t: "fitb", s: "夢に向かって最初の一歩を＿＿＿＿勇気が必要だ。", en: "Courage is needed to take the first step toward your dream.", o: ["踏み出す", "踏み切る", "踏み込む", "歩み出す"], a: 0, e: "踏み出す(ふみだす) = to take a step forward (first steps). 踏み切る(ふみきる) = to take the plunge (decisive action after hesitation). 踏み込む(ふみこむ) = to step into/delve into. 歩み出す(あゆみだす) = to begin to walk forward (literary)." },
      { t: "meaning", s: "「踏み出す」の意味は？", o: ["to step forward; to take a first step", "to take the plunge (after hesitation)", "to step into; to delve into", "to begin to walk forward (literary)"], a: 0, e: "踏み出す = taking a first, forward step (新しい一歩を踏み出す = to take a new step forward, 社会に踏み出す = to step out into society)." }
    ]
  },
  {
    id: "n2-0769", w: "読み取る", r: "よみとる", m: "to read; to interpret; to grasp (from context)", c: "verb", lv: 1,
    ex: [{ jp: "グラフからデータの傾向を読み取ることができる。", en: "You can read the trend of the data from the graph." }],
    qs: [
      { t: "fitb", s: "相手の表情から気持ちを＿＿＿＿ことは、コミュニケーションの基本だ。", en: "Reading the other person's feelings from their expression is a basic of communication.", o: ["読み取る", "読み解く", "察する", "感じ取る"], a: 0, e: "読み取る(よみとる) = to read/interpret (information, expression, graphs). 読み解く(よみとく) = to decipher/decode (complex text). 察する(さっする) = to infer/sense (feelings, intentions). 感じ取る(かんじとる) = to sense/feel (emotionally)." },
      { t: "meaning", s: "「読み取る」の意味は？", o: ["to read; to interpret; to extract information", "to decipher; to decode (complex text)", "to infer; to sense (feelings)", "to sense; to feel (emotionally)"], a: 0, e: "読み取る = extracting meaning from something visual or written (データを読み取る = to read data, 空気を読み取る = to read the atmosphere)." }
    ]
  },
  {
    id: "n2-0770", w: "割合", r: "わりあい", m: "proportion; ratio; percentage; relatively", c: "noun", lv: 1,
    ex: [{ jp: "全体の約三割の割合で女性が管理職についている。", en: "About 30% of the total proportion are women in management positions." }],
    qs: [
      { t: "fitb", s: "参加者のうち、外国人が占める＿＿＿＿が年々増えている。", en: "The proportion of foreigners among participants is increasing year by year.", o: ["割合", "比率", "パーセンテージ", "比例"], a: 0, e: "割合(わりあい) = proportion/ratio (general everyday term). 比率(ひりつ) = ratio/rate (more mathematical). パーセンテージ = percentage (loanword). 比例(ひれい) = proportion/proportionality (mathematical relation)." },
      { t: "meaning", s: "「割合」の意味は？", o: ["proportion; ratio (everyday)", "ratio; rate (mathematical)", "percentage (loanword)", "proportion; proportionality (math)"], a: 0, e: "割合 = share or ratio (割合が高い = high proportion, 割合に = relatively/comparatively). As an adverb: 割合うまくいった = it went relatively well." }
    ]
  },
  {
    id: "n2-0771", w: "損なう", r: "そこなう", m: "to damage; to harm; to impair; to spoil", c: "verb", lv: 1,
    ex: [{ jp: "無理な運動は健康を損なうおそれがある。", en: "Overexercising may harm your health." }],
    qs: [
      { t: "fitb", s: "不適切な発言が会社のイメージを＿＿＿＿た。", en: "The inappropriate comment damaged the company's image.", o: ["損なっ", "傷つけ", "悪化させ", "壊し"], a: 0, e: "損なう(そこなう) = to damage/impair (health, image, trust). 傷つける(きずつける) = to hurt/wound (physically or emotionally). 悪化させる(あっかさせる) = to make worse. 壊す(こわす) = to break/destroy." },
      { t: "meaning", s: "「損なう」の意味は？", o: ["to damage; to impair; to harm", "to hurt; to wound (physical/emotional)", "to make worse; to worsen", "to break; to destroy"], a: 0, e: "損なう = reducing the quality or integrity of something (健康を損なう = to damage health, 信頼を損なう = to undermine trust). Also: やり損なう = to fail in doing something." }
    ]
  },
  {
    id: "n2-0772", w: "見習う", r: "みならう", m: "to follow someone's example; to learn from; to emulate", c: "verb", lv: 1,
    ex: [{ jp: "先輩の誠実な仕事ぶりを見習いたいと思っている。", en: "I want to follow my senior's example of sincere work." }],
    qs: [
      { t: "fitb", s: "諸外国の成功事例を＿＿＿＿、新しい政策を立案すべきだ。", en: "We should draw up new policies by learning from the successful examples of other countries.", o: ["見習い", "参考にし", "模倣し", "真似し"], a: 0, e: "見習う(みならう) = to follow someone's example/emulate. 参考にする(さんこうにする) = to use as a reference. 模倣する(もほうする) = to imitate. 真似する(まねする) = to copy/mimic." },
      { t: "meaning", s: "「見習う」の意味は？", o: ["to follow one's example; to emulate", "to use as a reference", "to imitate; to copy", "to mimic"], a: 0, e: "見習う = taking someone as a model to learn from (先輩を見習う = to follow one's senior's example). 見習い = an apprentice/trainee (noun)." }
    ]
  },
  {
    id: "n2-0773", w: "当然", r: "とうぜん", m: "natural; obvious; of course; rightfully", c: "naadj", lv: 1,
    ex: [{ jp: "努力した分だけ結果が出るのは当然のことだ。", en: "It is only natural that you get results proportional to your effort." }],
    qs: [
      { t: "fitb", s: "ルールを破れば罰せられるのは＿＿＿＿だ。", en: "It is only natural to be punished for breaking the rules.", o: ["当然", "当たり前", "必然", "必ず"], a: 0, e: "当然(とうぜん) = natural/rightfully so (formal). 当たり前(あたりまえ) = obvious/natural (casual everyday). 必然(ひつぜん) = inevitable (logical necessity). 必ず(かならず) = without fail (adverb)." },
      { t: "meaning", s: "「当然」の意味は？", o: ["natural; rightfully so (formal)", "obvious; natural (casual)", "inevitable (logical necessity)", "without fail (adverb)"], a: 0, e: "当然 is the formal equivalent of 当たり前 (当然の結果 = a natural result, 当然ながら = naturally/as is to be expected, 当然の権利 = a rightful entitlement)." }
    ]
  },
  {
    id: "n2-0774", w: "見込む", r: "みこむ", m: "to expect; to anticipate; to count on", c: "verb", lv: 1,
    ex: [{ jp: "来年の売上は今年より二割増しを見込んでいる。", en: "We are anticipating a 20% increase in next year's sales compared to this year." }],
    qs: [
      { t: "fitb", s: "コスト削減効果を三千万円と＿＿＿＿でいるが、実際はどうだろうか。", en: "We are counting on a cost reduction effect of 30 million yen, but how will it actually turn out?", o: ["見込ん", "予測し", "期待し", "目標にし"], a: 0, e: "見込む(みこむ) = to anticipate/project (a figure or outcome). 予測する(よそくする) = to predict/forecast. 期待する(きたいする) = to expect/hope for. 目標にする = to set as a goal." },
      { t: "meaning", s: "「見込む」の意味は？", o: ["to anticipate; to project (a figure)", "to predict; to forecast", "to expect; to hope for", "to set as a goal"], a: 0, e: "見込む = judging that something will amount to X (黒字を見込む = to anticipate a surplus, 見込み客 = a prospective customer). The noun 見込み = expectation/likelihood." }
    ]
  },
  {
    id: "n2-0775", w: "度合い", r: "どあい", m: "degree; extent; level", c: "noun", lv: 1,
    ex: [{ jp: "ストレスの度合いによって、対処法も変わる。", en: "The appropriate coping method also changes depending on the degree of stress." }],
    qs: [
      { t: "fitb", s: "満足の＿＿＿＿を調べるため、アンケートを実施した。", en: "We conducted a survey to investigate the degree of satisfaction.", o: ["度合い", "程度", "レベル", "尺度"], a: 0, e: "度合い(どあい) = degree/extent (of a quality/feeling). 程度(ていど) = degree/level (more general). レベル = level (loanword). 尺度(しゃくど) = a scale/measure (for measuring something)." },
      { t: "meaning", s: "「度合い」の意味は？", o: ["degree; extent (of a quality)", "degree; level (general)", "level (loanword)", "scale; measure (for measuring)"], a: 0, e: "度合い = how much or how intense something is (依存の度合い = the degree of dependence, 熟成の度合い = the level of maturity)." }
    ]
  },
  {
    id: "n2-0776", w: "引き付ける", r: "ひきつける", m: "to attract; to draw in; to fascinate", c: "verb", lv: 1,
    ex: [{ jp: "彼女の演技は観客の心を引き付けた。", en: "Her performance captivated the hearts of the audience." }],
    qs: [
      { t: "fitb", s: "その映画の予告編は多くの人の関心を強く＿＿＿＿た。", en: "The trailer for that film strongly attracted the interest of many people.", o: ["引き付け", "惹きつけ", "魅了し", "引き寄せ"], a: 0, e: "引き付ける(ひきつける) = to attract/draw in (attention, people). 惹きつける(ひきつける) = variant kanji, same meaning. 魅了する(みりょうする) = to fascinate/enchant. 引き寄せる(ひきよせる) = to draw closer/pull toward." },
      { t: "meaning", s: "「引き付ける」の意味は？", o: ["to attract; to draw in (attention)", "to fascinate; to enchant", "to draw closer; to pull toward", "to repel; to push away"], a: 0, e: "引き付ける = drawing something toward you magnetically (人を引き付ける魅力 = appeal that attracts people, 注意を引き付ける = to attract attention)." }
    ]
  },
  {
    id: "n2-0777", w: "差し迫る", r: "さしせまる", m: "to be imminent; to be pressing; to be urgent", c: "verb", lv: 1,
    ex: [{ jp: "締め切りが差し迫っているのに、まだ半分も終わっていない。", en: "The deadline is imminent, yet I haven't even finished half." }],
    qs: [
      { t: "fitb", s: "試験まで時間が＿＿＿＿中、焦らず着実に勉強することが大切だ。", en: "With the exam pressing close, it is important to study calmly and steadily.", o: ["差し迫った", "迫った", "近づいた", "切迫した"], a: 0, e: "差し迫る(さしせまる) = to be imminent/pressing (deadline, crisis). 迫る(せまる) = to draw near / press. 近づく(ちかづく) = to approach/get closer. 切迫する(せっぱくする) = to be urgent/critical (more formal)." },
      { t: "meaning", s: "「差し迫る」の意味は？", o: ["to be imminent; to be pressing", "to draw near; to press", "to approach; to get closer", "to be urgent; critical (formal)"], a: 0, e: "差し迫る = being right on the doorstep (差し迫った問題 = an urgent problem, 差し迫った状況 = a pressing situation, 締め切りが差し迫る = the deadline is imminent)." }
    ]
  },
  {
    id: "n2-0778", w: "申し訳", r: "もうしわけ", m: "apology; excuse; justification", c: "noun", lv: 1,
    ex: [{ jp: "ご迷惑をおかけして、本当に申し訳ありません。", en: "I am truly sorry for the inconvenience caused." }],
    qs: [
      { t: "fitb", s: "今回の件については＿＿＿＿ない気持ちでいっぱいです。", en: "I am filled with nothing but apology regarding this matter.", o: ["申し訳", "言い訳", "釈明", "弁解"], a: 0, e: "申し訳(もうしわけ) = apology / excuse (申し訳ない = inexcusable / I'm so sorry). 言い訳(いいわけ) = an excuse (often dismissive). 釈明(しゃくめい) = a public clarification. 弁解(べんかい) = a defense/justification." },
      { t: "meaning", s: "「申し訳」の意味は？", o: ["apology; excuse (申し訳ない = very sorry)", "excuse (often dismissive)", "public clarification", "defense; justification"], a: 0, e: "申し訳ない = there is no excuse / I am deeply sorry (the most common polite apology in Japanese). 申し訳 alone appears in phrases like 申し訳程度 = just for form's sake." }
    ]
  },
  {
    id: "n2-0779", w: "見合わせる", r: "みあわせる", m: "to postpone; to hold off; to suspend", c: "verb", lv: 1,
    ex: [{ jp: "悪天候のため、イベントの開催を見合わせることになった。", en: "Due to bad weather, it was decided to suspend holding the event." }],
    qs: [
      { t: "fitb", s: "リスクが高いため、今回の投資は＿＿＿＿ることにした。", en: "Due to the high risk, we decided to hold off on the investment this time.", o: ["見合わせ", "見送り", "延期し", "中止し"], a: 0, e: "見合わせる(みあわせる) = to hold off / suspend temporarily (waiting for better conditions). 見送る(みおくる) = to pass on / defer (a plan). 延期する(えんきする) = to postpone (to a later date). 中止する(ちゅうしする) = to cancel." },
      { t: "meaning", s: "「見合わせる」の意味は？", o: ["to suspend; to hold off temporarily", "to pass on; to defer (a plan)", "to postpone (to a later date)", "to cancel"], a: 0, e: "見合わせる = temporarily holding back to reassess (運行を見合わせる = to suspend service, 購入を見合わせる = to hold off buying)." }
    ]
  },
  {
    id: "n2-0780", w: "食い違う", r: "くいちがう", m: "to conflict; to disagree; to be at odds", c: "verb", lv: 1,
    ex: [{ jp: "双方の証言が食い違い、真相の解明に時間がかかった。", en: "The testimonies of both parties conflicted, and it took time to clarify the truth." }],
    qs: [
      { t: "fitb", s: "二人の意見が大きく＿＿＿＿っており、話し合いが難航している。", en: "The two people's opinions are greatly at odds and the discussion is making difficult progress.", o: ["食い違", "相違し", "対立し", "ぶつか"], a: 0, e: "食い違う(くいちがう) = to be at odds / conflict (facts, testimonies, opinions). 相違する(そういする) = to differ (formal). 対立する(たいりつする) = to oppose / be in conflict. ぶつかる = to clash / collide." },
      { t: "meaning", s: "「食い違う」の意味は？", o: ["to conflict; to be at odds", "to differ (formal)", "to oppose; be in opposition", "to clash; to collide"], a: 0, e: "食い違う = two things that should match but don't (話が食い違う = the stories don't match, 利害が食い違う = interests conflict)." }
    ]
  },
  {
    id: "n2-0781", w: "払い込む", r: "はらいこむ", m: "to pay in; to deposit; to remit", c: "verb", lv: 1,
    ex: [{ jp: "受講料は来月末までに指定口座に払い込んでください。", en: "Please remit the course fee to the designated account by the end of next month." }],
    qs: [
      { t: "fitb", s: "保険料を毎月自動で＿＿＿＿む設定にしている。", en: "I have it set up to automatically pay in the insurance premium every month.", o: ["払い込", "振り込", "支払", "納め"], a: 0, e: "払い込む(はらいこむ) = to pay into / remit (to an account or fund). 振り込む(ふりこむ) = to transfer money (bank transfer). 支払う(しはらう) = to pay (general). 納める(おさめる) = to pay/submit (taxes, fees officially)." },
      { t: "meaning", s: "「払い込む」の意味は？", o: ["to pay in; to remit (to an account)", "to transfer money (bank)", "to pay (general)", "to pay; to submit (officially)"], a: 0, e: "払い込む = putting money into a designated place (資本金を払い込む = to pay in capital, 保険料の払い込み = premium payment)." }
    ]
  },
  {
    id: "n2-0782", w: "浮かび上がる", r: "うかびあがる", m: "to surface; to come to light; to emerge", c: "verb", lv: 1,
    ex: [{ jp: "調査を進めるうちに、新たな問題が浮かび上がってきた。", en: "As the investigation progressed, new problems came to light." }],
    qs: [
      { t: "fitb", s: "データを分析したところ、興味深い傾向が＿＿＿＿った。", en: "When the data was analyzed, an interesting trend emerged.", o: ["浮かび上が", "明らかにな", "見えてき", "判明し"], a: 0, e: "浮かび上がる(うかびあがる) = to surface / come to light (naturally). 明らかになる(あきらかになる) = to become clear. 見えてくる(みえてくる) = to start to become visible. 判明する(はんめいする) = to become known / be established." },
      { t: "meaning", s: "「浮かび上がる」の意味は？", o: ["to surface; to come to light", "to become clear; to be revealed", "to start to become visible", "to be established; to become known"], a: 0, e: "浮かび上がる = rising up to the surface from below (問題が浮かび上がる = a problem surfaces, 姿が浮かび上がる = a figure emerges)." }
    ]
  },
  {
    id: "n2-0783", w: "押し付ける", r: "おしつける", m: "to impose; to force on; to push onto", c: "verb", lv: 1,
    ex: [{ jp: "自分の価値観を他人に押し付けるのは良くない。", en: "It is not good to impose your own values on others." }],
    qs: [
      { t: "fitb", s: "責任を部下に＿＿＿＿上司は信頼されない。", en: "A boss who pushes responsibility onto subordinates will not be trusted.", o: ["押し付ける", "押しつける", "なすりつける", "転嫁する"], a: 0, e: "押し付ける(おしつける) = to force/impose on someone (a view, task). なすりつける = to pin on / shift blame onto. 転嫁する(てんかする) = to shift (blame, costs) onto someone else (formal)." },
      { t: "meaning", s: "「押し付ける」の意味は？", o: ["to impose; to force on someone", "to pin blame on", "to shift blame/cost onto (formal)", "to push physically"], a: 0, e: "押し付ける = unilaterally forcing something on someone (意見を押し付ける = to impose an opinion, 仕事を押し付ける = to dump work on someone)." }
    ]
  },
  {
    id: "n2-0784", w: "見極め", r: "みきわめ", m: "discernment; accurate judgment; determining", c: "noun", lv: 1,
    ex: [{ jp: "状況の見極めが早い人は、どんな環境でも活躍できる。", en: "A person who can quickly size up a situation can be active in any environment." }],
    qs: [
      { t: "fitb", s: "投資において、タイミングの＿＿＿＿が成否を分ける。", en: "In investing, the accuracy of judging timing determines success or failure.", o: ["見極め", "見通し", "判断", "目利き"], a: 0, e: "見極め(みきわめ) = decisive assessment / discernment (the act of judging accurately). 見通し(みとおし) = outlook. 判断(はんだん) = judgment. 目利き(めきき) = an expert eye / connoisseurship." },
      { t: "meaning", s: "「見極め」の意味は？", o: ["discernment; accurate final judgment", "outlook; forecast", "judgment; assessment", "expert eye; connoisseurship"], a: 0, e: "見極め = the act of definitively sizing something up (見極めが肝心 = discernment is key, 見極める力 = the ability to judge accurately)." }
    ]
  },
  {
    id: "n2-0785", w: "踏まえた上で", r: "ふまえたうえで", m: "based on; taking into account; building on", c: "adv", lv: 1,
    ex: [{ jp: "現状を踏まえた上で、最善策を考えよう。", en: "Let's think of the best measure, building on an understanding of the current situation." }],
    qs: [
      { t: "fitb", s: "議論の結果を＿＿＿＿、最終決定を下した。", en: "Based on the results of the discussion, we made a final decision.", o: ["踏まえた上で", "踏まえて", "基づいて", "考慮して"], a: 0, e: "踏まえた上で = building on / after duly considering (strong nuance of standing on that foundation before acting). 踏まえて = based on (same but slightly lighter). 基づいて(もとづいて) = based on (formal). 考慮して(こうりょして) = taking into consideration." },
      { t: "meaning", s: "「踏まえた上で」の意味は？", o: ["based on; building on (strong foundation)", "based on (slightly lighter)", "based on (formal)", "taking into consideration"], a: 0, e: "踏まえた上で implies thoroughly digesting something before acting (事実を踏まえた上で判断する = to judge after fully taking the facts on board)." }
    ]
  },
  {
    id: "n2-0786", w: "差し置く", r: "さしおく", m: "to set aside; to leave out; to disregard", c: "verb", lv: 1,
    ex: [{ jp: "他のことは差し置いて、まずこの問題を解決すべきだ。", en: "Setting other things aside, we should first resolve this problem." }],
    qs: [
      { t: "fitb", s: "経験豊富な先輩を＿＿＿＿いて新入りが昇進するのは異例だ。", en: "It is exceptional for a newcomer to be promoted while setting aside experienced seniors.", o: ["差し置", "無視し", "差し引", "後回しにし"], a: 0, e: "差し置く(さしおく) = to set aside / bypass (someone/something deserving attention). 無視する(むしする) = to ignore. 差し引く(さしひく) = to deduct. 後回しにする = to put off." },
      { t: "meaning", s: "「差し置く」の意味は？", o: ["to set aside; to bypass; to disregard", "to ignore; to disregard", "to deduct; to subtract", "to put off; to leave for later"], a: 0, e: "差し置く = deliberately bypassing someone or something (彼を差し置いて = passing over him, 仕事を差し置いて = setting work aside)." }
    ]
  },
  {
    id: "n2-0787", w: "当惑", r: "とうわく", m: "bewilderment; perplexity; embarrassment", c: "noun", lv: 1,
    ex: [{ jp: "突然の質問に当惑して、うまく答えられなかった。", en: "Bewildered by the sudden question, I could not answer well." }],
    qs: [
      { t: "fitb", s: "予想外の展開に会場は＿＿＿＿の空気に包まれた。", en: "The venue was enveloped in an atmosphere of bewilderment at the unexpected development.", o: ["当惑", "困惑", "混乱", "狼狽"], a: 0, e: "当惑(とうわく) = bewilderment/perplexity (not knowing how to react). 困惑(こんわく) = confusion/embarrassment (troubled, at a loss). 混乱(こんらん) = confusion/disorder (chaotic). 狼狽(ろうばい) = panic/consternation (flustered)." },
      { t: "meaning", s: "「当惑」の意味は？", o: ["bewilderment; perplexity (not knowing how to react)", "confusion; embarrassment (at a loss)", "confusion; disorder (chaotic)", "panic; consternation (flustered)"], a: 0, e: "当惑 = being thrown off and not knowing how to respond (当惑した表情 = a perplexed expression). 困惑 has a stronger nuance of being troubled or embarrassed." }
    ]
  },
  {
    id: "n2-0788", w: "要領", r: "ようりょう", m: "the knack; the point; efficiency; gist", c: "noun", lv: 1,
    ex: [{ jp: "仕事の要領を覚えてからは、残業が減った。", en: "Since I got the knack of the job, overtime has decreased." }],
    qs: [
      { t: "fitb", s: "彼は＿＿＿＿がよく、いつも最小限の努力で最大の成果を出す。", en: "He has a good knack for things and always gets maximum results with minimum effort.", o: ["要領", "効率", "センス", "コツ"], a: 0, e: "要領(ようりょう) = the knack/the smart way to do something (要領がいい = efficient/smart). 効率(こうりつ) = efficiency (ratio of output to input). センス = sense/knack (innate, loanword). コツ = the trick/knack (practical tip)." },
      { t: "meaning", s: "「要領」の意味は？", o: ["the knack; the smart way; efficiency", "efficiency (ratio output/input)", "innate sense; flair (loanword)", "the trick; practical tip"], a: 0, e: "要領 = knowing how to handle things smartly (要領を得ない = vague / doesn't get to the point, 要領がいい = knows how to work smart)." }
    ]
  },
  {
    id: "n2-0789", w: "難航", r: "なんこう", m: "difficult progress; running into trouble; rough going", c: "noun", lv: 1,
    ex: [{ jp: "交渉は依然として難航しており、合意の見通しが立たない。", en: "Negotiations are still making difficult progress and there is no prospect of agreement." }],
    qs: [
      { t: "fitb", s: "新製品の開発は技術的な問題で＿＿＿＿している。", en: "Development of the new product is running into trouble due to technical problems.", o: ["難航", "難しく", "遅延", "停滞"], a: 0, e: "難航(なんこう)する = to make difficult progress / struggle (交渉が難航 = negotiations hit rough waters). 遅延(ちえん)する = to be delayed. 停滞(ていたい)する = to stagnate." },
      { t: "meaning", s: "「難航」の意味は？", o: ["difficult progress; rough going", "becoming difficult", "delay", "stagnation"], a: 0, e: "難航 = making slow, troubled progress (難航する交渉 = difficult negotiations, 難航続き = continued rough going). Literally: difficult sailing." }
    ]
  },
  {
    id: "n2-0790", w: "反面", r: "はんめん", m: "on the other hand; on the flip side", c: "adv", lv: 1,
    ex: [{ jp: "彼は頭が切れる反面、人付き合いが苦手だ。", en: "On the flip side of being sharp-minded, he is poor at socializing." }],
    qs: [
      { t: "fitb", s: "便利な＿＿＿＿、依存しすぎるリスクもある。", en: "On the flip side of being convenient, there is also the risk of over-reliance.", o: ["反面", "一方", "その反面", "逆に"], a: 0, e: "反面(はんめん) = on the flip side / the other aspect (same subject, contrasting trait). 一方(いっぽう) = on the other hand (can contrast two different subjects). その反面 = on the other hand (same meaning with その). 逆に(ぎゃくに) = conversely." },
      { t: "meaning", s: "「反面」の意味は？", o: ["on the flip side (same subject, opposite aspect)", "on the other hand (can differ subjects)", "conversely", "however; but"], a: 0, e: "反面 specifically contrasts two aspects of the same thing or person (長所の反面 = on the flip side of one's strength). It cannot introduce a completely different subject." }
    ]
  },
  {
    id: "n2-0791", w: "手掛かり", r: "てがかり", m: "clue; lead; something to hold on to", c: "noun", lv: 1,
    ex: [{ jp: "事件解決の手掛かりがようやく見つかった。", en: "A clue to solving the case was finally found." }],
    qs: [
      { t: "fitb", s: "その古い写真が、行方不明の人物を探す唯一の＿＿＿＿となった。", en: "That old photograph became the only clue in searching for the missing person.", o: ["手掛かり", "手がかり", "糸口", "証拠"], a: 0, e: "手掛かり(てがかり) = a clue / lead (alternate kanji of 手がかり). 糸口(いとぐち) = a starting thread to pull. 証拠(しょうこ) = evidence." },
      { t: "meaning", s: "「手掛かり」の意味は？", o: ["clue; lead; something to go on", "a starting thread (to unravel a problem)", "evidence; proof", "hint; suggestion"], a: 0, e: "手掛かり / 手がかり = something you can grab onto to make progress (犯人の手掛かり = a lead on the culprit, 手掛かりをつかむ = to get a lead)." }
    ]
  },
  {
    id: "n2-0792", w: "歯止め", r: "はどめ", m: "brake; check; curb; putting a stop to", c: "noun", lv: 1,
    ex: [{ jp: "インフレに歯止めをかけるため、金利が引き上げられた。", en: "Interest rates were raised to put a brake on inflation." }],
    qs: [
      { t: "fitb", s: "少子化に＿＿＿＿をかける政策が急務となっている。", en: "Policies to put a brake on the declining birthrate have become urgently needed.", o: ["歯止め", "ブレーキ", "制限", "規制"], a: 0, e: "歯止め(はどめ) = a brake/check (歯止めをかける = to put a brake on something). ブレーキ = brake (loanword). 制限(せいげん) = restriction/limit. 規制(きせい) = regulation/control." },
      { t: "meaning", s: "「歯止め」の意味は？", o: ["brake; check; putting a stop to", "brake (loanword)", "restriction; limit", "regulation; control"], a: 0, e: "歯止め = a mechanism that stops runaway progress (歯止めがきかない = cannot be stopped, 歯止めをかける = to apply a brake/curb)." }
    ]
  },
  {
    id: "n2-0793", w: "見合う", r: "みあう", m: "to be commensurate; to be worth it; to match", c: "verb", lv: 1,
    ex: [{ jp: "この仕事の給与は労働量に見合っていないと感じる。", en: "I feel that the salary for this job is not commensurate with the workload." }],
    qs: [
      { t: "fitb", s: "価格に＿＿＿＿だけの品質がなければ、顧客は離れていく。", en: "If the quality is not commensurate with the price, customers will leave.", o: ["見合う", "釣り合う", "相応する", "値する"], a: 0, e: "見合う(みあう) = to be commensurate/worth it (cost vs value). 釣り合う(つりあう) = to be balanced/matched. 相応する(そうおうする) = to be appropriate/corresponding. 値する(あたいする) = to be worthy of / deserve." },
      { t: "meaning", s: "「見合う」の意味は？", o: ["to be commensurate; to be worth it", "to be balanced; to match", "to be appropriate; to correspond", "to be worthy of; to deserve"], a: 0, e: "見合う = the value matches what you put in (努力に見合う報酬 = rewards commensurate with effort, リスクに見合わない = not worth the risk)." }
    ]
  },
  {
    id: "n2-0794", w: "引き換え", r: "ひきかえ", m: "in exchange for; at the cost of; in return for", c: "noun", lv: 1,
    ex: [{ jp: "健康を引き換えにしてまで、仕事を続けるべきではない。", en: "You should not continue working at the cost of your health." }],
    qs: [
      { t: "fitb", s: "それと＿＿＿＿に、あなたは何を差し出せますか？", en: "In exchange for that, what can you offer?", o: ["引き換え", "代わり", "交換に", "お返しに"], a: 0, e: "引き換え(ひきかえ) = in exchange for / at the cost of (Aと引き換えに = in exchange for A). 代わりに(かわりに) = instead / in return. 交換に(こうかんに) = in exchange. お返しに(おかえしに) = in return/as a reciprocal gift." },
      { t: "meaning", s: "「引き換え」の意味は？", o: ["in exchange for; at the cost of", "instead; in return", "in exchange (direct swap)", "in return (reciprocal gift)"], a: 0, e: "引き換え = swapping one thing for another, often at a cost (チケットと引き換えに入場 = admission in exchange for a ticket, 命と引き換えに = at the cost of one's life)." }
    ]
  },
  {
    id: "n2-0795", w: "立て直す", r: "たてなおす", m: "to rebuild; to restructure; to get back on track", c: "verb", lv: 1,
    ex: [{ jp: "経営危機に陥った会社を立て直すのに三年かかった。", en: "It took three years to rebuild the company that had fallen into a management crisis." }],
    qs: [
      { t: "fitb", s: "前半で大幅に負けたが、後半で態勢を＿＿＿＿すことができた。", en: "We were losing heavily in the first half, but managed to get back on track in the second half.", o: ["立て直", "立ち直", "立て直すこと", "再建"], a: 0, e: "立て直す(たてなおす) = to rebuild/restructure (a situation, strategy). 立ち直る(たちなおる) = to recover/bounce back (intransitive). 再建する(さいけんする) = to reconstruct/restore (formal)." },
      { t: "meaning", s: "「立て直す」の意味は？", o: ["to rebuild; to restructure (transitive)", "to recover; to bounce back (intransitive)", "to reconstruct; to restore (formal)", "to reconsider; to redo"], a: 0, e: "立て直す = actively rebuilding something that went wrong (体制を立て直す = to restructure the system, 計画を立て直す = to revamp the plan)." }
    ]
  },
  {
    id: "n2-0796", w: "行き詰まる", r: "いきづまる", m: "to reach a deadlock; to be stuck; to hit a wall", c: "verb", lv: 1,
    ex: [{ jp: "研究が行き詰まり、新しいアプローチを模索している。", en: "The research has hit a wall and I am searching for a new approach." }],
    qs: [
      { t: "fitb", s: "交渉が＿＿＿＿まってしまい、双方が打開策を探している。", en: "The negotiations have reached a deadlock and both sides are looking for a breakthrough.", o: ["行き詰", "手詰ま", "行き詰まり", "停滞し"], a: 0, e: "行き詰まる(いきづまる) = to hit a dead end / be stuck. 手詰まり(てづまり) = a deadlock / no more moves (chess/go). 停滞する(ていたいする) = to stagnate." },
      { t: "meaning", s: "「行き詰まる」の意味は？", o: ["to reach a deadlock; to hit a wall", "a deadlock; no more moves (game)", "to stagnate; to stop moving", "to fail; to end in failure"], a: 0, e: "行き詰まる = coming to a point where you can't go further (行き詰まり = a deadlock/impasse, 行き詰まりを打開する = to break through a deadlock)." }
    ]
  },
  {
    id: "n2-0797", w: "一筋", r: "ひとすじ", m: "single-minded; devoted to one thing; a single line", c: "noun", lv: 1,
    ex: [{ jp: "彼は三十年間、教育一筋に生きてきた。", en: "He has devoted himself single-mindedly to education for thirty years." }],
    qs: [
      { t: "fitb", s: "料理＿＿＿＿に生きてきた職人の技は、見事なものだ。", en: "The craftsmanship of an artisan who has devoted their whole life to cooking is magnificent.", o: ["一筋", "一途", "ひたすら", "専念"], a: 0, e: "一筋(ひとすじ) = devoted to one thing (noun: 野球一筋 = devoted solely to baseball). 一途(いちず) = wholehearted / single-minded (adjective sense). ひたすら = simply/earnestly (adverb). 専念する(せんねんする) = to devote oneself to." },
      { t: "meaning", s: "「一筋」の意味は？", o: ["single-minded devotion to one thing", "wholehearted; single-minded (adj)", "earnestly; simply (adverb)", "to devote oneself to"], a: 0, e: "一筋 = unwavering focus on one path (野球一筋 = baseball only, 一筋の希望 = a single ray of hope). Also literally: a single line/streak." }
    ]
  },
  {
    id: "n2-0798", w: "仕掛け", r: "しかけ", m: "mechanism; device; trick; contrivance", c: "noun", lv: 1,
    ex: [{ jp: "このおもちゃには面白い仕掛けが施されている。", en: "This toy has an interesting mechanism built into it." }],
    qs: [
      { t: "fitb", s: "マジックのタネは単純な＿＿＿＿だったが、見事に騙された。", en: "The trick behind the magic was a simple device, but I was brilliantly fooled.", o: ["仕掛け", "仕組み", "からくり", "トリック"], a: 0, e: "仕掛け(しかけ) = a device/mechanism (often hidden or clever). 仕組み(しくみ) = how something works / mechanism (explanatory). からくり = a trick/mechanism (often surprising). トリック = a trick (loanword)." },
      { t: "meaning", s: "「仕掛け」の意味は？", o: ["mechanism; device; trick", "how something works; mechanism (explanatory)", "trick; surprising mechanism", "trick (loanword)"], a: 0, e: "仕掛け = a built-in mechanism or trick (仕掛け絵本 = a pop-up book, 仕掛けを施す = to set a device/trap). Also: 仕掛け人 = a puppeteer/schemer." }
    ]
  },
  {
    id: "n2-0799", w: "まとまる", r: "まとまる", m: "to come together; to be settled; to reach agreement", c: "verb", lv: 1,
    ex: [{ jp: "長い交渉の末、ようやく話がまとまった。", en: "After long negotiations, the discussion finally came together." }],
    qs: [
      { t: "fitb", s: "チームの意見が＿＿＿＿らず、プロジェクトが前に進まない。", en: "The team's opinions won't come together and the project can't move forward.", o: ["まとま", "一致し", "まとめられ", "統一され"], a: 0, e: "まとまる(まとまる) = to come together / be settled (intransitive: 話がまとまる = the deal is settled). 一致する(いっちする) = to agree/match. まとめる(まとめる) = to put together (transitive). 統一される(とういつされる) = to be unified." },
      { t: "meaning", s: "「まとまる」の意味は？", o: ["to come together; to be settled (intransitive)", "to agree; to match", "to put together (transitive)", "to be unified"], a: 0, e: "まとまる = things consolidating into a coherent whole (話がまとまる = things are settled, 意見がまとまる = opinions converge, まとまりがない = incoherent/scattered)." }
    ]
  },
  {
    id: "n2-0800", w: "向き合う", r: "むきあう", m: "to face; to confront; to come to terms with", c: "verb", lv: 1,
    ex: [{ jp: "過去の失敗と向き合うことが、成長への近道だ。", en: "Facing up to past failures is a shortcut to growth." }],
    qs: [
      { t: "fitb", s: "困難な現実から逃げずに、真剣に＿＿＿＿必要がある。", en: "Without running from the difficult reality, we need to face it seriously.", o: ["向き合う", "立ち向かう", "対峙する", "直視する"], a: 0, e: "向き合う(むきあう) = to come face to face with / sit with (a problem, person). 立ち向かう(たちむかう) = to stand up against (more combative). 対峙する(たいじする) = to confront / stand face to face (formal). 直視する(ちょくしする) = to look directly at." },
      { t: "meaning", s: "「向き合う」の意味は？", o: ["to face; to come to terms with", "to stand up against (combative)", "to confront (formal)", "to look directly at"], a: 0, e: "向き合う = being fully present with something or someone (問題と向き合う = to face a problem, 患者と向き合う = to engage with a patient directly)." }
    ]
  },
  {
    id: "n2-0801", w: "打開", r: "だかい", m: "breakthrough; breaking through a deadlock", c: "noun", lv: 1,
    ex: [{ jp: "行き詰まった状況を打開するために、新しい戦略が必要だ。", en: "A new strategy is needed to break through the deadlocked situation." }],
    qs: [
      { t: "fitb", s: "局面の＿＿＿＿を図るため、トップ同士の会談が設けられた。", en: "A summit meeting between the leaders was arranged in order to seek a breakthrough in the situation.", o: ["打開", "解決", "突破", "転換"], a: 0, e: "打開(だかい) = breaking through a difficult situation. 解決(かいけつ) = resolution/solution (complete). 突破(とっぱ) = breaking through (a barrier, goal). 転換(てんかん) = a shift/change." },
      { t: "meaning", s: "「打開」の意味は？", o: ["breakthrough; breaking a deadlock", "resolution; solution (complete)", "breaking through a barrier", "a shift; a change of direction"], a: 0, e: "打開 = forcing a way through a stuck situation (打開策 = a way forward, 局面を打開する = to break through the current impasse)." }
    ]
  },
  {
    id: "n2-0802", w: "余波", r: "よは", m: "aftermath; ripple effect; after-effect", c: "noun", lv: 1,
    ex: [{ jp: "金融危機の余波は数年にわたって経済に影響を与えた。", en: "The ripple effects of the financial crisis affected the economy for several years." }],
    qs: [
      { t: "fitb", s: "大企業の倒産の＿＿＿＿を受けて、関連する中小企業も苦境に立たされた。", en: "In the wake of the major company's bankruptcy, related small and medium enterprises also found themselves in difficulty.", o: ["余波", "影響", "余韻", "後遺症"], a: 0, e: "余波(よは) = ripple effect / aftermath (spreading from a major event). 影響(えいきょう) = influence/effect. 余韻(よいん) = lingering feeling/afterglow. 後遺症(こういしょう) = after-effects / lasting damage (medical/metaphorical)." },
      { t: "meaning", s: "「余波」の意味は？", o: ["ripple effect; aftermath", "influence; effect (general)", "lingering feeling; afterglow", "after-effects; lasting damage"], a: 0, e: "余波 = the waves that spread out from a major event (政変の余波 = the ripple effects of a political upheaval, 余波が広がる = the ripples spread)." }
    ]
  },
  {
    id: "n2-0803", w: "素早い", r: "すばやい", m: "quick; swift; agile; prompt", c: "iadj", lv: 1,
    ex: [{ jp: "緊急事態への素早い対応が、被害を最小限に抑えた。", en: "Swift response to the emergency kept the damage to a minimum." }],
    qs: [
      { t: "fitb", s: "彼女の＿＿＿＿判断が、事故を防いだ。", en: "Her quick judgment prevented the accident.", o: ["素早い", "迅速な", "瞬時の", "機敏な"], a: 0, e: "素早い(すばやい) = quick/swift (movement, reaction). 迅速な(じんそくな) = prompt/speedy (formal, na-adj). 瞬時の(しゅんじの) = instantaneous. 機敏な(きびんな) = agile/alert." },
      { t: "meaning", s: "「素早い」の意味は？", o: ["quick; swift; agile", "prompt; speedy (formal)", "instantaneous", "agile; alert"], a: 0, e: "素早い = physically or mentally quick (素早い動き = quick movements, 素早く対応する = to respond swiftly). 迅速 is the more formal/written equivalent." }
    ]
  },
  {
    id: "n2-0804", w: "物足りない", r: "ものたりない", m: "unsatisfying; lacking; leaving something to be desired", c: "iadj", lv: 1,
    ex: [{ jp: "内容は悪くないが、どこか物足りない気がする。", en: "The content isn't bad, but somehow it feels like it's lacking something." }],
    qs: [
      { t: "fitb", s: "一皿だけでは＿＿＿＿ので、もう一品注文した。", en: "One dish left me wanting more, so I ordered another.", o: ["物足りない", "足りない", "不十分な", "少ない"], a: 0, e: "物足りない(ものたりない) = leaving something to be desired / unsatisfying (a subtle feeling of lack). 足りない(たりない) = insufficient/not enough (factual lack). 不十分な(ふじゅうぶんな) = insufficient (formal). 少ない(すくない) = few/little." },
      { t: "meaning", s: "「物足りない」の意味は？", o: ["unsatisfying; leaving sth to be desired", "insufficient; not enough (factual)", "insufficient (formal)", "few; little (quantity)"], a: 0, e: "物足りない = that feeling of 'something's missing' even when nothing is technically wrong (物足りなさを感じる = to feel a sense of dissatisfaction, 物足りない結果 = a result that falls short of what you hoped)." }
    ]
  },
  {
    id: "n2-0805", w: "馴染む", r: "なじむ", m: "to get used to; to fit in; to blend in", c: "verb", lv: 1,
    ex: [{ jp: "新しい職場に馴染むのに少し時間がかかったが、今は楽しく働いている。", en: "It took a little time to fit into the new workplace, but now I am working happily." }],
    qs: [
      { t: "fitb", s: "外国の文化に＿＿＿＿のは大変だが、充実した経験になる。", en: "It is difficult to blend in with a foreign culture, but it becomes a fulfilling experience.", o: ["馴染む", "慣れる", "溶け込む", "適応する"], a: 0, e: "馴染む(なじむ) = to fit in / become familiar with (gradual, natural process). 慣れる(なれる) = to get used to. 溶け込む(とけこむ) = to blend in / merge (complete assimilation). 適応する(てきおうする) = to adapt." },
      { t: "meaning", s: "「馴染む」の意味は？", o: ["to fit in; to become familiar (gradual)", "to get used to", "to blend in; to merge completely", "to adapt"], a: 0, e: "馴染む = becoming comfortable and familiar (環境に馴染む = to settle into an environment, 馴染みの店 = a familiar/regular shop, 馴染みのない言葉 = an unfamiliar word)." }
    ]
  },
  {
    id: "n2-0806", w: "行き渡る", r: "いきわたる", m: "to spread throughout; to reach everywhere; to permeate", c: "verb", lv: 1,
    ex: [{ jp: "支援物資が被災地全体に行き渡るのに一週間かかった。", en: "It took one week for aid supplies to reach throughout the entire disaster-stricken area." }],
    qs: [
      { t: "fitb", s: "インターネットが社会全体に＿＿＿＿、情報格差が縮まってきた。", en: "As the internet has spread throughout society, the information gap has been narrowing.", o: ["行き渡り", "普及し", "広まり", "浸透し"], a: 0, e: "行き渡る(いきわたる) = to reach every corner / spread throughout. 普及する(ふきゅうする) = to become widespread. 広まる(ひろまる) = to spread (information, custom). 浸透する(しんとうする) = to permeate/sink in." },
      { t: "meaning", s: "「行き渡る」の意味は？", o: ["to spread throughout; to reach everywhere", "to become widespread", "to spread (information, custom)", "to permeate; to sink in"], a: 0, e: "行き渡る = reaching every single place or person (全員に情報が行き渡る = information reaches everyone, 隅々まで行き渡る = to reach every corner)." }
    ]
  },
  {
    id: "n2-0807", w: "もれなく", r: "もれなく", m: "without exception; all; every single one", c: "adv", lv: 1,
    ex: [{ jp: "応募者全員にもれなく記念品をプレゼントします。", en: "We will give a commemorative gift to every single applicant without exception." }],
    qs: [
      { t: "fitb", s: "このキャンペーンは参加者＿＿＿＿に特典が付いてきます。", en: "This campaign comes with a benefit for every single participant.", o: ["もれなく", "全員に", "例外なく", "一人残らず"], a: 0, e: "もれなく = without a single exception / every last one (often in advertising). 全員に(ぜんいんに) = to all members. 例外なく(れいがいなく) = without exception. 一人残らず(ひとりのこらず) = without leaving a single person out." },
      { t: "meaning", s: "「もれなく」の意味は？", o: ["without exception; every single one", "to all members", "without exception (formal)", "without leaving a single person out"], a: 0, e: "もれなく is commonly used in promotions and official announcements (もれなくプレゼント = a gift for every single person, もれなく伝える = to inform everyone without omission)." }
    ]
  },
  {
    id: "n2-0808", w: "手薄", r: "てうす", m: "understaffed; thinly spread; inadequate", c: "naadj", lv: 1,
    ex: [{ jp: "夜間は警備が手薄になるため、別の対策が必要だ。", en: "Because security becomes thin at night, additional measures are needed." }],
    qs: [
      { t: "fitb", s: "この分野の知識が＿＿＿＿なので、専門家に相談することにした。", en: "Since my knowledge of this field is thin, I decided to consult a specialist.", o: ["手薄", "不十分", "不足", "乏しい"], a: 0, e: "手薄(てうす) = thinly covered / understaffed (not enough resources). 不十分(ふじゅうぶん) = insufficient. 不足(ふそく) = shortage/lack. 乏しい(とぼしい) = scarce/meager." },
      { t: "meaning", s: "「手薄」の意味は？", o: ["thinly spread; understaffed; inadequate", "insufficient; not enough", "shortage; lack", "scarce; meager"], a: 0, e: "手薄 = not having enough people or resources to cover something properly (警備が手薄 = security is thin, 手薄な布陣 = a thin lineup/formation)." }
    ]
  },
  {
    id: "n2-0809", w: "根付く", r: "ねづく", m: "to take root; to become established; to be ingrained", c: "verb", lv: 1,
    ex: [{ jp: "その文化はこの地域に深く根付いている。", en: "That culture is deeply rooted in this region." }],
    qs: [
      { t: "fitb", s: "新しい習慣が社会に＿＿＿＿くには時間がかかる。", en: "It takes time for a new custom to take root in society.", o: ["根付", "定着し", "浸透し", "広ま"], a: 0, e: "根付く(ねづく) = to take root (become firmly established over time). 定着する(ていちゃくする) = to become established/settled. 浸透する(しんとうする) = to permeate/spread. 広まる(ひろまる) = to spread." },
      { t: "meaning", s: "「根付く」の意味は？", o: ["to take root; to become established", "to become settled; to take hold", "to permeate; to spread (gradual)", "to spread (information/custom)"], a: 0, e: "根付く = becoming so embedded it won't easily be removed (文化が根付く = a culture takes root, 根付いた慣習 = an ingrained custom)." }
    ]
  },
  {
    id: "n2-0810", w: "目を向ける", r: "めをむける", m: "to turn one's attention to; to look toward", c: "verb", lv: 1,
    ex: [{ jp: "国内だけでなく、海外の動向にも目を向けることが重要だ。", en: "It is important to turn attention not only to domestic trends but also to international ones." }],
    qs: [
      { t: "fitb", s: "問題の原因に＿＿＿＿けることなく、表面的な対処だけを続けた。", en: "Without turning attention to the cause of the problem, they continued only superficial measures.", o: ["目を向", "注目し", "着目し", "目指し"], a: 0, e: "目を向ける(めをむける) = to turn one's gaze/attention toward. 注目する(ちゅうもくする) = to pay attention to / focus on. 着目する(ちゃくもくする) = to focus on / pay heed to. 目指す(めざす) = to aim for." },
      { t: "meaning", s: "「目を向ける」の意味は？", o: ["to turn attention to; to look toward", "to focus on; to pay attention to", "to pay heed to; to focus on", "to aim for; to target"], a: 0, e: "目を向ける = directing your awareness somewhere (弱者に目を向ける = to turn one's attention to the vulnerable, 未来に目を向ける = to look to the future)." }
    ]
  },
  {
    id: "n2-0811", w: "立証する", r: "りっしょうする", m: "to prove; to demonstrate; to establish (a fact)", c: "verb", lv: 1,
    ex: [{ jp: "無罪を立証するには、確かな証拠が必要だ。", en: "Solid evidence is needed to prove innocence." }],
    qs: [
      { t: "fitb", s: "その理論の正しさを実験で＿＿＿＿ことができた。", en: "We were able to demonstrate the correctness of the theory through experiment.", o: ["立証する", "証明する", "実証する", "検証する"], a: 0, e: "立証する(りっしょうする) = to prove/establish (legally or formally). 証明する(しょうめいする) = to prove/certify. 実証する(じっしょうする) = to demonstrate empirically. 検証する(けんしょうする) = to verify/examine." },
      { t: "meaning", s: "「立証する」の意味は？", o: ["to prove; to establish (legally/formally)", "to prove; to certify (general)", "to demonstrate empirically", "to verify; to examine"], a: 0, e: "立証 = establishing something as fact, especially in legal or academic contexts (無実を立証する = to prove innocence, 立証責任 = burden of proof)." }
    ]
  },
  {
    id: "n2-0812", w: "気兼ね", r: "きがね", m: "reservation; constraint; hesitation (about bothering others)", c: "noun", lv: 1,
    ex: [{ jp: "一人暮らしなので、夜遅く帰っても気兼ねなくていい。", en: "Since I live alone, I don't have to worry about bothering anyone coming home late at night." }],
    qs: [
      { t: "fitb", s: "遠慮や＿＿＿＿なしに、何でも相談してください。", en: "Please consult me about anything without reserve or worry about imposing.", o: ["気兼ね", "遠慮", "躊躇", "気遣い"], a: 0, e: "気兼ね(きがね) = hesitation about being a burden to others. 遠慮(えんりょ) = restraint/holding back (modesty). 躊躇(ちゅうちょ) = hesitation/reluctance. 気遣い(きづかい) = consideration/care for others." },
      { t: "meaning", s: "「気兼ね」の意味は？", o: ["constraint; worry about being a burden", "restraint; holding back (modesty)", "hesitation; reluctance", "consideration; care for others"], a: 0, e: "気兼ねなく = without worrying about imposing (気兼ねなく話す = to speak freely, 気兼ねのいらない関係 = a relationship where you don't have to hold back)." }
    ]
  },
  {
    id: "n2-0813", w: "明らかに", r: "あきらかに", m: "clearly; obviously; evidently", c: "adv", lv: 1,
    ex: [{ jp: "その説明は明らかに事実と矛盾している。", en: "That explanation is clearly contradicted by the facts." }],
    qs: [
      { t: "fitb", s: "彼の態度は＿＿＿＿昨日と違っており、何かあったのだろう。", en: "His attitude is obviously different from yesterday; something must have happened.", o: ["明らかに", "明確に", "はっきりと", "明白に"], a: 0, e: "明らかに(あきらかに) = clearly/evidently (observable). 明確に(めいかくに) = clearly/unambiguously (stated). はっきりと = clearly (direct, spoken). 明白に(めいはくに) = obviously/patently (stronger)." },
      { t: "meaning", s: "「明らかに」の意味は？", o: ["clearly; obviously; evidently", "clearly; unambiguously (stated)", "clearly (direct, spoken)", "obviously; patently (stronger)"], a: 0, e: "明らかに = plainly apparent to observation (明らかに間違っている = clearly wrong, 明らかになる = to become clear/be revealed)." }
    ]
  },
  {
    id: "n2-0814", w: "とりわけ", r: "とりわけ", m: "especially; particularly; above all", c: "adv", lv: 1,
    ex: [{ jp: "この地域はとりわけ冬の寒さが厳しい。", en: "This region is especially harsh in winter cold." }],
    qs: [
      { t: "fitb", s: "参加者の中で＿＿＿＿活躍したのは、最年少のメンバーだった。", en: "The one who stood out above all among the participants was the youngest member.", o: ["とりわけ", "特に", "とくべつ", "ひときわ"], a: 0, e: "とりわけ = especially/above all (formal/written). 特に(とくに) = especially (general). ひときわ = conspicuously / notably (stands out visually). とくべつ = special/particular." },
      { t: "meaning", s: "「とりわけ」の意味は？", o: ["especially; above all (formal/written)", "especially (general)", "conspicuously; notably (stands out)", "special; particular"], a: 0, e: "とりわけ = singling something out as exceptional (とりわけ重要な点 = a particularly important point). It is more literary than 特に and often appears in written texts." }
    ]
  },
  {
    id: "n2-0815", w: "かつて", r: "かつて", m: "once; formerly; in the past; ever (with negative)", c: "adv", lv: 1,
    ex: [{ jp: "この街はかつて繁栄していたが、今は面影もない。", en: "This town once prospered, but now there is no trace of it." }],
    qs: [
      { t: "fitb", s: "＿＿＿＿ないほどの大雪が降り、交通機関が完全に麻痺した。", en: "Snow fell like never before and transportation was completely paralyzed.", o: ["かつて", "以前", "昔", "かつてない"], a: 0, e: "かつて = once (in the past) / ever (with negative: かつてない = unprecedented). 以前(いぜん) = before / previously. 昔(むかし) = in the old days / long ago. かつてない = unprecedented (set phrase)." },
      { t: "meaning", s: "「かつて」の意味は？", o: ["once; formerly; ever (with negative)", "before; previously", "long ago; in the old days", "unprecedented (set phrase)"], a: 0, e: "かつて = at some past time (かつて存在した = once existed). With negatives: かつてない規模 = an unprecedented scale, かつて経験したことがない = never experienced before." }
    ]
  },
  {
    id: "n2-0816", w: "取り巻く", r: "とりまく", m: "to surround; to encircle; to envelop", c: "verb", lv: 1,
    ex: [{ jp: "私たちを取り巻く環境は急速に変化している。", en: "The environment surrounding us is changing rapidly." }],
    qs: [
      { t: "fitb", s: "国際情勢を＿＿＿＿状況は複雑だ。", en: "The situation surrounding the international situation is complex.", o: ["取り巻く", "囲む", "取り囲む", "包む"], a: 0, e: "取り巻く(とりまく) = to surround (circumstances, environment — abstract or physical). 囲む(かこむ) = to surround (physical). 取り囲む(とりかこむ) = to surround from all sides. 包む(つつむ) = to wrap / envelop." },
      { t: "meaning", s: "「取り巻く」の意味は？", o: ["to surround; to envelop (abstract or physical)", "to surround (physical)", "to surround from all sides", "to wrap; to envelop"], a: 0, e: "取り巻く = the things that form one's context or circle (取り巻く環境 = the surrounding environment, 取り巻き = hangers-on / entourage)." }
    ]
  },
  {
    id: "n2-0817", w: "備わる", r: "そなわる", m: "to be equipped with; to be gifted with; to be inherent in", c: "verb", lv: 1,
    ex: [{ jp: "彼には生まれつき優れたリーダーシップが備わっている。", en: "He is inherently equipped with excellent leadership." }],
    qs: [
      { t: "fitb", s: "この製品には最新の安全機能が＿＿＿＿っている。", en: "This product is equipped with the latest safety features.", o: ["備わ", "装備され", "搭載され", "付いて"], a: 0, e: "備わる(そなわる) = to be endowed with / naturally equipped (intransitive). 装備される(そうびされる) = to be equipped (military/technical). 搭載される(とうさいされる) = to be mounted/installed (tech). 付く(つく) = to come with / be attached." },
      { t: "meaning", s: "「備わる」の意味は？", o: ["to be endowed with; naturally equipped", "to be equipped (military/technical)", "to be installed; to be mounted", "to come with; to be attached"], a: 0, e: "備わる = having something as an inherent quality (才能が備わる = to be gifted with talent, 機能が備わる = to be equipped with a function). More organic than 装備される." }
    ]
  },
  {
    id: "n2-0818", w: "積み重ねる", r: "つみかさねる", m: "to accumulate; to pile up; to build up over time", c: "verb", lv: 1,
    ex: [{ jp: "長年の努力を積み重ねた結果、今の自分がある。", en: "The person I am today is the result of accumulating years of effort." }],
    qs: [
      { t: "fitb", s: "失敗を恐れず経験を＿＿＿＿ることが、成長への道だ。", en: "Accumulating experience without fearing failure is the road to growth.", o: ["積み重ね", "積み上げ", "蓄積し", "重ね"], a: 0, e: "積み重ねる(つみかさねる) = to accumulate layer by layer over time. 積み上げる(つみあげる) = to stack up / build up. 蓄積する(ちくせきする) = to accumulate (formal). 重ねる(かさねる) = to layer/repeat." },
      { t: "meaning", s: "「積み重ねる」の意味は？", o: ["to accumulate layer by layer over time", "to stack up; to build up", "to accumulate (formal)", "to layer; to repeat"], a: 0, e: "積み重ねる = building something through sustained, repeated effort (実績を積み重ねる = to build a track record, 積み重ねてきた努力 = accumulated efforts over time)." }
    ]
  },
  {
    id: "n2-0819", w: "兼ね備える", r: "かねそなえる", m: "to have both; to combine; to be endowed with both", c: "verb", lv: 1,
    ex: [{ jp: "彼女は美しさと知性を兼ね備えた人だ。", en: "She is a person who combines both beauty and intelligence." }],
    qs: [
      { t: "fitb", s: "実用性とデザイン性を＿＿＿＿た製品が消費者に支持されている。", en: "Products that combine both practicality and design appeal are favoured by consumers.", o: ["兼ね備え", "両立させ", "備え", "持ち合わせ"], a: 0, e: "兼ね備える(かねそなえる) = to possess both qualities simultaneously. 両立させる(りょうりつさせる) = to make both coexist. 備える(そなえる) = to equip with / prepare. 持ち合わせる(もちあわせる) = to happen to have." },
      { t: "meaning", s: "「兼ね備える」の意味は？", o: ["to have both; to combine two qualities", "to make both coexist", "to equip with; to prepare", "to happen to have"], a: 0, e: "兼ね備える = being endowed with two things at once (知識と経験を兼ね備える = to have both knowledge and experience)." }
    ]
  },
  {
    id: "n2-0820", w: "問いかける", r: "といかける", m: "to question; to pose a question to; to raise the question of", c: "verb", lv: 1,
    ex: [{ jp: "この映画は現代社会のあり方に深く問いかけている。", en: "This film deeply questions the way modern society is." }],
    qs: [
      { t: "fitb", s: "自分自身に＿＿＿＿ことで、本当にやりたいことが見えてくる。", en: "By posing questions to yourself, what you truly want to do becomes visible.", o: ["問いかける", "問い直す", "自問する", "問う"], a: 0, e: "問いかける(といかける) = to direct a question at someone or something (society, oneself). 問い直す(といなおす) = to re-examine/question again. 自問する(じもんする) = to ask oneself. 問う(とう) = to question / call to account (formal)." },
      { t: "meaning", s: "「問いかける」の意味は？", o: ["to pose a question to; to raise the question", "to re-examine; to question again", "to ask oneself", "to question; to call to account (formal)"], a: 0, e: "問いかける = directing a question outward (観客に問いかける = to pose questions to the audience, 社会に問いかける = to challenge society to reflect)." }
    ]
  },
  {
    id: "n2-0821", w: "思い当たる", r: "おもいあたる", m: "to come to mind; to think of; to realize", c: "verb", lv: 1,
    ex: [{ jp: "なぜ彼が怒っているのか、思い当たる節がある。", en: "I have some idea of why he is angry." }],
    qs: [
      { t: "fitb", s: "心当たりはありますか？＿＿＿＿ことがあれば教えてください。", en: "Do you have any idea? If anything comes to mind, please let me know.", o: ["思い当たる", "思い出す", "気づく", "思い当たり"], a: 0, e: "思い当たる(おもいあたる) = to have something come to mind as a likely cause or reason. 思い出す(おもいだす) = to recall a memory. 気づく(きづく) = to notice / become aware of. 思い当たる節がある = I think I know why." },
      { t: "meaning", s: "「思い当たる」の意味は？", o: ["to come to mind; to think of a likely reason", "to recall; to remember", "to notice; to become aware of", "to realize suddenly"], a: 0, e: "思い当たる = something clicking as a likely explanation (思い当たる節がある = there is something that comes to mind as a reason, 思い当たらない = nothing comes to mind)." }
    ]
  },
  {
    id: "n2-0822", w: "整合性", r: "せいごうせい", m: "consistency; coherence; logical consistency", c: "noun", lv: 1,
    ex: [{ jp: "前後の発言に整合性がないと、信頼を失う。", en: "If there is no consistency between what you said before and after, you lose trust." }],
    qs: [
      { t: "fitb", s: "この計画は目標と手段の間に＿＿＿＿がとれていない。", en: "This plan lacks coherence between the goals and the means.", o: ["整合性", "一貫性", "矛盾", "つじつま"], a: 0, e: "整合性(せいごうせい) = logical consistency between parts of a system or argument. 一貫性(いっかんせい) = consistency (of attitude, policy over time). 矛盾(むじゅん) = contradiction. つじつま = coherence (つじつまが合わない = doesn't add up)." },
      { t: "meaning", s: "「整合性」の意味は？", o: ["logical consistency; coherence", "consistency (of attitude over time)", "contradiction", "coherence (つじつまが合う = adds up)"], a: 0, e: "整合性 = parts fitting together logically (データの整合性 = data consistency, 整合性がとれている = internally consistent)." }
    ]
  },
  {
    id: "n2-0823", w: "前者", r: "ぜんしゃ", m: "the former", c: "noun", lv: 1,
    ex: [{ jp: "二つの方法があるが、前者の方が効率的だ。", en: "There are two methods, but the former is more efficient." }],
    qs: [
      { t: "fitb", s: "速さと正確さのどちらを優先するかと言えば、私は＿＿＿＿より後者を選ぶ。", en: "If asked which to prioritize, speed or accuracy, I would choose the latter over the former.", o: ["前者", "後者", "それ", "一方"], a: 0, e: "前者(ぜんしゃ) = the former (the first of two mentioned). 後者(こうしゃ) = the latter. それ = that. 一方(いっぽう) = one side / on the other hand." },
      { t: "meaning", s: "「前者」の意味は？", o: ["the former (first of two)", "the latter (second of two)", "that (general)", "one side; the one hand"], a: 0, e: "前者 always refers back to the first of two items just mentioned (前者と後者 = the former and the latter). Used in written/formal contexts to avoid repetition." }
    ]
  },
  {
    id: "n2-0824", w: "後者", r: "こうしゃ", m: "the latter", c: "noun", lv: 1,
    ex: [{ jp: "質と量を比べたとき、後者より前者を優先すべきだ。", en: "When comparing quality and quantity, the former should be prioritized over the latter." }],
    qs: [
      { t: "fitb", s: "AとBの二案があるが、コスト面では＿＿＿＿の方が有利だ。", en: "There are two proposals, A and B, but the latter is more advantageous in terms of cost.", o: ["後者", "前者", "後者の方が", "二番目"], a: 0, e: "後者(こうしゃ) = the latter (second of two). 前者(ぜんしゃ) = the former. 後者の方が = the latter is more ~. 二番目(にばんめ) = the second one." },
      { t: "meaning", s: "「後者」の意味は？", o: ["the latter (second of two)", "the former (first of two)", "the second one (ordinal)", "the other one (general)"], a: 0, e: "後者 refers back to the second of two items mentioned (前者・後者 = the former and the latter). Used to avoid repeating a long noun phrase." }
    ]
  },
  {
    id: "n2-0825", w: "特徴", r: "とくちょう", m: "characteristic; feature; distinguishing trait", c: "noun", lv: 1,
    ex: [{ jp: "この製品の最大の特徴は、軽くて丈夫な点だ。", en: "The greatest feature of this product is that it is light and durable." }],
    qs: [
      { t: "fitb", s: "彼女の絵には独特の＿＿＿＿があり、誰の作品かすぐわかる。", en: "Her paintings have a distinctive characteristic and you can immediately tell whose work they are.", o: ["特徴", "特色", "個性", "特性"], a: 0, e: "特徴(とくちょう) = a distinguishing feature (observable). 特色(とくしょく) = a distinctive characteristic (positive quality). 個性(こせい) = individuality (personal uniqueness). 特性(とくせい) = a special property/characteristic (inherent quality)." },
      { t: "meaning", s: "「特徴」の意味は？", o: ["characteristic; distinguishing feature", "distinctive quality (positive)", "individuality; uniqueness", "inherent property; special characteristic"], a: 0, e: "特徴 = what makes something recognizable (特徴を捉える = to capture the characteristic, 特徴的な = distinctive/characteristic, 特徴を活かす = to leverage one's strengths)." }
    ]
  },
  {
    id: "n2-0826", w: "切り捨てる", r: "きりすてる", m: "to discard; to cut off; to abandon", c: "verb", lv: 1,
    ex: [{ jp: "効率化のために感情を切り捨てることはできない。", en: "You cannot discard emotions for the sake of efficiency." }],
    qs: [
      { t: "fitb", s: "採算の取れない事業を＿＿＿＿て、中核事業に集中することにした。", en: "We decided to cut off the unprofitable business and concentrate on the core business.", o: ["切り捨て", "廃止し", "撤退し", "手放し"], a: 0, e: "切り捨てる(きりすてる) = to discard/cut off (ruthlessly). 廃止する(はいしする) = to abolish/discontinue. 撤退する(てったいする) = to withdraw/pull out. 手放す(てばなす) = to let go of." },
      { t: "meaning", s: "「切り捨てる」の意味は？", o: ["to discard; to cut off ruthlessly", "to abolish; to discontinue", "to withdraw; to pull out", "to let go of; to release"], a: 0, e: "切り捨てる = severing something without mercy (弱者を切り捨てる = to abandon the vulnerable, 小数点以下を切り捨てる = to round down/truncate)." }
    ]
  },
  {
    id: "n2-0827", w: "見据える", r: "みすえる", m: "to keep in sight; to have in view; to fix one's gaze on", c: "verb", lv: 1,
    ex: [{ jp: "将来を見据えて、今から準備を始めることが重要だ。", en: "It is important to start preparing now with the future in sight." }],
    qs: [
      { t: "fitb", s: "長期的な目標を＿＿＿＿た戦略が必要だ。", en: "A strategy with long-term goals firmly in sight is needed.", o: ["見据え", "見通し", "念頭に置い", "目指し"], a: 0, e: "見据える(みすえる) = to fix one's gaze on / keep firmly in view (a goal, the future). 見通す(みとおす) = to foresee / see through to the end. 念頭に置く(ねんとうにおく) = to keep in mind. 目指す(めざす) = to aim for." },
      { t: "meaning", s: "「見据える」の意味は？", o: ["to fix one's gaze on; to have firmly in view", "to foresee; to look ahead", "to keep in mind", "to aim for; to target"], a: 0, e: "見据える = staring directly at something without flinching (現実を見据える = to face reality squarely, 未来を見据える = to keep the future firmly in sight)." }
    ]
  },
  {
    id: "n2-0828", w: "追い求める", r: "おいもとめる", m: "to pursue; to chase after; to seek", c: "verb", lv: 1,
    ex: [{ jp: "理想を追い求める姿勢が、彼を偉大な芸術家にした。", en: "The attitude of pursuing his ideals made him a great artist." }],
    qs: [
      { t: "fitb", s: "利益だけを＿＿＿＿経営は長続きしない。", en: "Management that pursues only profit will not last.", o: ["追い求める", "追求する", "求める", "追いかける"], a: 0, e: "追い求める(おいもとめる) = to persistently pursue over time. 追求する(ついきゅうする) = to pursue/seek (formal). 求める(もとめる) = to seek/demand. 追いかける(おいかける) = to chase after." },
      { t: "meaning", s: "「追い求める」の意味は？", o: ["to persistently pursue over time", "to pursue; to seek (formal)", "to seek; to demand", "to chase after"], a: 0, e: "追い求める = continuing to chase a goal relentlessly (夢を追い求める = to pursue one's dream, 完璧を追い求める = to relentlessly seek perfection)." }
    ]
  },
  {
    id: "n2-0829", w: "傾ける", r: "かたむける", m: "to tilt; to incline; to devote (to something)", c: "verb", lv: 1,
    ex: [{ jp: "彼女の話に耳を傾けると、意外な事実が明らかになった。", en: "When I lent an ear to what she was saying, unexpected facts came to light." }],
    qs: [
      { t: "fitb", s: "全力を研究に＿＿＿＿た結果、画期的な発見に至った。", en: "As a result of devoting all my energy to research, I arrived at a groundbreaking discovery.", o: ["傾け", "捧げ", "注ぎ込み", "費やし"], a: 0, e: "傾ける(かたむける) = to tilt / devote (耳を傾ける = to lend an ear, 情熱を傾ける = to pour passion into). 捧げる(ささげる) = to dedicate/offer up. 注ぎ込む(そそぎこむ) = to pour into. 費やす(ついやす) = to spend/expend." },
      { t: "meaning", s: "「傾ける」の意味は？", o: ["to tilt; to pour into; to devote", "to dedicate; to offer up", "to pour into", "to spend; to expend"], a: 0, e: "傾ける = directing something strongly in one direction (耳を傾ける = to listen attentively, 全力を傾ける = to devote all one's effort)." }
    ]
  },
  {
    id: "n2-0830", w: "明け渡す", r: "あけわたす", m: "to hand over; to vacate; to surrender", c: "verb", lv: 1,
    ex: [{ jp: "退去命令を受け、建物を明け渡さざるを得なかった。", en: "Receiving an eviction order, we had no choice but to vacate the building." }],
    qs: [
      { t: "fitb", s: "首位を相手チームに＿＿＿＿したくないため、最後まで全力で戦った。", en: "Not wanting to surrender first place to the opposing team, we fought with all our strength to the end.", o: ["明け渡し", "譲り", "奪われ", "手放し"], a: 0, e: "明け渡す(あけわたす) = to vacate / hand over (a position, place). 譲る(ゆずる) = to yield/give way to. 奪われる(うばわれる) = to be taken/snatched away. 手放す(てばなす) = to let go of." },
      { t: "meaning", s: "「明け渡す」の意味は？", o: ["to hand over; to vacate; to surrender", "to yield; to give way", "to be taken away", "to let go of; to release"], a: 0, e: "明け渡す = giving up control of a space or position (陣地を明け渡す = to surrender a position, 首位を明け渡す = to give up first place)." }
    ]
  },
  {
    id: "n2-0831", w: "突き止める", r: "つきとめる", m: "to track down; to pinpoint; to ascertain", c: "verb", lv: 1,
    ex: [{ jp: "原因を突き止めるまでに三ヶ月を要した。", en: "It took three months to pinpoint the cause." }],
    qs: [
      { t: "fitb", s: "犯人の居場所を＿＿＿＿た捜査員が、現場に急行した。", en: "The investigator who tracked down the criminal's whereabouts rushed to the scene.", o: ["突き止め", "突き止めた", "特定し", "発見し"], a: 0, e: "突き止める(つきとめる) = to track down/pinpoint (through investigation). 特定する(とくていする) = to identify/specify. 発見する(はっけんする) = to discover. 割り出す(わりだす) = to work out/figure out." },
      { t: "meaning", s: "「突き止める」の意味は？", o: ["to track down; to pinpoint", "to identify; to specify", "to discover", "to work out; to figure out"], a: 0, e: "突き止める = not stopping until you've found the answer (原因を突き止める = to identify the cause, 居場所を突き止める = to track down someone's whereabouts)." }
    ]
  },
  {
    id: "n2-0832", w: "思い切る", r: "おもいきる", m: "to make up one's mind; to take the plunge; to give up on", c: "verb", lv: 1,
    ex: [{ jp: "思い切って上司に直談判した。", en: "I took the plunge and went directly to my boss to negotiate." }],
    qs: [
      { t: "fitb", s: "長年住んだ家を＿＿＿＿って売ることにした。", en: "I made up my mind to sell the house I had lived in for many years.", o: ["思い切", "踏み切", "決心し", "諦め"], a: 0, e: "思い切る(おもいきる) = to make up one's mind decisively (思い切って = resolutely / going for it). 踏み切る(ふみきる) = to take the plunge. 決心する(けっしんする) = to resolve/decide. 諦める(あきらめる) = to give up." },
      { t: "meaning", s: "「思い切る」の意味は？", o: ["to make up one's mind; to go for it", "to take the plunge (after hesitation)", "to resolve; to decide", "to give up; to abandon"], a: 0, e: "思い切って = resolutely, going ahead without hesitation (思い切って挑戦する = to boldly take on a challenge). 思い切りよく = decisively / without holding back." }
    ]
  },
  {
    id: "n2-0833", w: "持ち合わせる", r: "もちあわせる", m: "to happen to have; to have on hand", c: "verb", lv: 1,
    ex: [{ jp: "あいにく今日は現金を持ち合わせていない。", en: "Unfortunately I don't happen to have any cash on me today." }],
    qs: [
      { t: "fitb", s: "彼女は才能と努力の両方を＿＿＿＿いる珍しい人材だ。", en: "She is a rare talent who happens to have both talent and work ethic.", o: ["持ち合わせて", "兼ね備えて", "持って", "備えて"], a: 0, e: "持ち合わせる(もちあわせる) = to happen to have (on you, at the moment). 兼ね備える(かねそなえる) = to possess both qualities. 持つ(もつ) = to have. 備える(そなえる) = to be equipped with." },
      { t: "meaning", s: "「持ち合わせる」の意味は？", o: ["to happen to have; to have on hand", "to possess both qualities simultaneously", "to have; to hold", "to be equipped with"], a: 0, e: "持ち合わせる = having something available at this moment (生憎持ち合わせがない = unfortunately I don't have it on me, 良識を持ち合わせる = to happen to have good sense)." }
    ]
  },
  {
    id: "n2-0834", w: "折り合う", r: "おりあう", m: "to compromise; to come to terms; to get along", c: "verb", lv: 1,
    ex: [{ jp: "双方が折り合うことで、ようやく契約が成立した。", en: "With both sides compromising, the contract was finally concluded." }],
    qs: [
      { t: "fitb", s: "意見の違う二人が＿＿＿＿のに時間がかかった。", en: "It took time for the two people with differing opinions to come to terms.", o: ["折り合う", "妥協する", "合意する", "歩み寄る"], a: 0, e: "折り合う(おりあう) = to reach a mutual compromise / get along. 妥協する(だきょうする) = to compromise (give up something). 合意する(ごういする) = to agree/reach agreement. 歩み寄る(あゆみよる) = to make concessions / meet halfway." },
      { t: "meaning", s: "「折り合う」の意味は？", o: ["to compromise; to come to terms", "to compromise (give something up)", "to agree; to reach agreement", "to make concessions; to meet halfway"], a: 0, e: "折り合う = finding a workable middle ground (折り合いをつける = to reach a compromise, 折り合いが悪い = not getting along well)." }
    ]
  },
  {
    id: "n2-0835", w: "差し替える", r: "さしかえる", m: "to replace; to swap out; to substitute", c: "verb", lv: 1,
    ex: [{ jp: "古いデータを最新のものに差し替えた。", en: "I replaced the old data with the latest version." }],
    qs: [
      { t: "fitb", s: "誤りのある図表を正しいものに＿＿＿＿て再送します。", en: "I will replace the erroneous chart with the correct one and resend.", o: ["差し替え", "置き換え", "交換し", "変更し"], a: 0, e: "差し替える(さしかえる) = to swap one thing out for another. 置き換える(おきかえる) = to replace/substitute (more general). 交換する(こうかんする) = to exchange/swap (bilateral). 変更する(へんこうする) = to change/modify." },
      { t: "meaning", s: "「差し替える」の意味は？", o: ["to replace; to swap out", "to replace; to substitute (general)", "to exchange; to swap (bilateral)", "to change; to modify"], a: 0, e: "差し替える = removing something and inserting a different one in its place (写真を差し替える = to swap out a photo, 担当者を差し替える = to replace the person in charge)." }
    ]
  },
  {
    id: "n2-0836", w: "引き立てる", r: "ひきたてる", m: "to set off; to enhance; to bring out; to promote", c: "verb", lv: 1,
    ex: [{ jp: "シンプルな服装が彼女の美しさを一層引き立てている。", en: "The simple outfit further sets off her beauty." }],
    qs: [
      { t: "fitb", s: "部下の才能を＿＿＿＿のも、上司の大切な役割だ。", en: "Drawing out the talents of one's subordinates is also an important role of a superior.", o: ["引き立てる", "引き出す", "伸ばす", "活かす"], a: 0, e: "引き立てる(ひきたてる) = to enhance/bring out (a quality, talent) or to promote someone. 引き出す(ひきだす) = to draw out. 伸ばす(のばす) = to develop/extend. 活かす(いかす) = to make use of." },
      { t: "meaning", s: "「引き立てる」の意味は？", o: ["to enhance; to set off; to bring out", "to draw out", "to develop; to extend", "to make use of; to leverage"], a: 0, e: "引き立てる = making something look or appear better by contrast or support (色を引き立てる = to set off a colour, 部下を引き立てる = to bring out the best in a subordinate / to promote them)." }
    ]
  },
  {
    id: "n2-0837", w: "立ち返る", r: "たちかえる", m: "to go back to; to return to basics; to revisit", c: "verb", lv: 1,
    ex: [{ jp: "問題が複雑になったとき、原点に立ち返ることが大切だ。", en: "When a problem becomes complicated, it is important to return to basics." }],
    qs: [
      { t: "fitb", s: "この議論の出発点に＿＿＿＿て考え直してみよう。", en: "Let's go back to the starting point of this discussion and reconsider.", o: ["立ち返っ", "戻っ", "振り返っ", "原点回帰し"], a: 0, e: "立ち返る(たちかえる) = to return to a starting point or principle (原点に立ち返る = to go back to basics). 戻る(もどる) = to go back/return. 振り返る(ふりかえる) = to look back. 原点回帰(げんてんかいき) = return to origins." },
      { t: "meaning", s: "「立ち返る」の意味は？", o: ["to return to basics; to go back to a principle", "to go back; to return (general)", "to look back; to reflect", "return to origins (set phrase)"], a: 0, e: "立ち返る = deliberately returning to a foundational point (問題の核心に立ち返る = to go back to the heart of the issue, 初心に立ち返る = to return to one's original spirit/intention)." }
    ]
  },
  {
    id: "n2-0838", w: "突き詰める", r: "つきつめる", m: "to pursue to the end; to think through completely; to get to the bottom of", c: "verb", lv: 1,
    ex: [{ jp: "物事を突き詰めて考える習慣が、彼を優秀な研究者にした。", en: "The habit of thinking things through to the end made him an excellent researcher." }],
    qs: [
      { t: "fitb", s: "問題の本質を＿＿＿＿ると、意外なところに原因があることがわかった。", en: "When we pursued the essence of the problem to the end, we found the cause was in an unexpected place.", o: ["突き詰め", "掘り下げ", "突き止め", "分析し"], a: 0, e: "突き詰める(つきつめる) = to follow something to its logical end (thought, argument). 掘り下げる(ほりさげる) = to dig deeper. 突き止める(つきとめる) = to track down/pinpoint. 分析する(ぶんせきする) = to analyze." },
      { t: "meaning", s: "「突き詰める」の意味は？", o: ["to pursue to the very end; to think through", "to dig deeper into", "to track down; to pinpoint", "to analyze; to break down"], a: 0, e: "突き詰める = not stopping until you've reached the ultimate conclusion (突き詰めると = when you really think it through, 考えを突き詰める = to pursue a thought to its logical end)." }
    ]
  },
  {
    id: "n2-0839", w: "取り持つ", r: "とりもつ", m: "to mediate; to act as go-between; to facilitate", c: "verb", lv: 1,
    ex: [{ jp: "双方の関係を取り持つ役割を担っている。", en: "I am playing the role of mediating between both parties." }],
    qs: [
      { t: "fitb", s: "対立する両者の間を＿＿＿＿のは骨の折れる仕事だ。", en: "Mediating between two parties in conflict is a laborious task.", o: ["取り持つ", "仲介する", "調停する", "橋渡しする"], a: 0, e: "取り持つ(とりもつ) = to act as a go-between / facilitate a relationship. 仲介する(ちゅうかいする) = to mediate/broker. 調停する(ちょうていする) = to arbitrate/mediate (formal/legal). 橋渡しする(はしわたしする) = to bridge/act as liaison." },
      { t: "meaning", s: "「取り持つ」の意味は？", o: ["to mediate; to act as go-between", "to mediate; to broker", "to arbitrate (formal/legal)", "to bridge; to act as liaison"], a: 0, e: "取り持つ = smoothing relations between people (縁を取り持つ = to act as matchmaker, 場を取り持つ = to facilitate the atmosphere/occasion)." }
    ]
  },
  {
    id: "n2-0840", w: "引き延ばす", r: "ひきのばす", m: "to drag out; to prolong; to delay deliberately", c: "verb", lv: 1,
    ex: [{ jp: "交渉を引き延ばす戦術は、相手の信頼を損なう。", en: "Tactics of dragging out negotiations undermine the other party's trust." }],
    qs: [
      { t: "fitb", s: "決断を＿＿＿＿ばしにしても、問題は解決しない。", en: "Even if you drag out the decision, the problem will not be resolved.", o: ["引き延", "先延", "後回", "延期"], a: 0, e: "引き延ばす(ひきのばす) = to deliberately prolong/drag out. 先延ばしにする(さきのばしにする) = to put off/delay. 後回しにする = to leave for later. 延期する(えんきする) = to postpone (setting a new date)." },
      { t: "meaning", s: "「引き延ばす」の意味は？", o: ["to drag out; to prolong deliberately", "to put off; to delay", "to leave for later", "to postpone (with a new date)"], a: 0, e: "引き延ばす = deliberately stretching out time (時間を引き延ばす = to drag things out, 返答を引き延ばす = to delay an answer). Can also mean to enlarge a photo." }
    ]
  },
  {
    id: "n2-0841", w: "成り行き", r: "なりゆき", m: "course of events; development; how things turn out", c: "noun", lv: 1,
    ex: [{ jp: "成り行きに任せて行動した結果、思わぬ出会いがあった。", en: "As a result of acting according to how things developed, there was an unexpected encounter." }],
    qs: [
      { t: "fitb", s: "事態の＿＿＿＿を見守るしかない状況だ。", en: "We are in a situation where all we can do is watch how events unfold.", o: ["成り行き", "展開", "進展", "推移"], a: 0, e: "成り行き(なりゆき) = the natural course of events (as things unfold). 展開(てんかい) = development/unfolding. 進展(しんてん) = progress/development (forward movement). 推移(すいい) = transition/change over time." },
      { t: "meaning", s: "「成り行き」の意味は？", o: ["course of events; how things unfold", "development; unfolding", "progress; forward movement", "transition; change over time"], a: 0, e: "成り行き = letting things take their natural course (成り行き任せ = leaving it to chance, 成り行きを見守る = to watch how things develop)." }
    ]
  },
  {
    id: "n2-0842", w: "底上げ", r: "そこあげ", m: "raising the floor; overall improvement; lifting the baseline", c: "noun", lv: 1,
    ex: [{ jp: "教育の底上げなくして、社会全体の発展はない。", en: "Without raising the baseline of education, there can be no development of society as a whole." }],
    qs: [
      { t: "fitb", s: "チーム全体の実力の＿＿＿＿を図るため、研修を強化した。", en: "We strengthened training in order to raise the overall level of the entire team.", o: ["底上げ", "向上", "強化", "底上げ策"], a: 0, e: "底上げ(そこあげ) = raising the floor level of all members (not just the top). 向上(こうじょう) = improvement. 強化(きょうか) = strengthening. 底上げ策(そこあげさく) = measures to raise the baseline." },
      { t: "meaning", s: "「底上げ」の意味は？", o: ["raising the floor; lifting the baseline", "improvement (general)", "strengthening; reinforcement", "baseline-raising measure"], a: 0, e: "底上げ = bringing the lower end up (賃金の底上げ = raising the wage floor, 学力の底上げ = raising the overall academic baseline across all students)." }
    ]
  },
  {
    id: "n2-0843", w: "名残", r: "なごり", m: "trace; remnant; lingering feeling", c: "noun", lv: 1,
    ex: [{ jp: "祭りが終わった後も、町には活気の名残があった。", en: "Even after the festival ended, traces of its vitality lingered in the town." }],
    qs: [
      { t: "fitb", s: "彼女と別れた後も、長い間その＿＿＿＿を感じていた。", en: "Even after parting with her, I felt the lingering traces for a long time.", o: ["名残", "余韻", "名残惜しさ", "余波"], a: 0, e: "名残(なごり) = a trace or lingering feeling left after something ends. 余韻(よいん) = afterglow / lingering resonance. 名残惜しさ(なごりおしさ) = the sadness of parting. 余波(よは) = ripple effect." },
      { t: "meaning", s: "「名残」の意味は？", o: ["trace; remnant; lingering feeling", "afterglow; lingering resonance", "sadness of parting", "ripple effect; aftermath"], a: 0, e: "名残 = something left behind from the past (名残惜しい = reluctant to part, 冬の名残 = lingering traces of winter, 名残をとどめる = to preserve traces of the past)." }
    ]
  },
  {
    id: "n2-0844", w: "手本", r: "てほん", m: "model; example to follow; copybook", c: "noun", lv: 1,
    ex: [{ jp: "彼女の生き方は、多くの若者にとっての手本になっている。", en: "Her way of life has become a model for many young people." }],
    qs: [
      { t: "fitb", s: "上司が率先して＿＿＿＿を見せることで、部下のやる気が上がる。", en: "When a superior leads the way by showing an example, subordinates' motivation rises.", o: ["手本", "模範", "見本", "例"], a: 0, e: "手本(てほん) = a model to copy or learn from (手本を見せる = to show an example). 模範(もはん) = a model/exemplar (formal). 見本(みほん) = a sample. 例(れい) = an example/case." },
      { t: "meaning", s: "「手本」の意味は？", o: ["model; example to follow; copybook", "exemplar (formal)", "sample (to show quality)", "example; case"], a: 0, e: "手本 = something you copy or learn from (習字の手本 = a calligraphy copybook, 手本にする = to take as a model, 手本を示す = to lead by example)." }
    ]
  },
  {
    id: "n2-0845", w: "生かす", r: "いかす", m: "to make use of; to put to good use; to leverage", c: "verb", lv: 1,
    ex: [{ jp: "留学の経験を仕事に生かしたいと考えている。", en: "I am thinking of putting my study abroad experience to good use in my work." }],
    qs: [
      { t: "fitb", s: "自分の強みを＿＿＿＿た仕事に就くことで、より満足度が高まる。", en: "By getting a job that makes use of your strengths, your satisfaction increases.", o: ["生かし", "活かし", "使い", "発揮し"], a: 0, e: "生かす(いかす) / 活かす = to make the most of something (experience, strengths). 使う(つかう) = to use. 発揮する(はっきする) = to demonstrate/exercise (already in earlier batches)." },
      { t: "meaning", s: "「生かす」の意味は？", o: ["to make use of; to put to good use", "to use (general)", "to demonstrate; to exercise (ability)", "to develop; to grow"], a: 0, e: "生かす / 活かす = extracting maximum value from something (経験を生かす = to draw on experience, 素材を生かした料理 = cooking that brings out the best of ingredients)." }
    ]
  },
  {
    id: "n2-0846", w: "勢い", r: "いきおい", m: "momentum; force; energy; vigour", c: "noun", lv: 1,
    ex: [{ jp: "改革の勢いに乗って、次々と新しい施策が実施された。", en: "Riding the momentum of reform, new measures were implemented one after another." }],
    qs: [
      { t: "fitb", s: "チームは連勝の＿＿＿＿に乗り、決勝まで勝ち進んだ。", en: "The team rode the momentum of consecutive wins and advanced to the final.", o: ["勢い", "流れ", "弾み", "波"], a: 0, e: "勢い(いきおい) = momentum/force (powerful forward energy). 流れ(ながれ) = the flow/current (of events). 弾み(はずみ) = a bounce/momentum (弾みがつく = to gain momentum). 波(なみ) = a wave." },
      { t: "meaning", s: "「勢い」の意味は？", o: ["momentum; force; vigour", "flow; current (of events)", "bounce; gaining momentum", "wave"], a: 0, e: "勢い = powerful, active force (勢いがある = has momentum, 勢いよく = vigorously, 勢いに乗る = to ride the momentum)." }
    ]
  },
  {
    id: "n2-0847", w: "余すところなく", r: "あますところなく", m: "without remainder; completely; thoroughly", c: "adv", lv: 1,
    ex: [{ jp: "この本は著者の知識を余すところなく伝えている。", en: "This book conveys the author's knowledge completely without omission." }],
    qs: [
      { t: "fitb", s: "自分の才能を＿＿＿＿発揮した素晴らしいパフォーマンスだった。", en: "It was a wonderful performance that thoroughly demonstrated all of his talent.", o: ["余すところなく", "余すことなく", "完全に", "すべて"], a: 0, e: "余すところなく = leaving nothing behind / completely (formal). 余すことなく = alternate phrasing (same meaning). 完全に(かんぜんに) = completely/perfectly. すべて = all/everything." },
      { t: "meaning", s: "「余すところなく」の意味は？", o: ["completely; without omission (formal)", "completely (alternate phrasing)", "completely; perfectly", "all; everything"], a: 0, e: "余すところなく = not leaving a single thing out (余すところなく語る = to speak about everything without omission, 余すところなく活用する = to make full and complete use of)." }
    ]
  },
  {
    id: "n2-0848", w: "いわゆる", r: "いわゆる", m: "so-called; what is called; known as", c: "adv", lv: 1,
    ex: [{ jp: "これがいわゆる「デジタル格差」と呼ばれる問題だ。", en: "This is what is called the 'digital divide' problem." }],
    qs: [
      { t: "fitb", s: "彼は＿＿＿＿エリートコースを歩んできた人物だ。", en: "He is a person who has followed what is called the elite career path.", o: ["いわゆる", "いわば", "つまり", "すなわち"], a: 0, e: "いわゆる = so-called / what is commonly referred to as (used before a label or term). いわば = so to speak. つまり = in other words. すなわち = that is to say (formal)." },
      { t: "meaning", s: "「いわゆる」の意味は？", o: ["so-called; what is known as", "so to speak", "in other words", "that is to say (formal)"], a: 0, e: "いわゆる introduces a widely used term or label (いわゆる「草食系」= what is called the 'herbivore type'). It can have a slightly distancing or ironic nuance." }
    ]
  },
  {
    id: "n2-0849", w: "いわば", r: "いわば", m: "so to speak; as it were; in a manner of speaking", c: "adv", lv: 1,
    ex: [{ jp: "彼はいわば、この組織の頭脳だ。", en: "He is, so to speak, the brains of this organization." }],
    qs: [
      { t: "fitb", s: "この制度は＿＿＿＿、社会の安全網の役割を果たしている。", en: "This system plays the role of a safety net for society, so to speak.", o: ["いわば", "いわゆる", "つまり", "まるで"], a: 0, e: "いわば = so to speak / as it were (introducing a metaphor or analogy). いわゆる = so-called (introducing a common label). つまり = in other words (rephrasing). まるで = just like / as if." },
      { t: "meaning", s: "「いわば」の意味は？", o: ["so to speak; as it were (metaphor)", "so-called (common label)", "in other words (rephrasing)", "just like; as if (simile)"], a: 0, e: "いわば introduces a figurative comparison (いわば人生の縮図だ = it is, so to speak, a microcosm of life). It signals that the next phrase is approximate or metaphorical." }
    ]
  },
  {
    id: "n2-0850", w: "あるいは", r: "あるいは", m: "or; alternatively; perhaps", c: "adv", lv: 1,
    ex: [{ jp: "電話あるいはメールでご連絡ください。", en: "Please contact us by phone or by email." }],
    qs: [
      { t: "fitb", s: "彼が遅刻したのは、渋滞のせい、＿＿＿＿は別の理由があるのかもしれない。", en: "His being late may be due to traffic, or alternatively there may be another reason.", o: ["あるいは", "または", "もしくは", "それとも"], a: 0, e: "あるいは = or / alternatively / perhaps (written formal). または = or (standard). もしくは = or (formal/legal). それとも = or (spoken, presenting alternatives in a question)." },
      { t: "meaning", s: "「あるいは」の意味は？", o: ["or; alternatively; perhaps (written)", "or (standard)", "or (formal/legal)", "or (spoken, in questions)"], a: 0, e: "あるいは can mean 'or' (A あるいは B) or 'perhaps' (あるいは間違いかもしれない = perhaps it is a mistake). More literary than または." }
    ]
  },
  {
    id: "n2-0851", w: "かつ", r: "かつ", m: "and; moreover; at the same time (combining two conditions)", c: "adv", lv: 1,
    ex: [{ jp: "この仕事は迅速かつ正確に行う必要がある。", en: "This work must be carried out quickly and accurately." }],
    qs: [
      { t: "fitb", s: "リーダーには力強く、＿＿＿＿繊細な判断力が求められる。", en: "A leader is required to have both powerful and at the same time delicate judgment.", o: ["かつ", "そして", "また", "加えて"], a: 0, e: "かつ = and/moreover (formal written conjunction combining two simultaneous qualities). そして = and then. また = also/and. 加えて(くわえて) = in addition." },
      { t: "meaning", s: "「かつ」の意味は？", o: ["and; at the same time (formal written)", "and then (sequential)", "also; and (general)", "in addition; furthermore"], a: 0, e: "かつ is formal written language for combining simultaneous attributes (安価かつ高品質 = inexpensive yet high quality, 迅速かつ丁寧に = quickly and carefully)." }
    ]
  },
  {
    id: "n2-0852", w: "ないし", r: "ないし", m: "or; to; ranging from ~ to ~", c: "adv", lv: 1,
    ex: [{ jp: "費用は三万ないし五万円かかる見込みだ。", en: "The cost is expected to range from 30,000 to 50,000 yen." }],
    qs: [
      { t: "fitb", s: "参加人数は十名＿＿＿＿十五名を予定しています。", en: "We are planning for 10 to 15 participants.", o: ["ないし", "または", "から", "あるいは"], a: 0, e: "ないし = or / ranging from A to B (formal/written: 三日ないし五日 = three to five days). または = or (standard alternatives). から = from. あるいは = or / alternatively." },
      { t: "meaning", s: "「ないし」の意味は？", o: ["or; ranging from ~ to ~ (formal)", "or (standard alternatives)", "from (starting point)", "or; alternatively (written)"], a: 0, e: "ないし links two numbers as a range (三名ないし五名 = three to five people) or two options (A ないし B = A or B). Exclusively formal/written." }
    ]
  },
  {
    id: "n2-0853", w: "ともなると", r: "ともなると", m: "when it comes to; given that; once ~ is reached", c: "adv", lv: 1,
    ex: [{ jp: "プロともなると、細かいミスも許されない。", en: "When it comes to a professional, even minor mistakes are not allowed." }],
    qs: [
      { t: "fitb", s: "部長＿＿＿＿、発言の重みが全然違う。", en: "When you are at the level of department head, the weight of your words is completely different.", o: ["ともなると", "になると", "ともなれば", "となると"], a: 0, e: "ともなると = when it comes to (that level/position: implies a standard is expected). になると = when it becomes. ともなれば = similar nuance (slightly more hypothetical). となると = when it comes to (same, slightly less formal)." },
      { t: "meaning", s: "「ともなると」の意味は？", o: ["when it comes to (that level/status)", "when it becomes ~", "once ~ level is reached (hypothetical)", "when it comes to (slightly less formal)"], a: 0, e: "ともなると = at that level, certain expectations naturally follow (大人ともなると = once you're an adult, それほどの規模ともなると = at that scale)." }
    ]
  },
  {
    id: "n2-0854", w: "いかに", r: "いかに", m: "how; no matter how; to what extent", c: "adv", lv: 1,
    ex: [{ jp: "いかに優れた計画でも、実行なしには意味がない。", en: "No matter how excellent a plan is, it is meaningless without execution." }],
    qs: [
      { t: "fitb", s: "＿＿＿＿努力しても、結果が伴わないこともある。", en: "No matter how hard you try, sometimes results don't follow.", o: ["いかに", "どんなに", "いかなる", "どれほど"], a: 0, e: "いかに = how/no matter how (formal/literary). どんなに = no matter how (colloquial: どんなに頑張っても). いかなる = whatever/any kind of (formal: いかなる理由でも). どれほど = how much (degree)." },
      { t: "meaning", s: "「いかに」の意味は？", o: ["how; no matter how (formal/literary)", "no matter how (colloquial)", "whatever; any kind of (formal)", "how much; to what degree"], a: 0, e: "いかに is formal/literary (いかに困難でも = no matter how difficult, いかにも = indeed / as expected). 類語 どんなに is the everyday equivalent." }
    ]
  },
  {
    id: "n2-0855", w: "さらなる", r: "さらなる", m: "further; even more; additional", c: "adv", lv: 1,
    ex: [{ jp: "さらなる成長を目指して、新たな挑戦に臨む。", en: "Aiming for further growth, I face a new challenge." }],
    qs: [
      { t: "fitb", s: "今の成功に満足せず、＿＿＿＿高みを目指すべきだ。", en: "Not satisfied with current success, one should aim for even greater heights.", o: ["さらなる", "更なる", "より高い", "一層の"], a: 0, e: "さらなる = further/additional (modifies a noun: さらなる発展 = further development). 更なる = alternate kanji. より高い = higher. 一層の(いっそうの) = even more / a further degree of." },
      { t: "meaning", s: "「さらなる」の意味は？", o: ["further; even more; additional", "further (alternate kanji)", "higher; greater", "even more (a further degree)"], a: 0, e: "さらなる = pushing beyond the current level (さらなる努力 = further effort, さらなる高みへ = to even greater heights). Only modifies nouns (さらなる+noun)." }
    ]
  },
  {
    id: "n2-0856", w: "辛うじて", r: "からうじて", m: "barely; narrowly; just barely", c: "adv", lv: 1,
    ex: [{ jp: "試験には辛うじて合格したが、余裕はなかった。", en: "I barely passed the exam; it was not with any ease." }],
    qs: [
      { t: "fitb", s: "崖崩れで道が寸断されたが、＿＿＿＿て迂回路を見つけた。", en: "The road was cut off by a landslide, but we barely found a detour.", o: ["辛うじ", "かろうじ", "やっと", "何とか"], a: 0, e: "辛うじて(からうじて) = barely/just barely (very close to not succeeding). かろうじて = alternate reading (same word). やっと = finally/at last. 何とか(なんとか) = somehow/manage to." },
      { t: "meaning", s: "「辛うじて」の意味は？", o: ["barely; just barely (close to failing)", "barely (alternate reading)", "finally; at last", "somehow; manage to"], a: 0, e: "辛うじて = by a hair's breadth (辛うじて間に合った = barely made it in time, 辛うじて生き延びた = barely survived). Implies it was extremely close to failing." }
    ]
  },
  {
    id: "n2-0857", w: "ひいては", r: "ひいては", m: "and by extension; ultimately; eventually leading to", c: "adv", lv: 1,
    ex: [{ jp: "個人の健康は、ひいては社会全体の活力につながる。", en: "Individual health leads by extension to the vitality of society as a whole." }],
    qs: [
      { t: "fitb", s: "環境保護は、＿＿＿＿地球の未来を守ることにつながる。", en: "Environmental protection leads by extension to protecting the future of the planet.", o: ["ひいては", "つまり", "結果的に", "さらには"], a: 0, e: "ひいては = by extension / ultimately (A, and ひいてはB = A, which ultimately leads to B). つまり = in other words. 結果的に(けっかてきに) = as a result. さらには = furthermore / and beyond that." },
      { t: "meaning", s: "「ひいては」の意味は？", o: ["and by extension; ultimately", "in other words", "as a result", "furthermore; beyond that"], a: 0, e: "ひいては = extending the chain of consequence (会社の成功、ひいては国の繁栄 = the success of the company, and by extension the prosperity of the nation)." }
    ]
  },
  {
    id: "n2-0858", w: "まして", r: "まして", m: "much more so; let alone; all the more", c: "adv", lv: 1,
    ex: [{ jp: "専門家でも難しいのだから、ましてや素人には無理だ。", en: "Even experts find it difficult, so let alone a layperson." }],
    qs: [
      { t: "fitb", s: "大人でも理解が難しい内容だ。＿＿＿＿や子供にはわからないだろう。", en: "It is content even adults find hard to understand. Let alone a child.", o: ["まして", "ましてや", "なおさら", "それどころか"], a: 0, e: "まして/ましてや = let alone / much more so (Aでさえ難しい、ましてやBは = if A is hard, then B is all the more so). なおさら = all the more. それどころか = far from it / on the contrary." },
      { t: "meaning", s: "「まして」の意味は？", o: ["let alone; much more so; all the more", "all the more so", "far from it; on the contrary", "especially; in particular"], a: 0, e: "まして(や) = escalating beyond an already extreme point (日本語でさえ難しいのに、ましてや中国語は = Japanese is already hard, let alone Chinese)." }
    ]
  },
  {
    id: "n2-0859", w: "たとえ", r: "たとえ", m: "even if; no matter how; though", c: "adv", lv: 1,
    ex: [{ jp: "たとえ失敗しても、挑戦したことに価値がある。", en: "Even if you fail, there is value in having tried." }],
    qs: [
      { t: "fitb", s: "＿＿＿＿結果が悪くても、精一杯やったことを誇りに思おう。", en: "Even if the results are bad, let's be proud of having done our best.", o: ["たとえ", "仮に", "もし", "いくら"], a: 0, e: "たとえ～ても = even if ~ (emphasises the condition is irrelevant to the conclusion). 仮に(かりに) = hypothetically/supposing. もし = if. いくら～ても = no matter how much ~ (with a degree)." },
      { t: "meaning", s: "「たとえ」の意味は？", o: ["even if; no matter ~ (condition irrelevant)", "hypothetically; supposing", "if (general conditional)", "no matter how much ~"], a: 0, e: "たとえ～ても = regardless of the condition (たとえ雨でも行く = I'll go even if it rains). Paired with ても/でも. Emphasises unstoppable determination or universal truth." }
    ]
  },
  {
    id: "n2-0860", w: "すなわち", r: "すなわち", m: "that is to say; namely; in other words", c: "adv", lv: 1,
    ex: [{ jp: "努力なき結果、すなわち夢は実現しない。", en: "Results without effort — in other words, dreams will not be realized." }],
    qs: [
      { t: "fitb", s: "三分の二、＿＿＿＿約六十七パーセントの賛成が必要だ。", en: "Two-thirds — namely about 67 percent — of votes in favour are needed.", o: ["すなわち", "つまり", "すなわちは", "言い換えれば"], a: 0, e: "すなわち = namely/that is to say (formal, introduces an exact equivalent or restatement). つまり = in other words (rephrasing for clarity). 言い換えれば(いいかえれば) = to put it differently. すなわちは = incorrect form." },
      { t: "meaning", s: "「すなわち」の意味は？", o: ["namely; that is to say (formal)", "in other words (rephrasing)", "to put it differently", "in short; to sum up"], a: 0, e: "すなわち introduces an exact equivalence or specification (民主主義、すなわち人民の支配 = democracy, that is, the rule of the people). More formal and precise than つまり." }
    ]
  },
  {
    id: "n2-0861", w: "のみならず", r: "のみならず", m: "not only ~ but also; in addition to", c: "adv", lv: 1,
    ex: [{ jp: "彼は成績優秀なのみならず、スポーツも得意だ。", en: "He is not only excellent in his studies but also good at sports." }],
    qs: [
      { t: "fitb", s: "この政策は国内＿＿＿＿、海外からも高い評価を受けた。", en: "This policy received high praise not only domestically but also from abroad.", o: ["のみならず", "だけでなく", "に限らず", "はもちろん"], a: 0, e: "のみならず = not only ~ but also (formal/written). だけでなく = not only (general). に限らず(にかぎらず) = not limited to. はもちろん = of course / needless to say." },
      { t: "meaning", s: "「のみならず」の意味は？", o: ["not only ~ but also (formal)", "not only (general)", "not limited to", "of course; needless to say"], a: 0, e: "のみならず is a formal written expression for 'not only A but also B' (経済のみならず文化の面でも = not only economically but also culturally)." }
    ]
  },
  {
    id: "n2-0862", w: "につれて", r: "につれて", m: "as ~; in proportion to; along with", c: "adv", lv: 1,
    ex: [{ jp: "時間が経つにつれて、痛みが和らいでいった。", en: "As time passed, the pain gradually eased." }],
    qs: [
      { t: "fitb", s: "年齢を重ねる＿＿＿＿、考え方も変わってくるものだ。", en: "As one accumulates years of age, one's way of thinking changes too.", o: ["につれて", "にしたがって", "とともに", "にともなって"], a: 0, e: "につれて = as A progresses, B changes proportionally (parallel change). にしたがって = as/in accordance with. とともに = along with/as. にともなって = accompanying/as a result of." },
      { t: "meaning", s: "「につれて」の意味は？", o: ["as ~; proportional parallel change", "as; in accordance with", "along with; as", "accompanying; as a result of"], a: 0, e: "につれて marks two things changing in tandem (温度が上がるにつれて体積が増える = as temperature rises, volume increases). The change in B is gradual and proportional to A." }
    ]
  },
  {
    id: "n2-0863", w: "に際して", r: "にさいして", m: "on the occasion of; at the time of; when", c: "adv", lv: 1,
    ex: [{ jp: "入学に際して、必要な書類を提出してください。", en: "On the occasion of enrollment, please submit the required documents." }],
    qs: [
      { t: "fitb", s: "契約を結ぶ＿＿＿＿、条件をよく確認することが大切だ。", en: "At the time of concluding a contract, it is important to carefully check the conditions.", o: ["に際して", "にあたって", "にあたり", "において"], a: 0, e: "に際して(にさいして) = on the occasion of / at the time of (formal). にあたって = in doing / on the occasion of (similar, slightly broader). において = in / at (location or context). にあたり = same as にあたって (more formal variant)." },
      { t: "meaning", s: "「に際して」の意味は？", o: ["on the occasion of; at the time of (formal)", "in doing; on the occasion of", "in; at (location or context)", "same as にあたって (more formal)"], a: 0, e: "に際して = a formal marker for a significant moment or transition (卒業に際して = upon graduation, 大会に際して = on the occasion of the tournament)." }
    ]
  },
  {
    id: "n2-0864", w: "なるべく", r: "なるべく", m: "as much as possible; if possible; preferably", c: "adv", lv: 1,
    ex: [{ jp: "なるべく早く返事をするようにしている。", en: "I try to reply as quickly as possible." }],
    qs: [
      { t: "fitb", s: "環境のために、プラスチック製品は＿＿＿＿使わないようにしたい。", en: "For the environment, I want to avoid using plastic products as much as possible.", o: ["なるべく", "できるだけ", "極力", "できれば"], a: 0, e: "なるべく = as much as possible (moderate effort). できるだけ = as much as possible (similar, slightly stronger). 極力(きょくりょく) = to the utmost degree (strongest effort). できれば = if possible (softest — just a preference)." },
      { t: "meaning", s: "「なるべく」の意味は？", o: ["as much as possible (moderate)", "as much as possible (slightly stronger)", "to the utmost degree (strongest)", "if possible (softest preference)"], a: 0, e: "なるべく = doing one's best within reasonable limits (なるべく早く = as soon as possible, なるべくなら = ideally if possible). Less forceful than 極力." }
    ]
  },
  {
    id: "n2-0865", w: "よりによって", r: "よりによって", m: "of all things; of all times; of all people (expressing exasperation)", c: "adv", lv: 1,
    ex: [{ jp: "よりによって大事な会議の日に風邪をひいてしまった。", en: "Of all days, I caught a cold on the day of the important meeting." }],
    qs: [
      { t: "fitb", s: "＿＿＿＿なぜ今日なんだ、と思うような出来事が重なった。", en: "Events piled up that made me think, 'Of all days, why today?'", o: ["よりによって", "あいにく", "運悪く", "折悪しく"], a: 0, e: "よりによって = of all things/times (exasperated at the worst possible timing). あいにく = unfortunately. 運悪く(うんわるく) = unluckily. 折悪しく(おりあしく) = at an inopportune moment." },
      { t: "meaning", s: "「よりによって」の意味は？", o: ["of all things/times (exasperated)", "unfortunately", "unluckily", "at an inopportune moment"], a: 0, e: "よりによって = highlighting the worst possible choice or timing with exasperation (よりによってそんな日に = of all days, that day; よりによってあの人に頼むとは = of all people to ask, that person!)." }
    ]
  },
  {
    id: "n2-0866", w: "いっそ", r: "いっそ", m: "rather; it would be better to; might as well", c: "adv", lv: 1,
    ex: [{ jp: "こんなに悩むなら、いっそやめてしまった方がいい。", en: "If you're going to worry this much, you might as well just quit." }],
    qs: [
      { t: "fitb", s: "中途半端にやるくらいなら、＿＿＿＿最初からやり直した方がいい。", en: "Rather than doing it half-heartedly, you might as well start over from the beginning.", o: ["いっそ", "むしろ", "차라리", "いっそのこと"], a: 0, e: "いっそ = it would be better to just (making a decisive choice, often radical). むしろ = rather (preference/reframe). いっそのこと = same as いっそ, slightly more emphatic. 차라리 = Korean equivalent (not Japanese)." },
      { t: "meaning", s: "「いっそ」の意味は？", o: ["might as well; it'd be better to (decisive)", "rather; preference (reframe)", "might as well (slightly more emphatic)", "conversely (opposite direction)"], a: 0, e: "いっそ = choosing a clear-cut option rather than continuing a difficult in-between state (いっそ言ってしまおう = I might as well just say it, いっそのこと = just go ahead and)." }
    ]
  },
  {
    id: "n2-0867", w: "あくまで", r: "あくまで", m: "to the last; stubbornly; strictly; purely", c: "adv", lv: 1,
    ex: [{ jp: "これはあくまで私個人の意見です。", en: "This is strictly my personal opinion." }],
    qs: [
      { t: "fitb", s: "彼は自分の主張を＿＿＿＿も曲げなかった。", en: "He stubbornly refused to change his position to the last.", o: ["あくまで", "どこまでも", "最後まで", "頑として"], a: 0, e: "あくまで(も) = stubbornly / strictly (to the last). どこまでも = to the very end / anywhere. 最後まで(さいごまで) = until the end. 頑として(がんとして) = obstinately/flatly (頑として譲らない = flatly refusing to yield)." },
      { t: "meaning", s: "「あくまで」の意味は？", o: ["stubbornly; strictly; to the last", "to the very end; anywhere", "until the end", "obstinately; flatly refusing"], a: 0, e: "あくまで = not deviating from something (あくまで原則を守る = to uphold the principle to the last, あくまでも個人的な見解 = strictly a personal view)." }
    ]
  },
  {
    id: "n2-0868", w: "末", r: "すえ", m: "end; after; at the end of; result of", c: "noun", lv: 1,
    ex: [{ jp: "長い議論の末、ようやく合意に達した。", en: "After a long discussion, we finally reached agreement." }],
    qs: [
      { t: "fitb", s: "さんざん悩んだ＿＿＿＿、転職することに決めた。", en: "After agonizing greatly, I decided to change jobs.", o: ["末", "結果", "挙句", "あげく"], a: 0, e: "末(すえ) = at the end of (a process — usually positive or neutral). 結果(けっか) = result/outcome. 挙句(あげく) = in the end (after negative process). あげく = same as 挙句." },
      { t: "meaning", s: "「末」の意味は？", o: ["after; at the end of (a process)", "result; outcome", "in the end (after negative process)", "eventually; in the long run"], a: 0, e: "末 = the end-point of a process (検討の末 = after deliberation, 交渉の末 = after negotiations). Neutral to positive. 挙句の果て = after all that / after going through all that (negative nuance)." }
    ]
  },
  {
    id: "n2-0869", w: "合わせて", r: "あわせて", m: "in addition; at the same time; combined; altogether", c: "adv", lv: 1,
    ex: [{ jp: "本日の出席者は合わせて五十名でした。", en: "Today's attendees totalled fifty people altogether." }],
    qs: [
      { t: "fitb", s: "このキャンペーンでは、割引＿＿＿＿ポイントも付与されます。", en: "In this campaign, points will also be awarded in addition to the discount.", o: ["合わせて", "加えて", "さらに", "併せて"], a: 0, e: "合わせて(あわせて) = in addition / combined total. 加えて(くわえて) = in addition / furthermore. さらに = furthermore / even more. 併せて(あわせて) = at the same time / simultaneously (同じ読み but 併 emphasizes simultaneity)." },
      { t: "meaning", s: "「合わせて」の意味は？", o: ["in addition; altogether; combined", "in addition; furthermore", "furthermore; even more", "at the same time; simultaneously"], a: 0, e: "合わせて = together / in total (合わせて百名 = a hundred in total) or along with something else (割引と合わせてご利用ください = please use together with the discount)." }
    ]
  },
  {
    id: "n2-0870", w: "仕上がり", r: "しあがり", m: "finish; result; quality of completion", c: "noun", lv: 1,
    ex: [{ jp: "このスーツの仕上がりは非常に丁寧で、職人の腕前が光る。", en: "The finish of this suit is exceptionally careful, and the craftsman's skill shines through." }],
    qs: [
      { t: "fitb", s: "洗濯後の＿＿＿＿がよく、皺も少ない素材を選んだ。", en: "I chose a fabric with a good finish after washing and few wrinkles.", o: ["仕上がり", "仕上げ", "質感", "出来栄え"], a: 0, e: "仕上がり(しあがり) = the finished state/quality (how it turned out). 仕上げ(しあげ) = the finishing (the act of finishing). 質感(しつかん) = texture/feel. 出来栄え(できばえ) = workmanship/quality of the result." },
      { t: "meaning", s: "「仕上がり」の意味は？", o: ["the finished state; quality of result", "the finishing (act of)", "texture; feel", "workmanship; quality of result"], a: 0, e: "仕上がり = how something turns out when complete (仕上がりがいい = a fine finish, 仕上がりを確認する = to check the finished product)." }
    ]
  },
  {
    id: "n2-0871", w: "張り合い", r: "はりあい", m: "reward; incentive; sense of purpose; worth", c: "noun", lv: 1,
    ex: [{ jp: "誰にも感謝されない仕事には張り合いがない。", en: "Work that nobody thanks you for has no sense of reward." }],
    qs: [
      { t: "fitb", s: "目標があってこそ、毎日の勉強に＿＿＿＿が生まれる。", en: "It is precisely having a goal that brings a sense of purpose to daily studying.", o: ["張り合い", "やりがい", "生きがい", "励み"], a: 0, e: "張り合い(はりあい) = a sense of reward/worth (makes effort feel worthwhile). やりがい = a sense of fulfilment/meaningfulness in work. 生きがい(いきがい) = a reason for living / ikigai. 励み(はげみ) = encouragement/incentive." },
      { t: "meaning", s: "「張り合い」の意味は？", o: ["sense of reward; incentive; worth", "sense of fulfilment in work", "reason for living; ikigai", "encouragement; incentive"], a: 0, e: "張り合い = the feeling that effort is worth it (張り合いがある = rewarding, 張り合いをなくす = to lose the will to go on). Also: 張り合う = to compete/rival." }
    ]
  },
  {
    id: "n2-0872", w: "ほころびる", r: "ほころびる", m: "to come apart at the seams; to crack; to break down (of a facade)", c: "verb", lv: 1,
    ex: [{ jp: "完璧に見えた計画がほころびはじめた。", en: "The seemingly perfect plan began to come apart at the seams." }],
    qs: [
      { t: "fitb", s: "彼の証言は細部が＿＿＿＿、信憑性が疑われた。", en: "Details of his testimony began to unravel, and its credibility was questioned.", o: ["ほころびて", "崩れて", "矛盾し", "ほころびはじめ"], a: 0, e: "ほころびる = to come apart / unravel (fabric, plan, facade). 崩れる(くずれる) = to crumble/collapse. 矛盾する(むじゅんする) = to contradict." },
      { t: "meaning", s: "「ほころびる」の意味は？", o: ["to come apart; to unravel (plan/facade)", "to crumble; to collapse", "to contradict", "to break; to fracture"], a: 0, e: "ほころびる = the moment cracks begin to show (計画がほころびる = the plan starts to unravel, ほころびが見える = cracks become visible). Also: a flower buds open, or a smile softens." }
    ]
  },
  {
    id: "n2-0873", w: "持ち前", r: "もちまえ", m: "one's natural quality; innate characteristic; one's trademark", c: "noun", lv: 1,
    ex: [{ jp: "彼女は持ち前の明るさで、チームの雰囲気を変えた。", en: "With her natural cheerfulness, she changed the atmosphere of the team." }],
    qs: [
      { t: "fitb", s: "＿＿＿＿の粘り強さで、どんな困難も乗り越えてきた。", en: "With his innate tenacity, he has overcome any difficulty.", o: ["持ち前", "持ち味", "天性", "生まれつきの"], a: 0, e: "持ち前(もちまえ) = one's trademark / innate quality that one naturally possesses. 持ち味(もちあじ) = one's distinctive quality/flavour. 天性(てんせい) = natural talent/gift. 生まれつきの(うまれつきの) = inborn/by nature." },
      { t: "meaning", s: "「持ち前」の意味は？", o: ["one's innate quality; trademark characteristic", "one's distinctive flavour/quality", "natural talent; gift", "inborn; by nature"], a: 0, e: "持ち前 = what one naturally comes equipped with as a personality trait (持ち前の明るさ = one's natural cheerfulness, 持ち前の力を発揮する = to demonstrate one's natural abilities)." }
    ]
  },
  {
    id: "n2-0874", w: "決め手", r: "きめて", m: "the decisive factor; the clincher; the deciding blow", c: "noun", lv: 1,
    ex: [{ jp: "応募先を決めた決め手は、社風の良さだった。", en: "The decisive factor in choosing where to apply was the good company culture." }],
    qs: [
      { t: "fitb", s: "この試合の＿＿＿＿となったのは、後半のコーナーキックだった。", en: "What proved to be the decisive blow in this match was the corner kick in the second half.", o: ["決め手", "勝因", "ポイント", "決定打"], a: 0, e: "決め手(きめて) = the decisive factor/clincher. 勝因(しょういん) = the reason for victory. ポイント = key point (loanword). 決定打(けっていだ) = the decisive hit/blow." },
      { t: "meaning", s: "「決め手」の意味は？", o: ["decisive factor; the clincher", "reason for victory", "key point (loanword)", "decisive hit; finishing blow"], a: 0, e: "決め手 = what tips the balance or seals the deal (決め手に欠ける = lacking a decisive factor, 決め手を欠く交渉 = negotiations that lack a clinching argument)." }
    ]
  },
  {
    id: "n2-0875", w: "胸を張る", r: "むねをはる", m: "to hold one's head high; to stand tall; to take pride in", c: "verb", lv: 1,
    ex: [{ jp: "自分の仕事に胸を張って言えるような成果を残したい。", en: "I want to leave results that I can proudly claim as my own work." }],
    qs: [
      { t: "fitb", s: "恥ずかしいことは何もない。堂々と＿＿＿＿っていい。", en: "There is nothing to be ashamed of. You can stand tall with pride.", o: ["胸を張", "胸を張って歩", "誇りを持", "自信を持"], a: 0, e: "胸を張る(むねをはる) = to hold one's chest up with pride. 誇りを持つ(ほこりをもつ) = to take pride in. 自信を持つ(じしんをもつ) = to have confidence." },
      { t: "meaning", s: "「胸を張る」の意味は？", o: ["to hold one's head high; to take pride", "to take pride in", "to have confidence", "to boast; to brag"], a: 0, e: "胸を張る = walking with your chest out, conveying pride or confidence (胸を張って言える = to be able to say with pride, 胸を張って歩く = to walk with head held high)." }
    ]
  },
];
